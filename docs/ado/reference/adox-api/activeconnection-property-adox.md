---
title: ActiveConnection-Eigenschaft (ADOX) | Microsoft Docs
...
## <a name="settings-and-return-values"></a>Einstellungen und Rückgabewerte  
 Legt eine **Verbindung** Objekt oder eine **Zeichenfolge** , die die Definition für eine Verbindung enthält. Gibt den aktiven **Verbindung** Objekt.  
