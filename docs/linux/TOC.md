...
### [Provision a SQL VM in Azure (Bereitstellen einer SQL-VM in Azure)](https://docs.microsoft.com/azure/virtual-machines/linux/sql/provision-sql-server-linux-virtual-machine)
