...
### [Create and run jobs (Erstellen und Ausführen von Aufträgen)](sql-server-linux-run-sql-server-agent-job.md)
...
### [Restore from Windows (Wiederherstellen von Windows)](sql-server-linux-migrate-restore-database.md)
...
### [Load data with (SSIS) (Laden von Daten mit SSIS)](sql-server-linux-migrate-ssis.md)
...
### [Failover Cluster Instance (Failoverclusterinstanz)](sql-server-linux-shared-disk-cluster-configure.md)
...
### [Active Directory Authentication (Active Directory-Authentifizierung)](sql-server-linux-active-directory-authentication.md)

## [Optimize Performance (Optimieren der Leistung)](sql-server-linux-performance-get-started.md)
