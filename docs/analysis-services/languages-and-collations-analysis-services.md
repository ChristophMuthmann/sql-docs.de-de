...
helpviewer_keywords: 
  - "Windows-Sortierungen [Analysis Services]"
  - "Standardsortierungen"
  - "Sprachen [Analysis Services]"
  - "Sortierreihenfolgen [Analysis Services]"
  - "Sprachen-ID [Analysis Services]"
  - "Standardsprachen"
  - "Sortierungen [Analysis Services]"
...
-   Erneutes Verarbeiten von Partitionen und Dimensionen, nachdem die Sortierung aktualisiert wurde  
 ...
 Sie können SQL Server Management Studio oder AMO PowerShell verwenden, um die Standardsprache oder -sortierung auf Serverebene zu ändern. Alternativ können Sie die Einstellungen **\<Sprache>** und **\<Name der Sortierung>** in der Datei „msmdsrv.ini“ unter Angabe der LCID der Sprache ändern.  
