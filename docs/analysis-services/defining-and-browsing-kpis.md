...
manager: "erikre"
---
# Definieren und Durchsuchen von KPIs
...
1.  Öffnen Sie den Cube-Designer für den [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial-Cube, und klicken Sie anschließend auf die Registerkarte **KPIs**.  
    ...
    ![KPIs (Registerkarte des Cube-Designers)](../analysis-services/media/l7-kpi-1.gif "KPIs (Registerkarte des Cube-Designers)")  
...
2.  Geben Sie im Feld **Name** die Bezeichnung **Product Gross Profit Margin** ein, und überprüfen Sie anschließend, ob in der Liste **Zugeordnete Measuregruppe** die Option **<All>** angezeigt wird.  
