...
1. [Analysis Services, Abwärtskompatibilität (2017 SQL)](analysis-services-backward-compatibility-sql2017.md)
2. [Sicherheit auf Nachrichtenebene-Objekt](tabular-models/object-level-security.md)
