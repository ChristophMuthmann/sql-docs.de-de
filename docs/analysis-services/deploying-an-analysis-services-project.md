---
title: "Bereitstellen eines Analysis Services-Projekts | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
### So stellen Sie das Analysis Services-Projekt bereit  
...
2.  Klicken Sie im Knoten **Konfigurationseigenschaften** im linken Bereich auf **Bereitstellung**.  
    ...
    > [!NOTE]  
    > Wenn Sie das Projekt für eine benannte Instanz von [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] auf dem lokalen Computer oder für eine Instanz auf einem Remoteserver bereitstellen möchten, ändern Sie die **Server**-Eigenschaft zum entsprechenden Instanznamen, beispielsweise \<*ServerName**>\\<**InstanceName**>*.  
...
[Durchsuchen des Cubes](../analysis-services/browsing-the-cube.md)  
