...
ms.topic: "reference"
helpviewer_keywords: 
  - "PriorityRatio (Eigenschaft)"
  - "Threads [Analysis Services]"
  - "MinThreads (Eigenschaft)"
  - "NumThreads (Eigenschaft)"
  - "MaxThreads (Eigenschaft)"
 ...
 **Festlegen von "PerNumaNode=0"**  
 ...
 ![NUMA, Übereinstimmung zwischen Prozessor und Threadpool](../../analysis-services/server-properties/media/ssas-threadpool-numaex0.PNG "NUMA, Übereinstimmung zwischen Prozessor und Threadpool")  
 ...
 **Festlegen von "PerNumaNode=1"**  
 ...
 ![NUMA, Übereinstimmung zwischen Prozessor und Threadpool](../../analysis-services/server-properties/media/ssas-threadpool-numaex1.PNG "NUMA, Übereinstimmung zwischen Prozessor und Threadpool")  
 ...
 **Festlegen von "PerNumaNode=2"**  
 ...
 ![NUMA, Übereinstimmung zwischen Prozessor und Threadpool](../../analysis-services/server-properties/media/ssas-threadpool-numaex2.PNG "NUMA, Übereinstimmung zwischen Prozessor und Threadpool")  
