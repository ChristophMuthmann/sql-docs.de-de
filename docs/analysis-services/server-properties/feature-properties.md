---
title: "Funktionseigenschaften | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "reference"
helpviewer_keywords: 
  - "SQMSupportEnabled (Eigenschaft)"
  - "ComUdfEnabled (Eigenschaft)"
  - "LinkToOtherInstanceEnabled (Eigenschaft)"
  - "ManagedCodeEnabled (Eigenschaft)"
  - "ConnStringEncryptionEnabled (Eigenschaft)"
  - "LinkFromOtherInstanceEnabled (Eigenschaft)"
  - "LinkInsideInstanceEnabled (Eigenschaft)"
  - "UseCachedPageAllocators (Eigenschaft)"
