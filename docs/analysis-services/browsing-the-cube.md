...
3.  Wechseln Sie in [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] zum **Cube-Designer**. Doppelklicken Sie hierzu auf den **Analysis Services Tutorial**-Cube im **Cubes**-Knoten des Projektmappen-Explorers.  
...
## Siehe auch  
[MDX-Abfrage-Editor &#40;Analysis Services – Mehrdimensionale Daten&#41;](../Topic/MDX%20Query%20Editor%20(Analysis%20Services%20-%20Multidimensional%20Data).md)  
