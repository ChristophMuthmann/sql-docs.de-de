...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Die Query Processing-Ereigniskategorie verfügt über die in der folgenden Tabelle beschriebenen Ereignisklassen.  
