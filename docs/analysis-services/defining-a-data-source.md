...
### So definieren Sie eine neue Datenquelle  
...
5.  Geben Sie im Textfeld **Servername** die Eingabe **localhost** ein.  
    ...
    Um eine Verbindung mit einer benannten Instanz auf Ihrem lokalen Computer herzustellen, geben Sie **localhost\\<instance name>** ein. Geben Sie den Computernamen oder die IP-Adresse ein, um eine Verbindung zu einem spezifischen Computer statt zum lokalen Computer herzustellen.  
...
[Definieren einer Datenquellensicht](../analysis-services/defining-a-data-source-view.md)  
