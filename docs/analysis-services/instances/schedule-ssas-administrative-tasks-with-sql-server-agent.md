---
title: "Planen von administrativen Tasks in SSAS mithilfe von SQL Server-Agent | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
7.  Geben Sie in **Server** **localhost** für eine Standardinstanz von [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] und **localhost\\**\<*Instanzname*> für eine benannte Instanz ein.  
     ...
     Wenn Sie den Auftrag von einem Remotecomputer ausführen, verwenden Sie den Namen des Servers und der Instanz, wo der Auftrag ausgeführt wird. Verwenden Sie das Format \<*Servername*> für eine Standardinstanz und \<*Servername*>\\<*Instanzname*> für eine benannte Instanz.  
