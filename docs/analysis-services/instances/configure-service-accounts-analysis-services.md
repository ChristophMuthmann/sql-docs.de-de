...
2.  Verwenden Sie **Computer-Manager** | **Lokale Benutzer und Gruppen** | **Gruppen**, um die Mitgliedschaft der Sicherheitsgruppe SQLServerMSASUser$\<Servername>$\<Instanzname> zu prüfen.  
