---
title: "Konfigurieren von Power Pivot und Bereitstellen von L&#246;sungen (SharePoint 2016) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Konfigurieren von Power Pivot und Bereitstellen von L&#246;sungen (SharePoint 2016)
...
8.  Wählen Sie **Ausführen** aus, um alle Aktionen in der Aufgabenliste zu verarbeiten. Beachten Sie, dass **Ausführen** verfügbar wird, nachdem Sie die Aktionen überprüft haben. Wenn **Ausführen** nicht aktiviert ist, wählen Sie zuerst **Überprüfen** aus.  
 ...
 Weitere Informationen finden Sie unter [Konfigurieren oder Reparieren von PowerPivot für SharePoint 2010 (PowerPivot-Konfigurationstool)](http://msdn.microsoft.com/de-de/d61f49c5-efaa-4455-98f2-8c293fa50046).  
...
2.  Überprüfen Sie, ob die **Funktion zur [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)]-Integration** **Aktiv** ist.  
  
 **Websitesammlungsfunktion:**  
  
1.  Navigieren Sie zu der vom Konfigurationstool erstellten Website-URL.  
  
     Wählen Sie **Einstellungen** ![SharePoint-Einstellungen](../../../analysis-services/media/as-sharepoint2013-settings-gear.png "SharePoint-Einstellungen") und anschließend **Siteeinstellungen** aus.  
  
     Wählen Sie **Websitesammlungsfeatures** aus.  
  
2.  Stellen Sie sicher, dass die **Funktion zur [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)]-Integration für Websitesammlungen** auf **Aktiv** festgelegt ist.  
