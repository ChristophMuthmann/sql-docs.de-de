...
# <a name="olapdatasource-data-type-assl"></a>OlapDataSource-Datentyp (ASSL)
  Definiert einen abgeleiteten Datentyp, der ein mehrdimensionales darstellt [DataSource](../../../analysis-services/scripting/objects/datasource-element-assl.md) Element.  
