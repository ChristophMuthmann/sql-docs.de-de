...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Gibt das Intervall an, an dem die gebundenen Daten, die verknüpft sind, mit dem übergeordneten Element aktualisiert werden.  
