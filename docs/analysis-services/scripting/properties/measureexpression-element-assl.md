...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Enthält den MDX (Multidimensional Expressions)-Ausdruck, der definiert, wie die Werte des übergeordneten Measures abgerufen werden.  
