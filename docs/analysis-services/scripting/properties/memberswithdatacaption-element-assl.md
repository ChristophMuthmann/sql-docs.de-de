...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Stellt eine Vorlagenzeichenfolge aus, die zum Erstellen von Beschriftungen für System generierten Datenelemente verwendet wird.  
