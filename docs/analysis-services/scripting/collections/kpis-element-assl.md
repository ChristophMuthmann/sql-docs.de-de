...
# <a name="kpis-element-assl"></a>Kpis-Element (ASSL)
  Enthält die Auflistung von Key Performance Indicators ([Kpi](../../../analysis-services/scripting/objects/kpi-element-assl.md) Elemente) mit dem übergeordneten Element verknüpft sind.  
