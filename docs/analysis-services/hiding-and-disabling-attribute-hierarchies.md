...
## Festlegen von Attributhierarchieeigenschaften in der Employee-Dimension  
...
4.  Legen Sie im Eigenschaftenfenster den Wert der **AttributeHierarchyEnabled** -Eigenschaft auf **False** für die ausgewählten Attribute fest.  
    ...
    ![AttributeHierarchyEnabled-Eigenschaft ist auf False festgelegt](../analysis-services/media/l4-hierarchyenabled-1.gif "AttributeHierarchyEnabled-Eigenschaft ist auf False festgelegt")  
...
## Festlegen von Attributhierarchieeigenschaften in der Customer-Dimension  
...
4.  Legen Sie im Eigenschaftenfenster den Wert der **AttributeHierarchyVisible** -Eigenschaft auf **False** für die ausgewählten Attribute fest.  
    ...
    ![AttributeHierarchyVisible-Eigenschaft ist auf False festgelegt](../analysis-services/media/l4-hierarchyvisible-1.gif "AttributeHierarchyVisible-Eigenschaft ist auf False festgelegt")  
...
[Sortieren von Attributelementen basierend auf einem sekundären Attribut](../analysis-services/sorting-attribute-members-based-on-a-secondary-attribute.md)  
