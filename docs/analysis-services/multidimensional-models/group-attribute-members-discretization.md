...
ms.topic: "article"
helpviewer_keywords: 
  - "NameColumn (Eigenschaft)"
  - "Diskretisierung [Analysis Services]"
  - "Elementgruppen [Analysis Services]"
  - "Gruppieren von Elementen"
  - "DiscretizationNumber (Eigenschaft)"
  - "Sortierreihenfolgen [Analysis Services]"
  - "DiscretizationMethod (Eigenschaft)"
  - "Hinzufügen von Elementen zu Elementgruppen"
  - "Anzahl von Elementgruppen"
  - "Elemente [Analysis Services], Gruppen"
  - "Namen [Analysis Services], Elementgruppen"
...
## Hinzufügen neuer Elemente in vorhandene Elementgruppen  
