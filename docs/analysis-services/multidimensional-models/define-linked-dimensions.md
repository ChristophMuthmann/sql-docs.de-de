...
ms.topic: "article"
helpviewer_keywords: 
  - "Dimensionen [Analysis Services], verknüpfte"
  - "Verknüpfte Dimensionen [Analysis Services]"
...
## Konfigurieren des Servers, sodass verknüpfte Objekte zulässig sind  
...
## Erstellen einer verknüpften Dimension in SQL Server-Datentools  
