...
ms.topic: "article"
helpviewer_keywords: 
  - "Berechtigungen [Analysis Services], Vollzugriff"
  - "Vollzugriffberechtigungen [Analysis Services]"
...
# Erteilen von Datenbankberechtigungen (Analysis Services)
 ...
 ![Dialogfeld "Rolle erstellen" mit Datenbankberechtigungen](../../analysis-services/multidimensional-models/media/ssas-permsdbrole.png "Dialogfeld "Rolle erstellen" mit Datenbankberechtigungen")  
