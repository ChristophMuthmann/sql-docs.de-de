...
helpviewer_keywords: 
  - "Identitätswechselinformationen (Dialogfeld)"
 ...
 **Bestimmten Benutzernamen und bestimmtes Kennwort verwenden**  
 Wählen Sie diese Option aus, damit vom [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]-Objekt die Sicherheitsanmeldeinformationen eines Windows-Benutzerkontos im folgenden Format verwendet werden: *\<Domänenname>***\\***\<Benutzerkontoname>*.  
