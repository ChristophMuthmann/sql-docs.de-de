...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Management Studio [Analysis Services], Datenbanken"
  - "SQL Server Analysis Services, Datenbanken"
  - "SSAS, Datenbanken"
  - "Analysis Services, Datenbanken"
  - "Datenbanken [Analysis Services], entwerfen"
  - "Business Intelligence Development Studio, Datenbanken [Analysis Services]"
  - "Datenbanken [Analysis Services]"
