...
ms.topic: "article"
helpviewer_keywords: 
  - "Partitionen [Analysis Services], Remote-"
  - "Remotepartitionen [Analysis Services]"
...
1.  Auf dem Masterserver: Öffnen Sie den Cube im Cube-Designer, und klicken Sie auf die Registerkarte **Partitionen** . Erweitern Sie die Measuregruppe. Klicken Sie auf **Neue Partition**, wenn die Measuregruppe bereits für mehrere Partitionen konfiguriert ist, oder klicken Sie in der Quellspalte auf die Schaltfläche zum Durchsuchen (.. . ), um die bestehende Partition zu bearbeiten.  
