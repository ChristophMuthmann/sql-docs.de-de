---
title: "Dimensionsattributeigenschaftenverweis | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Eigenschaften [Analysis Services], Attribute"
  - "Attribute [Analysis Services], Eigenschaften"
...
|**Typ**|Enthält den Typ des Attributs. Weitere Informationen finden Sie unter [Konfigurieren von Attributtypen](../../analysis-services/multidimensional-models/configure-attribute-types.md).|  
...
|**Verwendung**|Beschreibt die Verwendung eines Attributs.<br /><br /> Die folgenden Optionen sind verfügbar:<br /><br /> **Regular** Das Attribut ist ein reguläres Attribut. Dies ist der Standardwert.<br /><br /> **Schlüssel** Das Attribut ist ein Schlüsselattribut.<br /><br /> **Parent** Das Attribut ist ein übergeordnetes Attribut.|  
