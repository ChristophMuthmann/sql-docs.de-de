...
ms.topic: "article"
helpviewer_keywords: 
  - "Bereitstellen [Analysis Services], Eingabeaufforderung"
  - "Eingabeaufforderungs-Hilfsprogramme [SQL Server], Microsoft.AnalysisServices.Deployment"
  - "Microsoft.AnalysisServices.Deployment (Hilfsprogramm)"
  - "Analysis Services-Bereitstellungen, Eingabeaufforderung"
