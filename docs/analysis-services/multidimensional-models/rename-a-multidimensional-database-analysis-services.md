...
---
# Umbenennen einer mehrdimensionalen Datenbank (Analysis Services)
...
### So ändern Sie den Datenbanknamen im Onlinemodus  
...
### So ändern Sie den Datenbanknamen im Projektmodus  
...
### So ändern Sie den Datenbanknamen mithilfe von SQL Server Management Studio  
