---
title: "Verwaltung von mehrdimensionalen Modellassemblys | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Berechtigungen [Analysis Services], Assemblys"
  - "Aufrufen von benutzerdefinierten Funktionen"
  - "Benutzeridentitätswechsel [Analysis Services]"
  - "Identitätswechsel [Analysis Services]"
  - "Data Mining-Erweiterungen [Analysis Services], Assemblys"
  - "MDX [Analysis Services], Assemblys"
  - "Benutzerdefinierte Funktionen [Analysis Services]"
  - "Analysis Services-Objekte, Assemblys"
  - "Assemblys [Analysis Services]"
  - "Anwendungsdomänen [Analysis Services]"
