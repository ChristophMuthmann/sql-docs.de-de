...
ms.topic: "article"
helpviewer_keywords: 
  - "SSAS, Datenzugriffsschnittstellen"
  - "Objekte [Analysis Services], Datenzugriffsschnittstellen"
  - "Schnittstellen für den Datenzugriff in Analysis Services"
  - "Abrufen von Daten [Analysis Services]"
  - "Abrufen von Daten"
  - "Metadaten [Analysis Services]"
  - "Schnittstellen für den Datenzugriff [Analysis Services]"
  - "Bearbeiten von Objekten [Analysis Services]"
  - "Analysis Services-Datenzugriffsschnittstellen, Informationen zu Datenzugriffsschnittstellen"
...
### SQL Server Management Studio  
 Für Datenbankadministratoren ist SQL Server Management Studio eine integrierte Umgebung zum Verwalten der SQL Server-Instanzen, einschließlich Instanzen von Analysis Services und mehrdimensionalen Datenbanken. Weitere Informationen finden Sie im Artikel über [SQL Server Management Studio](../Topic/SQL%20Server%20Management%20Studio.md) und unter [Verbindung mit Analysis Services herstellen](../../../analysis-services/instances/connect-to-analysis-services.md).  
