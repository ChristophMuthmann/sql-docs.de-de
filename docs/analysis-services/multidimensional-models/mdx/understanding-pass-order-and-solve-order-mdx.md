...
ms.topic: "article"
helpviewer_keywords: 
  - "Auswertungsreihenfolge [MDX]"
  - "Berechnungsreihenfolge [MDX]"
  - "SOLVE_ORDER-Eigenschaft"
  - "Abfragen [MDX], Lösungsreihenfolgen"
  - "Lösungsreihenfolgen [MDX]"
  - "Durchlaufreihenfolgen [MDX]"
  - "Ausdrücke [MDX], Lösungsreihenfolgen"
...
### Abfrage 2 – Prozentsatz von Income nach Abzug von Expenses  
...
## Siehe auch  
 ...
 [Bearbeiten von Daten &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/manipulating-data-mdx.md)  
