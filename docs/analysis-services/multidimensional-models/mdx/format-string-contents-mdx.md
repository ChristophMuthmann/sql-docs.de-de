...
ms.topic: "article"
helpviewer_keywords: 
  - "Formate [Analysis Services], Zeichenfolgenwerte"
  - "VALUE-Eigenschaft"
  - "Formate [Analysis Services], numerische Werte"
  - "FORMATTED_VALUE-Eigenschaft"
  - "FORMAT_STRING-Inhalt"
...
## Siehe auch  
 [LANGUAGE und FORMAT_STRING für FORMATTED_VALUE](../../../analysis-services/multidimensional-models/mdx/language-and-format-string-on-formated-value.md)   
