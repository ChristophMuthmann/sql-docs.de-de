...
ms.topic: "article"
helpviewer_keywords: 
  - "DRILLTHROUGH-Anweisung"
  - "Abrufen von Daten"
  - "Abfragen [MDX], DRILLTHROUGH-Anweisung"
  - "Datenabruf [MDX]"
...
# Verwenden von DRILLTHROUGH zum Abrufen von Quelldaten (MDX)
  Die [DRILLTHROUGH](../Topic/DRILLTHROUGH%20Statement%20\(MDX\).md)-Anweisung wird in MDX (Multidimensional Expressions) dazu verwendet, ein Rowset aus den Quelldaten für eine Cubezelle abzurufen.  
