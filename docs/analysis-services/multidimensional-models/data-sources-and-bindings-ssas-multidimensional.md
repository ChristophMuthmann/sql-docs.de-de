...
ms.topic: "article"
helpviewer_keywords: 
  - "Datenquellensichten [Analysis Services], Bindungen"
  - "DSO, Bindungen"
  - "Analysis Services Scripting Language, Datenquellen"
  - "Cubes [Analysis Services], Bindungen"
  - "OLAP Miningmodelle [Analysis Services Scripting Language]"
  - "Bindungen [Analysis Services Scripting Language]"
  - "Erneute Bindungen [Analysis Services Scripting Language]"
  - "ASSL, Bindungen"
  - "Relationale Miningmodelle [ASSL]"
  - "Datenquellen [Analysis Services Scripting Language]"
  - "ASSL, Datenquellen"
  - "Dimensionen [Analysis Services], Bindungen"
  - "Measures [Analysis Services], Bindungen"
  - "Relationale Datenquellen [Analysis Services Scripting Language]"
  - "Analysis Services Scripting Language, Bindungen"
  - "Kapitelrowsets"
  - "Granularität"
  - "Miningmodelle [Analysis Services], Datenquellen"
  - "Inlinebindungen [ASSL]"
  - "Out-of-Line-Bindungen"
  - "Measuregruppen [Analysis Services], Bindungen"
  - "Partitionen [Analysis Services], Bindungen"
...
### Definition des Out-of-Line-Bindungstyps  
 Innerhalb der Out-of-Line-**Bindings**-Auflistung ermöglicht ASSL eine Auflistung von Bindungen für mehrere Objekte, von denen jedes eine **Bindung** ist. Jede **Bindung** besitzt einen erweiterten Objektverweis, der dem Objektverweis entspricht, der jedoch auch auf untergeordnete Objekte verweisen kann (beispielsweise Dimensionsattribute und Measuregruppenattribute). Dieses Objekt übernimmt die Flatform normalerweise von dem **Object**-Element in **Process**-Befehlen mit dem Unterschied, dass die \<*Object*>\<*/Object*>-Tags nicht vorhanden sind.  
  
 Jedes Objekt, für das die Bindung festgelegt wird, wird durch ein XML-Element der Form \<*Objekt*>-ID gekennzeichnet (beispielsweise **DimensionID**). Nachdem das Objekt anhand der Form \<*Objekt*>-ID als eindeutig erkannt wurde, wird das Element angegeben, für das die Bindung festgelegt wurde, dies ist normalerweise **Source**. Häufig ist die **Source** eine Eigenschaft für das **DataItem**. Dies ist der Fall bei Spaltenbindungen in einem Attribut. In diesem Fall geben Sie nicht das **DataItem**-Tag an, sondern lediglich die **Source**-Eigenschaft, als befände sich diese direkt in der zu bindenden Spalte.  
