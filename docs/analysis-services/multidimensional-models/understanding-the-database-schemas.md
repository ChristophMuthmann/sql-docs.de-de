...
ms.topic: "article"
helpviewer_keywords: 
  - "Schemagenerierungs-Assistent, Datenbankschema"
  - "Datenbankschema [Analysis Services]"
  - "relationales Schema [Analysis Services], Datenbankschema"
  - "Schemaoptionen im Themenbereich [Analysis Services]"
  - "Schemaoptionen im Stagingbereich [Analysis Services]"
  - "Nicht normalisierte Schemas"
