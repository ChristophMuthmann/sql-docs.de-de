---
title: "Technische Referenz f&#252;r den Microsoft Decision Trees-Algorithmus | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### Diskrete und kontinuierliche Eingaben  
...
|4|Bayes-Dirichlet-Äquivalent (BDE) mit uniformer A-priori-Verteilung<br /><br /> (Standard)|  
 ...
 Eine Erläuterung dieser Bewertungsmethoden finden Sie unter [Feature Selection](../Topic/Feature%20Selection.md).  
...
### Regressoren in Entscheidungsstrukturmodellen  
