---
title: "Miningmodellinhalt (Analysis Services &amp;ndash;&lt;/ph&gt; Data Mining) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### Liste von Mininginhalts-Knotentypen  
...
### Knoten-ID, Name, Beschriftung und Beschreibung  
...
### Übergeordnete Knoten, untergeordnete Knoten und Knotenkardinalität  
...
|--------------------|-----------------|---------------------|  
|1|Nicht vorhanden|Gibt an, dass die Falldaten keinen Wert für dieses Attribut enthalten haben. Der **Missing** -Zustand wird getrennt von Attributen berechnet, die über Werte verfügen.|  
...
### Knotenwahrscheinlichkeit und marginale Wahrscheinlichkeit  
