---
title: "Miningstrukturen (Analysis Services - Data Mining) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  ...
  - "Miningstrukturen [Analysis Services] Informationen zu Miningstrukturen"
  - "Miningstrukturen [Analysis Services]"
  - "Data Mining [Analysis Services], Struktur"
  - "Analysis Services-Objekte, Data Mining-Objekte"
...
### Anzeigen von Miningstrukturen  
 ...
 Die Anweisung `SELECT * FROM <model>.CASES` gibt die gleichen Spalten zurück, aber nur für die Fälle in dem betreffenden Modell. Weitere Informationen finden Sie unter [SELECT FROM &#60;structure&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md) und [SELECT FROM &#60;model&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md).  
...
|Arbeiten mit Miningstrukturen, die auf Cubes basieren|[Erstellen einer neuen OLAP-Miningstruktur](../../analysis-services/data-mining/create-a-new-olap-mining-structure.md)<br /><br /> [Filtern des Quellcubes für eine Miningstruktur](../Topic/Filter%20the%20Source%20Cube%20for%20a%20Mining%20Structure.md)|  
