---
title: "Definieren von Partitionen im DirectQuery-Modellen (SSAS Tabular) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
---
# Definieren von Partitionen im DirectQuery-Modellen (SSAS Tabular)
...
|DataView=Sample<br /><br /> Gilt für Tabular 1200-Modelle mit Beispieldatenansichten|Verarbeitung von Partitionen zulassen|Wenn das Modell Beispieldaten verwendet, können Sie die Tabelle verarbeiten, um ein gefiltertes Dataset zurückzugeben, das während des Modellentwurfs optische Hilfen bereitstellt.|  
