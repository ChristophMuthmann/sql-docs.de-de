...
manager: "erikre"
---
# Konfigurieren von Tabellenverhaltenseigenschaften f&#252;r Power View-Berichte (SSAS – tabellarisch)
...
### Bilder fehlen  
 ...
 ![Bild-URLs werden in einem Bericht als Text angezeigt.](../../analysis-services/tabular-models/media/ssas-rptprop-noimageurl.gif "Bild-URLs werden in einem Bericht als Text angezeigt.")  
...
### In Tabellen fehlen eine oder mehrere Zeilen  
 ...
 ![Zeilendaten mit Duplikaten nach Zeilen-ID](../../analysis-services/tabular-models/media/ssas-jonyang.gif "Zeilendaten mit Duplikaten nach Zeilen-ID")  
 ...
 **Vorher: Die Standardgruppierung auf der Grundlage von Feldern in einem Diagramm**  
 ...
 ![Diagramm auf Grundlage der Standardgruppierung auf Feldebene](../../analysis-services/tabular-models/media/ssas-rptprop-chartfieldgroup.gif "Diagramm auf Grundlage der Standardgruppierung auf Feldebene")  
  
 **Nachher: Gruppierung zu Zeilenbezeichner (Zeilenbezeichner wird zur Achse)**  
  
 ![Diagramm auf Grundlage der Zeilen-ID-Gruppierung](../../analysis-services/tabular-models/media/ssas-rptprop-chartrowid.gif "Diagramm auf Grundlage der Zeilen-ID-Gruppierung")  
