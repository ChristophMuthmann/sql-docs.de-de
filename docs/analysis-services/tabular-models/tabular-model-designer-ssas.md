---
title: "Tabellen-Modell-Designer (SSAS) | Microsoft Docs"
ms.date: "03/14/2017"
 ...
 **Von Server importieren (tabellarisch)**  
 ...
 Ältere Modelle haben ältere Kompatibilitätsgrade. Sie können durch Ändern der Kompatibilitätsgradeigenschaft nach dem Importieren der Modelldefinition auf 1200 aktualisieren.  
...
### Codefenster anzeigen  
 Sie können den Code hinter einer „Model.bim“-Datei anzeigen, indem Sie mit der rechten Maustaste auf die Datei klicken und im Projektmappen-Explorer **Code anzeigen** auswählen. Für tabellarische Modelle mit Kompatibilitätsgrad 1200 wird die Modelldefinition im JSON-Format ausgedrückt.  
...
### Tabellenmodell-Explorer
  Der Tabellenmodell-Explorer, der in der Version von August 2016 (14.0.60812.0) der [SQL Server Data Tools](https://msdn.microsoft.com/mt186501) eingeführt wurde, unterstützt Sie bei der Navigation von Metadatenobjekten in tabellarischen 1200-Modellen.
