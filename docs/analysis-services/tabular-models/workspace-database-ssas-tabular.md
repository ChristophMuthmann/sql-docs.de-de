...
## Angeben einer Arbeitsbereichinstanz  
...
> [!NOTE]  
>  Im Modus „Integrierter Arbeitsbereich“ wird die lokale Analysis Services-Instanz in einer 64-Bit-Version und SSDT für Analysis Services-Projekte für tabellarische Modelle in der 32-Bit-Umgebung von Visual Studio ausgeführt. Wenn Sie eine Verbindung zu speziellen Datenquellen herstellen, sollten Sie unbedingt sowohl die 32-Bit- als auch die 64-Bit-Version der entsprechenden Datenanbieter auf Ihrer Arbeitsstation installieren. Der 64-Bit-Anbieter ist für die 64-Bit-Instanz von Analysis Services erforderlich, während die 32-Bit-Version ist für den Tabellenimport-Assistenten in SSDT für Analysis Services-Projekte für tabellarische Modelle benötigt wird.

###  <a name="bkmk_overview"></a> Der Arbeitsbereichsserver  
...
-   Sie können keine Daten aus einer [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Arbeitsmappe importieren, wenn Sie mit der Projektvorlage für das Importieren von Daten aus [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] ein neues Tabellenmodellprojekt erstellen.  
  ...
  > [!IMPORTANT]  
>  Der Kompatibilitätsgrad für das Modell und der Arbeitsbereichsserver müssen zueinander passen. Für tabellarische Modelle mit dem Kompatibilitätsgrad **SQL Server 2016 RTM (1200)** muss es sich beim Arbeitsbereichsserver um eine tabellarische [!INCLUDE[ssASCurrent](../../includes/ssascurrent-md.md)]-Instanz handeln.  
