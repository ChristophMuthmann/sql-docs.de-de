...
### -Credential \<PSCredential>  
 ...
 Um diesen Parameter zu verwenden, erstellen Sie zuerst mit Get-Credential ein PSCredential-Objekt, um den Benutzernamen und das Kennwort anzugeben (z.B. `$Cred=Get-Credential “adventure-works\admin”`. Sie können dieses Objekt dann an den –Credential-Parameter `(-Credential:$Cred` weitergeben).  
  
 Weitere Informationen über Authentifizierung und die Verwendung von Anmeldeinformationen finden Sie unter [PowerShell-Skripts in Analysis Services](../../analysis-services/instances/powershell-scripting-in-analysis-services.md). Weitere Informationen zum HTTP-Zugriff finden Sie unter [Konfigurieren von HTTP-Zugriff auf Analysis Services unter Internetinformationsdienste &#40;IIS&#41; 8.0](../../analysis-services/instances/configure http access to analysis services on iis 8.0.md).  
