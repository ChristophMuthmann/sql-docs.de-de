...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Entfernt ein Mitglied aus der angegebenen Rolle einer Analysis Services-Datenbank.  
