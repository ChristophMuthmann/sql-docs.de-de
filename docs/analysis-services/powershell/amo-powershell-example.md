---
title: "Beispiel f&#252;r AMO PowerShell | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Beispiel f&#252;r AMO PowerShell
  Das folgende PowerShell-Beispielskript ruft Analysis Services Management Object-Typen (AMO) für die Erstellung einer tabellarischen Datenbank (Kompatibilitätsgrad 1200) auf Basis einer relationalen SQL Server-Datenbank auf.  
  
 Dieses Beispiel dient ausschließlich Demonstrationszwecken. Es endet noch vor der Definition der Tabellenbeziehungen und beinhaltet keinen Datenimport.  Das Skript ist also lediglich ein Codefragment und nicht wirklich ausführbar. Um ausgeführt werden zu können, müsste es weitere Hilfsfunktionen und Befehle enthalten.  
  
## DatabaseGenerate.ps1 – Beispiel  
