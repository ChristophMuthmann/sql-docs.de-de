...
10. Klicken Sie im Bereich **Tabellen** mit der rechten Maustaste auf **InternetSalesReason (dbo.FactInternetSalesReason)**, und klicken Sie anschließend auf **Daten durchsuchen**.  
    ...
    ![Schlüsselwert zum Identifizieren des Verkaufsgrundes für Käufe](../analysis-services/media/l5-many-to-many-1.png "Schlüsselwert zum Identifizieren des Verkaufsgrundes für Käufe")  
...
4.  Wählen Sie in der **Zwischenmeasuregruppe**-Liste **Internet Sales Reason** aus.  
    ...
    ![Beziehung definieren (Dialogfeld)](../analysis-services/media/l5-many-to-many-3.gif "Beziehung definieren (Dialogfeld)")  
...
2.  Wechseln Sie nach erfolgreichem Abschluss der Bereitstellung im Cube-Designer für den [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial-Cube zur Registerkarte **Browser**, und klicken Sie anschließend auf **Verbindung wiederherstellen**.  
