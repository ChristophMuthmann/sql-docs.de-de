...
9. Erweitern Sie in der Feldliste die **Employee**-Dimension, erweitern Sie **Organization**, und ziehen Sie anschließend **Sick Leave Hours** auf **Spaltenbezeichnungen**.  
    ...
    ![Sales dimensioniert nach den Krankheitstagen des Angestellten](../analysis-services/media/l4-discretizationmethod-2.gif "Sales dimensioniert nach den Krankheitstagen des Angestellten")  
...
[Ausblenden und Deaktivieren von Attributhierarchien](../analysis-services/hiding-and-disabling-attribute-hierarchies.md)  
  
## Siehe auch  
[Gruppieren von Attributelementen &#40;Diskretisierung&#41;](../analysis-services/multidimensional-models/group-attribute-members-discretization.md)  
