...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Identifiziert eine Partition innerhalb eines übergeordneten Elements, das einen Objektverweis enthält.  
