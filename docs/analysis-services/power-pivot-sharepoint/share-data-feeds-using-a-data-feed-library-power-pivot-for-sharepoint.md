...
---
# Freigeben von Datenfeeds mithilfe einer Datenfeedbibliothek (PowerPivot f&#252;r SharePoint)
...
> [!NOTE]  
>  Obwohl Datenfeeds zum Hinzufügen von Webdaten zu einer in einem [!INCLUDE[ssGeminiClient](../../includes/ssgeminiclient-md.md)] erstellten [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Datenquelle verwendet werden, kann jede Clientanwendung, die Atom-Feeds lesen kann, Datendienstdokumente verarbeiten.  
