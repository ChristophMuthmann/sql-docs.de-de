---
title: "Konfigurieren oder Reparieren von PowerPivot f&#252;r SharePoint 2013 (PowerPivot-Konfigurationstool) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|**Erstellen einer [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Dienstanwendung**|Name der Dienstanwendung|Standardwert|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Dienstanwendungsname: Der Standardname lautet **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Standarddienstanwendung**. Sie können einen anderen Wert im Tool ersetzen.|  
...
1.  Klicken Sie auf einer SharePoint 2013-Website auf das Einstellungssymbol ![SharePoint-Einstellungen](../../analysis-services/media/as-sharepoint2013-settings-gear.png "SharePoint-Einstellungen") und dann auf **Websiteeinstellungen**.  
...
### Erstellen einer [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Arbeitsmappe  
...
-   [Neuigkeiten in PowerPivot in Excel 2013](http://office.microsoft.com/excel-help/whats-new-in-powerpivot-in-excel-2013-HA102893837.aspx?CTT=1) (http://office.microsoft.com/excel-help/whats-new-in-powerpivot-in-excel-2013-HA102893837.aspx?CTT=1).  
...
### Hinzufügen zusätzlicher Analysis Services-Server im SharePoint-Modus  
