---
title: "Konfigurieren und Anzeigen der SharePoint-Protokolldateien und -Diagnoseprotokollierung (PowerPivot f&#252;r SharePoint) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
3.  Scrollen Sie zum **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Dienst**.  
  
4.  Erweitern Sie die Kategorie, und wählen Sie einzelne Kategorien aus:  
  
     Unter **Anwendungsseitenanforderung** werden Ereignisse angegeben, die beim Suchen einer [!INCLUDE[ssGeminiSrv](../../includes/ssgeminisrv-md.md)]-Instanz zum Laden einer [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Datenquelle und zum Kommunizieren mit anderen Servern in der Farm von der Dienstanwendung ausgelöst werden.  
  
     Unter **Anforderungsverarbeitung** werden Ereignisse angegeben, die durch Abfrageanforderungen für eine auf einem Server in der Farm geladene [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Datenbank ausgelöst wurden.  
  
     **Verwendung** gibt ein auf die Sammlung von [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Verwendungsdaten bezogenes Ereignis an.  
...
-   Suchen Sie nach dem Fehlerstatus "Hoch" oder "Ausnahme". Suchen Sie nach „[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Dienst“.  
...
#### Verwenden einer Protokoll-Viewer-Anwendung  
...
#### Einträge für PowerPivot-Dienste  
...
|w3wp.exe|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Dienst|Web-Front-End|Ausführlich|Die Suche nach dem Anwendungsserver war erfolgreich.|Die Anfrage wurde einer [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Dienstanwendung zugeordnet.|  
|w3wp.exe|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Dienst|Web-Front-End|Ausführlich|Umleiten der Anforderung für die \<*PowerPivotdata-Quelle*> an den [!INCLUDE[ssGeminiSrv](../../includes/ssgeminisrv-md.md)].|Die Anforderung wurde an den [!INCLUDE[ssGeminiSrv](../../includes/ssgeminisrv-md.md)]weitergeleitet.|  
|w3wp.exe|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Dienst|Anforderungsverarbeitung|Ausführlich|Umleiten der Anforderung für UserName\<*SharePoint-Benutzer*> an die Datenbank|Eine personifizierte Verbindung zur [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Datenquelle wurde für den SharePoint-Benutzer erstellt.|  
