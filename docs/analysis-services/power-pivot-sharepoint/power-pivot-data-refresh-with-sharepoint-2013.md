...
|Excel 2013|Unterstützt|Supported|  
...
##  <a name="bkmk_scheduled_refresh"></a> planmäßige Datenaktualisierung  
...
4.  Zum angegebenen Zeitpunkt sendet der [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Systemdienst eine Anforderung an Excel Services für folgende Aktionen:  
 ...
 ![Datenaktualisierung verwalten (Kontextmenü)](../../analysis-services/power-pivot-sharepoint/media/as-manage-datarefresh-sharepoint2013.gif "Datenaktualisierung verwalten (Kontextmenü)")  
...
1.  Klicken Sie in der SharePoint-Zentraladministration in der Gruppe **Allgemeine Anwendungseinstellungen** auf **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]-Management-Dashboard**.  
...
4.  In the **Verbindungseigenschaften** auf **Definition**und dann auf die Schaltfläche **Authentifizierungseinstellungen** aus.  
 ...
 ![Excel Services-Authentifizierungseinstellungen](../../analysis-services/power-pivot-sharepoint/media/as-authentication-settings-4-ecs-in-excel2013.gif "Excel Services-Authentifizierungseinstellungen")  
