---
title: "Stagingtabelle f&#252;r Blattelemente (Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "04/01/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Stagingtabelle für Elemente [Master Data Services]"
  - "Datenbank [Master Data Services], Stagingtabelle für Elemente"
...
---
# Stagingtabelle f&#252;r Blattelemente (Master Data Services)
  Verwenden Sie die Blattelemente Stagingtabelle (stg.name_Leaf) in der [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] Datenbank zu erstellen, aktualisieren, deaktivieren und löschen Blattelemente. Sie können sie auch zum Aktualisieren von Attributwerten für Blattelemente verwenden.  
...
|**ErrorCode**|Zeigt einen Fehlercode an. Für alle Datensätze mit einem **ImportStatus_ID** der **2**, finden Sie unter [Fehler des Stagingprozesses & #40; Master Data Services & #41;](../master-data-services/staging-process-errors-master-data-services.md).||  
|**Code**<br /><br /> Erforderlich, außer wenn Codes automatisch für generiert werden **ImportType1** oder **2**; finden Sie unter [Automatische Erstellung von Code & #40; Master Data Services & #41;](../master-data-services/automatic-code-creation-master-data-services.md) Weitere Informationen|Ein eindeutiger Code für das Element.||  
|**Name**<br /><br /> Optional|Ein Name für das Element.||  
|**NewCode**|Nur verwenden, wenn Sie den Elementcode ändern.||  
|\< Attributname>|Für jedes Attribut in der Entität ist eine Spalte vorhanden. Verwenden Sie dieses mit einem **ImportType** von **0** oder **2**. Geben Sie für Freiformattribute den neuen Text oder Zeichenfolgenwert für das Attribut an. Für domänenbasierte Attribute geben Sie den Code für das Element an, das als Attribut verwendet wird. Bei Linkattributen muss die URL mit beginnen **http://**.<br /><br /> Hinweis: Sie können keine Dateiattribute bereitstellen.||  
  
## Siehe auch  
 [Übersicht: Importieren von Daten aus Tabellen & #40; Master Data Services & #41;](../master-data-services/overview-importing-data-from-tables-master-data-services.md)   
 [Anzeigen von Fehlern, die auftreten, während Staging & #40; Master Data Services & #41;](../master-data-services/view-errors-that-occur-during-staging-master-data-services.md)   
 [Fehler des Stagingprozesses & #40; Master Data Services & #41;](../master-data-services/staging-process-errors-master-data-services.md)  
