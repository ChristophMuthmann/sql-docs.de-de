---
title: "Aktualisiert - Master Data Services für SQL Server-Dokumentation | Microsoft Docs"
description: "Codeausschnitte anzeigen aktualisierter Inhalt in zuletzt geänderten Dokumentation für Master Data Services (MDS) für Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
---
# <a name="new-and-recently-updated-master-data-services-for-sql-server"></a>Neue und kürzlich aktualisierte: Master Data Services für SQLServer
...
- *Bereich für die Themenbereichsdatenbank:* &nbsp; **Master Data Services (MDS) für SQL Server**.
...
1. [Installing Master Data Services in an AlwaysOn Environment (Installieren von Master Data Services in einer AlwaysOn-Umgebung)](installing-mds-in-an-alwayson-group-environment/installing-mds-in-an-alwayson-group-environment.md)
