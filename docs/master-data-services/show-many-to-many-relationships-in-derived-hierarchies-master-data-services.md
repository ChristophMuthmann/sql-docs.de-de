...
Eine Anleitung zum Bereitstellen des Customer-Beispielmodells und weitere in [!INCLUDE[ssMDSshort_md](../includes/ssmdsshort-md.md)] enthaltene Beispielmodelle finden Sie unter [Bereitstellen von Beispielmodelle und Daten](../sql-server/media/master-data-services.png#deploySample).   
