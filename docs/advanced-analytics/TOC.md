...
## [R-Paketverwaltung für SQL Server](r/r-package-management-for-sql-server-r-services.md)
...
### [Konfigurieren von Python-Tools für die Verwendung mit SQL Server](python/setup-python-client-tools-sql.md)
