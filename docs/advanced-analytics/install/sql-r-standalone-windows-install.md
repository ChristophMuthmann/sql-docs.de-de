...
Dieser Artikel beschreibt, wie SQL Server 2016-Setup zum Installieren der eigenständigen Version des **SQL Server 2016 R Server**. Wenn Sie eine Enterprise Edition oder Software Assurance verfügen, ist das Installieren des eigenständigen R-Server auf einem Produktionsserver kostenlos.
