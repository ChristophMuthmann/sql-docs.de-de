---
title: "Erstellen von Modellen (Tieferer Einblick in Data Science) | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
manager: "jhubbard"
---
# Erstellen von Modellen (Tieferer Einblick in Data Science)
...
Nun erstellen Sie ein logistisches Regressionsmodell, das angibt, ob ein bestimmter Kunde ein Betrugs-Risiko ist.  
  
Verwenden Sie die Funktion *rxLogit* (enthalten im **RevoScaleR**-Paket), die die Anpassung der logistischen Regressionsmodelle in Remotecomputekontexten unterstützt.  
...
## Nächster Schritt  
[Bewerten neuer Daten &#40;Tieferer Einblick in Data Science&#41;](../../advanced-analytics/r-services/score-new-data-data-science-deep-dive.md)  
