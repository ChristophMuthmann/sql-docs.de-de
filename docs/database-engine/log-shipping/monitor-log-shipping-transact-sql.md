---
title: "&#220;berwachen des Protokollversands (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Protokollversand [SQL Server], Status"
  - "Verlaufstabellen [SQL Server]"
  - "Verlaufsinformationen [SQL Server], Protokollversand"
  - "Protokollversands [SQL Server], überwachen"
  - "Warnungen [SQL Server], Protokollversand"
  - "Statusinformationen [SQL Server], Protokollversand"
  - "Überwachen des Protokollversands [SQL Server]"
