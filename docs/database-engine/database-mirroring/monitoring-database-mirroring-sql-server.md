---
title: "&#220;berwachen der Datenbankspiegelung (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Überwachung [SQL Server], Datenbankspiegelung"
...
#### Datenbank-Spiegelungsstatustabelle  
...
#### Überwachen des Datenbank-Spiegelungsstatus (durch Systemadministratoren)  
...
#### Überwachen des Datenbankspiegelungs-Status (durch dbm_monitor Members)  
...
#### Löschen des Auftrags für den Datenbankspiegelungs-Monitor  
...
#### Protokoll auf dem Prinzipalserver  
...
#### Protokoll auf dem Spiegelserver  
...
-   **sys.database_mirroring_witnesses**  
     ...
     Diese Katalogsicht zeigt die Metadaten für die Datenbankspiegelung für jede Sitzung an, bei der eine Serverinstanz Zeuge ist. Weitere Informationen finden Sie unter [sys.database_mirroring_witnesses &#40;Transact-SQL&#41;](../Topic/sys.database_mirroring_witnesses%20\(Transact-SQL\).md).  
  
-   **sys.dm_db_mirroring_connections**  
  
     Diese dynamische Verwaltungssicht gibt für jede Datenbankspiegelungs-Netzwerkverbindung eine Zeile zurück.  
  
     Weitere Informationen finden Sie unter [sys.dm_db_mirroring_connections &#40;Transact-SQL&#41;](../Topic/sys.dm_db_mirroring_connections%20\(Transact-SQL\).md).  
