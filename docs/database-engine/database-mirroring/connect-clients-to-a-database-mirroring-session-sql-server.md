---
title: "Verbinden von Clients mit einer Datenbank-Spiegelungssitzung (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Partner [SQL Server], Herstellen von Clientverbindungen"
  - "Datenbankspiegelung [SQL Server], Herstellen von Clientverbindungen"
  - "Clientverbindungen [SQL Server], Datenbankspiegelung"
  - "Verbindungen [SQL Server], Datenbankspiegelung"
 ...
 **In diesem Thema:**  
 ...
 [Herstellen der Anfangsverbindung mit einer Datenbank-Spiegelungssitzung](#InitialConnection)  
 Enthält Erläuterungen zum ersten Partnernamen und zum Namen des Failoverpartners sowie dazu, wie Datenzugriffsanbieter die erste Verbindung mit einer gespiegelten Datenbank herstellen. Beschreibt außerdem die Attribute der für die Verbindung mit einer gespiegelten Datenbank verwendeten Verbindungszeichenfolge.  
  
 [Algorithmus für zu wiederholende Verbindungsversuche (für TCP/IP-Verbindungen)](#RetryAlgorithm)  
 Beschreibt den Algorithmus für zu wiederholende Verbindungsversuche für TCP/IP-Verbindungen.  
  
 [Erneutes Herstellen einer Verbindung mit einer Datenbank-Spiegelungssitzung](#Reconnecting)  
 Beschreibt das Herstellen einer erneuten Verbindung mit einer gespiegelten Datenbank, wenn bei einer bereits eingerichteten Verbindung mit einer Datenbank-Spiegelungssitzung aus irgendeinem Grund ein Fehler auftritt, sowie die Auswirkung einer Umleitung auf eine Clientanwendung.  
  
 [Auswirkungen eines veralteten Failoverpartnernamens](#StalePartnerName)  
 Erläutert, mit welchen Auswirkungen zu rechnen ist, wenn ein Datenbankadministrator einen der Spiegelungspartner für eine gespiegelte Datenbank ändert.  
...
>  Wird die Spiegelungssitzung angehalten, stellt der Client normalerweise eine Verbindung mit dem Prinzipalserver her und lädt den Namen des Partners herunter. Die Datenbank steht dem Client jedoch erst nach dem Fortsetzen der Spiegelung wieder zur Verfügung.  
 ...
 ![Clientverbindung, wenn der Anfangspartner Prinzipal ist](../../database-engine/database-mirroring/media/dbm-initial-connection.gif "Clientverbindung, wenn der Anfangspartner Prinzipal ist")  
...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client überprüft zwar, ob die Verbindung mit einer Prinzipalserverinstanz hergestellt wird, aber nicht, ob diese Instanz der Partner der Serverinstanz ist, die im ersten Partnernamen der Verbindungszeichenfolge angegeben war.  
