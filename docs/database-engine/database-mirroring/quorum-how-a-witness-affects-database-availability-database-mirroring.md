---
title: "Quorum: Auswirkungen eines Zeugen auf die Datenbankverf&#252;gbarkeit (Datenbankspiegelung) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Quorum [SQL Server], Datenbankspiegelung"
  - "Ungeschütztes Laufen bei der Datenbankspiegelung [SQL Server]"
  - "Quorum zwischen Zeuge und Partner [SQL Server]"
  - "Partner [SQL Server], Quorum zwischen Partnern"
  - "Zeuge [SQL Server], Quorum"
  - "Besitzen des Quorums [SQL Server]"
  - "Quorum [SQL Server]"
  - "Spiegeldatenbank [SQL Server]"
  - "Vollständiges Quorum [SQL Server]"
