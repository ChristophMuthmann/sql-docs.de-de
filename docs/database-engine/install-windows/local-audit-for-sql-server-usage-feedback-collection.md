---
title: "Lokale &#220;berwachung f&#252;r Feedbackerfassung zur SQL Server-Nutzung | Microsoft Docs"
ms.custom: ""
ms.date: "02/28/2017"
...
## Vorkonfigurationsschritte vor der Aktivierung der lokalen Überwachung 
...
1. Er muss eine Registrierungsschlüsseleinstellung erstellen, um das Zielverzeichnis für die lokale Überwachung zu konfigurieren. 
    ...
    Er muss für das Datenbankmodul den Schlüssel unter *HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Microsoft SQL Server\\MSSQL13.\<INSTANCENAME\>\\CPE* erstellen. 
    
    Er muss für Analysis Services den Schlüssel unter *HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Microsoft SQL Server\\MSAS13.\<INSTANCENAME\>\\CPE* erstellen.

### Abrufen des Anmeldekontos für den SQL Server CEIP-Dienst
...
2. Navigieren Sie zu dem entsprechenden Dienst. Suchen Sie z. B. für das Datenbankmodul nach **SQL Server CEIP-Dienst *Instanzname***. Suchen Sie für Analysis Services nach **SQL Server Analysis Services CEIP *Instanzname***. 
...
### Er muss einen neuen Ordner für die Dateien der lokalen Überwachung konfigurieren.    
...
> Hinweis: Konfigurieren Sie den Verzeichnispfad für die lokale Überwachung außerhalb des SQL Server-Installationspfads, um zu vermeiden, dass die Überwachungsfunktionen und das Patchen zu potenziellen Problemen mit SQL Server führen.
  ...
  |------|-----------------|----------|  
  |![Checkbox](../../database-engine/availability-groups/windows/media/checkboxemptycenterxtraspacetopandright.gif "Checkbox")|Speicherplatzverfügbarkeit |Planen Sie für mittlere Arbeitsauslastungen mit ungefähr 10 Datenbanken ca. 2 MB an Speicherplatz pro Tag und Instanz ein.|  
...
### Erteilen von Berechtigungen für das Anmeldekonto für den SQL Server CEIP-Telemetriedienst
...
### Er muss eine Registrierungsschlüsseleinstellung erstellen, um das Zielverzeichnis für die lokale Überwachung zu konfigurieren.

1. Starten Sie „regedit“.  

1. Navigieren Sie zu dem entsprechenden CPE-Pfad. 

    Verwenden Sie für das Datenbankmodul *HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Microsoft SQL Server\\MSSQL13.\<INSTANCENAME\>\\CPE*. 
    
    Verwenden Sie für Analysis Services *HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Microsoft SQL Server\\MSAS13.\<INSTANCENAME\>\\CPE*.
...
## Aktivieren oder Deaktivieren der lokalen Überwachung
...
## Datenwörterbuch für die Ausgabedatenstruktur der lokalen Überwachung 
...
### Definition und Beispiele für Name-Wert-Paare 
...
|query| Die auf queryIdentifier bezogene T-SQL-Abfragedefinition, die Daten erzeugt, falls zutreffend.        Diese Komponente wird nicht vom SQL Server CEIP-Dienst hochgeladen. Sie ist in der lokalen Überwachung nur als Referenz für Kunden enthalten.| SELECT\n      SERVERPROPERTY(\u0027Collation\u0027) AS [Collation],\n      SERVERPROPERTY(\u0027IsFullTextInstalled\u0027) AS [SqlFTinstalled],\n      SERVERPROPERTY(\u0027IsIntegratedSecurityOnly\u0027) AS [SqlIntSec],\n      SERVERPROPERTY(\u0027IsSingleUser\u0027) AS [IsSingleUser],\n      SERVERPROPERTY (\u0027FileStreamEffectiveLevel\u0027) AS [SqlFilestreamMode],\n      SERVERPROPERTY(\u0027IsPolybaseInstalled\u0027) AS [SqlPbInstalled],\n      SERVERPROPERTY(\u0027PolybaseRole\u0027) AS [SqlPbNodeRole],\n      SERVERPROPERTY(\u0027ProductMajorVersion\u0027) AS [SqlVersionMajor],\n      SERVERPROPERTY(\u0027ProductMinorVersion\u0027) AS [SqlVersionMinor],\n      SERVERPROPERTY(\u0027ProductBuild\u0027) AS [SqlVersionBuild],\n      SERVERPROPERTY(\u0027ProductBuildType\u0027) AS ProductBuildType,\n      SERVERPROPERTY(\u0027ProductLevel\u0027) AS ProductLevel,\n      SERVERPROPERTY(\u0027ProductUpdateLevel\u0027) AS ProductUpdateLevel,\n      SERVERPROPERTY(\u0027ProductUpdateReference\u0027) AS ProductUpdateReference,\n      RIGHT(CAST(SERVERPROPERTY(\u0027ProductVersion\u0027) AS NVARCHAR(30)),CHARINDEX(\u0027.\u0027, REVERSE(CAST(SERVERPROPERTY(\u0027ProductVersion\u0027) AS NVARCHAR(30)))) - 1) AS ProductRevision,\n      SERVERPROPERTY(\u0027EditionID\u0027) AS SQLEditionId,\n      SERVERPROPERTY(\u0027IsClustered\u0027) AS IsClustered,\n      SERVERPROPERTY(\u0027IsHadrEnabled\u0027) AS IsHadrEnabled,\n      SERVERPROPERTY(\u0027IsAdvancedAnalyticsInstalled\u0027) AS [SqlAdvAInstalled],\n      @@PACK_RECEIVED AS PacketReceived,\n      @@VERSION AS Version
...
### Dateibeispiele für die lokale Überwachung
