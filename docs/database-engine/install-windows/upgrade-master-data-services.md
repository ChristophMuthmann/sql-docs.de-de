---
title: "Aktualisieren von Master Data Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
# Aktualisieren von Master Data Services
  Im Folgenden sind die Szenarien zum Aktualisieren auf Microsoft [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] aufgelistet.  
...
> -   Nachdem Data Quality Services und Master Data Services auf [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] aktualisiert wurden, funktioniert keine frühere Version des Master Data Services-Add-Ins für Excel mehr. Sie können das [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]-Master Data Services-Add-In für Excel aus dem [Microsoft Download Center](http://www.microsoft.com/en-us/download/details.aspx?id=47343) herunterladen.  
  
##  <a name="fileLocation"></a> Dateispeicherort  
  
-   In [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] werden die Dateien standardmäßig in *Laufwerk*:\Programme\Microsoft SQL Server\130\Master Data Services installiert.  
...
##  <a name="noengine"></a> Upgrade ohne Datenbankmodulupgrade  
 In diesem Szenario verwenden Sie weiterhin [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)], um die MDS-Datenbank zu hosten. Sie müssen jedoch das Schema der MDS-Datenbank aktualisieren und dann eine [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]-Webanwendung erstellen, um auf die MDS-Datenbank zuzugreifen. Auf die MDS-Datenbank kann nicht mehr von der [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]-, [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]- oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]-Webanwendung aus zugegriffen werden.  
  
 Sie können [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] und eine frühere Version von SQL Server ([!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]) auf demselben Computer installieren. Die Dateien werden in verschiedenen Speicherorten installiert, wie in [Dateispeicherort](#fileLocation) dargestellt.  
...
2.  Aktualisieren Sie das MDS-Datenbankschema.  
    ...
    1.  Öffnen Sie die [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]-Version von [!INCLUDE[ssMDScfgmgr](../../includes/ssmdscfgmgr-md.md)].  
    ...
    3.  Klicken Sie im rechten Bereich auf **Datenbank auswählen**, und geben Sie die Informationen für Ihre [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]-, [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]- oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]-Datenbankinstanz an.  
...
##  <a name="engine"></a> Upgrade mit Datenbankmodulupgrade  
 In diesem Szenario aktualisieren Sie sowohl das Datenbankmodul als auch die [!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)]-Anwendung von [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] auf [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)].  
...
2.  Aktualisieren Sie das Datenbankmodul auf [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]. Weitere Informationen finden Sie unter [Auswählen einer Upgrademethode für das Datenbankmodul](../../database-engine/install-windows/choose-a-database-engine-upgrade-method.md).  
...
##  <a name="twocomputer"></a> Upgrade in einem Szenario mit zwei Computern  
 In diesem Szenario wird das Upgrade eines Systems durchgeführt, in dem SQL Server auf zwei Computern installiert ist: auf einem ist [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] installiert, auf dem anderen [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)].  
  
 Wenn [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] installiert ist, verwenden Sie weiterhin [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] zum Hosten Ihrer MDS-Datenbank auf einem Computer. Sie müssen jedoch das Schema der MDS-Datenbank aktualisieren und dann die [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]-Webanwendung verwenden, um auf die MDS-Datenbank zuzugreifen. Auf die MDS-Datenbank kann nicht mehr von der [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]-, [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]- oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]-Webanwendung aus zugegriffen werden.  
...
##  <a name="restore"></a> Upgrade mithilfe einer Wiederherstellung einer Datenbank aus einer Sicherung  
 In diesem Szenario ist [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] zusammen mit [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] auf demselben Computer oder auf zwei unterschiedlichen Computern installiert. Vor dem Upgrade wurde eine Datenbank in einer früheren Version als [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] gesichert und muss nun wiederhergestellt werden.  
...
## Problembehandlung  
 **Problem**: Wenn Sie die [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]-, [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]- oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)][!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)]-Webanwendung öffnen, wird die Fehlermeldung „Die Clientversion ist nicht mit der Datenbankversion kompatibel“ angezeigt.  
  
 **Lösung**: Dieses Problem tritt auf, wenn eine [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]-, [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]- oder [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]-Master Data Manager-Webanwendung versucht, auf eine Datenbank zuzugreifen, die auf [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]-Master Data Services aktualisiert wurde. Sie müssen stattdessen eine [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]-Webanwendung verwenden.  
