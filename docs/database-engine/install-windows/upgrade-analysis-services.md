---
title: "Aktualisieren von Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
helpviewer_keywords: 
  ...
  - "Datenbanken [Analysis Services], Upgrades"
  - "Installieren von Analysis Services, parallele Installationen"
  - "Analysis Services-Upgrades"
  - "Analysis Services-Upgrades, Informationen zum Aktualisieren von Analysis Services"
  - "SSAS, Datenbankmigration"
  - "Aktualisieren von Analysis Services"
  - "Installieren von Analysis Services, aktualisieren"
  - "SSAS, aktualisieren"
...
---
# Aktualisieren von Analysis Services
  Analysis Services-Instanzen können auf eine SQL Server 2016-Version mit demselben Servermodus aktualisiert werden, um von den Features zu profitieren, die in der aktuellen Version eingeführt wurden. Informationen zu diesen Features finden Sie unter [Neuigkeiten in Analysis Services](../../analysis-services/what-s-new-in-analysis-services.md).  
...
-   In den [Versionsanmerkungen zu SQL Server 2016](http://go.microsoft.com/fwlink/?LinkID=398124) werden bekannte Probleme und Umgehungen beschrieben.  
...
## Upgrade eines tabellarischen Modells auf Kompatibilitätsgrad 1200  
...
## Aufgaben nach dem Upgrade tabellarischer Modelle auf Kompatibilitätsgrad 1200  
...
## Upgrade von tabellarischen Modellen im DirectQuery-Modus  
...
4.  Aktivieren Sie **DirectQuery** erneut. Weitere Informationen finden Sie unter [DirectQuery für tabellarische 1200-Modelle](../Topic/DirectQuery%20for%20Tabular%201200%20models.md).  
