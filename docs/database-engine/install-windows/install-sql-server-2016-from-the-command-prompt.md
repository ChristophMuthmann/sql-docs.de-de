---
title: "Installieren von SQL Server 2016 von der Eingabeaufforderung | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Installieren von SQL Server, Eingabeaufforderung"
  - "Installationsskripts [SQL Server]"
  - "Wartungsskripts [SQL Server]"
  - "REMOVENODE-Eigenschaft"
  - "Komponenten [SQL Server], Entfernen"
  - "Eingabeaufforderung [SQL Server], SQL Server-Installationen"
  - "ASACCOUNT-Parameter"
  - "Failoverclustering [SQL Server], installieren"
  - "Masterdatenbank [SQL Server], neu erstellen"
  - "SQLCOLLATION-Parameter"
  - "Cluster [SQL Server], installieren"
  - "Unbeaufsichtige Installationen [SQL Server]"
  - "Ändern von Sortierungen"
  - "AGTPASSWORD-Parameter"
  - "USESYSDB-Parameter"
  - "RSPASSWORD-Parameter"
  - "AUTOSTART-Parameter"
  - "ASPASSWORD-Parameter"
  - "Eigenständige Installationen [SQL Server]"
  - "SAMPLEDATABASESERVER-Parameter"
  - "Hinzufügen von Komponenten"
  - "SAPWD-Parameter"
  - "Skripts [SQL Server], deinstallieren"
  - "Remoteinstallationen [SQL Server]"
  - "Komponenten [SQL Server], installieren"
  - "TARGETCOMPUTER-Parameter"
  - "REMOVENODE-Parameter"
  - "REINSTALLMODE-Parameter"
  - "Skripts [SQL Server], Wartung"
  - "Wiederherstellung der Registrierung"
  - "SQLPASSWORD-Parameter"
  - "Erneutes Erstellen von Datenbanken"
  - "IP-Eigenschaft"
  - "PIDKEY-Parameter"
  - "RSCONFIGURATION-Parameter"
  - "ADDLOCAL-Parameter"
  - "Setup [SQL Server], Eingabeaufforderung"
  ...
  - "Parameter [SQL Server], SQL Server-Installationen"
  - "UPGRADE-Parameter"
  - "Tastenkombinationen [SQL Server]"
  ...
  - "GROUP-Eigenschaft"
  - "ERRORREPORTING-Eigenschaft"
  - "Deinstallationsskripts [SQL Server]"
  - "AGTACCOUNT-Parameter"
  - "SAVESYSDB-Parameter"
  - "INSTALLVS-Parameter"
  - "INSTANCENAME-Parameter"
  - "Skripts [SQL Server], Installationen"
  - "Erneutes Erstellen von Datenbanken, Master"
  - "Deinstallieren von SQL Server"
  - "ASCOLLATION-Parameter"
  - "INI-Dateien"
  - "ADDNODE-Parameter"
  - "Befehlszeileninstallationen [SQL Server]"
  - "VS-Parameter"
  - "INSTALLASDATADIR-Parameter"
  - "INSTALLSQLDIR-Parameter"
  - "Knoten [Failoverclustering], Eingabeaufforderung"
...
##  <a name="a-nameproperusea-proper-use-of-setup-parameters"></a><a name="ProperUse"></a> Richtige Verwendung von Setupparametern  
...
-   [Rollenparameter](../../database-engine/install-windows/install-sql-server-2016-from-the-command-prompt.md#RoleParameters)  
  
-   [Steuern des Failoververhaltens mithilfe des Parameters /FAILOVERCLUSTERROLLOWNERSHIP](../../database-engine/install-windows/install-sql-server-2016-from-the-command-prompt.md#RollOwnership)  
  
-   [Instanz-ID- oder InstanceID-Konfiguration](../../database-engine/install-windows/install-sql-server-2016-from-the-command-prompt.md#InstanceID) 
  
##  <a name="a-nameinstalla-installation-parameters"></a><a name="Install"></a> Installationsparameter  
...
|SQL Server-Setupsteuerelement|/INSTANCENAME<br /><br /> **Erforderlich**|Gibt den Namen einer SQL Server-Instanz an.<br /><br /> Weitere Informationen finden Sie unter [Instance Configuration](../Topic/Instance%20Configuration.md).|  
...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBFILESIZE<br /><br /> **Optional**|Gibt die Anfangsgröße jeder tempdb-Datendatei in MB an. Das Setup ermöglicht eine Größe von bis zu 1024 MB. Standardwert = 8<br /><br /> Zulässiger Bereich: Min = 8, Max = 1024|  
...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBLOGFILESIZE<br /><br /> **Optional**|Gibt die Anfangsgröße einer tempdb-Protokolldatei in MB an. Das Setup ermöglicht eine Größe von bis zu 1024 MB. <br />Standardwert: 8<br /><br /> Zulässiger Bereich: Min = 8, Max = 1024|  
...
##  <a name="a-namesysprepa-sysprep-parameters"></a><a name="SysPrep"></a> SysPrep-Parameter  
 Weitere Informationen zu SQL Server SysPrep finden Sie unter  
  
 [Installieren von SQL Server 2016 mit SysPrep](../../database-engine/install-windows/install-sql-server-2016-using-sysprep.md).  
...
|SQL Server-Setupsteuerelement|/INSTANCENAME<br /><br /> Vor dem kumulativen Update 2 (Januar 2013) für [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] Service Pack 1 **Erforderlich**<br /><br /> Ab dem kumulativen Update 2 für [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] Service Pack 1 **Optional**|Gibt einen SQL Server-Instanznamen für die Instanz an, die abgeschlossen wird<br /><br /> Weitere Informationen finden Sie unter [Instance Configuration](../Topic/Instance%20Configuration.md).|  
|PolyBase|/PBENGSVCACCOUNT<br /><br /> **Optional**|Gibt das Konto für den Moduldienst an. Der Standardwert ist **NT Authority\NETWORK SERVICE**.|  
|PolyBase|/PBDMSSVCPASSWORD<br /><br /> **Optional**|Gibt das Kennwort für das Moduldienstkonto an.|  
|PolyBase|/PBENGSVCSTARTUPTYPE<br /><br /> **Optional**|Gibt den Startmodus für den PolyBase-Moduldienst an: Automatisch (Standard), Deaktiviert und Manuell.|  
|PolyBase|/PBPORTRANGE<br /><br /> **Optional**|Gibt einen Portbereich für PolyBase-Dienste mit mindestens sechs Ports an. Beispiel:<br /><br /> `/PBPORTRANGE=16450-16460`|  
...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBDIR<br /><br /> **Optional**|Gibt die Verzeichnisse für tempdb-Datendateien an. Wenn Sie mehr als ein Verzeichnis angeben, trennen Sie die Verzeichnisse mit einem Leerzeichen. Wenn mehrere Verzeichnisse angegeben sind, werden die tempdb-Datendateien auf die Verzeichnisse im Rahmen eines Roundrobinverfahrens verteilt.<br /><br /> Standardwert: \<InstallSQLDataDir>\ \<SQLInstanceID>\MSSQL\Data(System Data Directory)<br /><br /> HINWEIS: Dieser Parameter wird dem RebuildDatabase-Szenario ebenfalls hinzugefügt.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBLOGDIR<br /><br /> **Optional**|Gibt das Verzeichnis für die tempdb-Protokolldatei an.<br /><br /> Standardwert: \<InstallSQLDataDir>\ \<SQLInstanceID>\MSSQL\Data(System Data Directory)<br /><br /> Hinweis: Dieser Parameter wird dem RebuildDatabase-Szenario ebenfalls hinzugefügt.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBFILESIZE<br /><br /> **Optional**|Gibt die Anfangsgröße jeder tempdb-Datendatei in MB an. Das Setup ermöglicht eine Größe von bis zu 256 MB.<br /><br /> Standardwert:<br /><br /> 4 für [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]<br /><br /> 8 für alle anderen Editionen<br /><br /> Zulässiger Bereich: Min = Standardwert (4 oder 8), Max = 256|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBFILEGROWTH<br /><br /> **Optional**|Gibt das Dateivergrößerungsinkrement jeder tempdb-Datendatei in MB an. Der Wert 0 zeigt an, dass die automatische Vergrößerung deaktiviert ist und kein zusätzlicher Platz zulässig ist. Das Setup ermöglicht eine Größe von bis zu 256 MB.<br /><br /> Standardwert: 64<br /><br /> Zulässiger Bereich: Min = 0, Max = 256|  
...
##  <a name="a-nameupgradea-upgrade-parameters"></a><a name="Upgrade"></a> Upgradeparameter  
...
##  <a name="a-namerepaira-repair-parameters"></a><a name="Repair"></a> Reparaturparameter  
...
##  <a name="a-namerebuilda-rebuild-system-database-parameters"></a><a name="Rebuild"></a> Parameter für die Neuerstellung einer Systemdatenbank  
...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBLOGDIR<br /><br /> **Optional**|Gibt das Verzeichnis für die tempdb-Protokolldatei an.<br /><br /> Standardwert: \<InstallSQLDataDir>\ \<SQLInstanceID>\MSSQL\Data(System Data Directory)<br /><br /> Hinweis: Dieser Parameter wird dem RebuildDatabase-Szenario ebenfalls hinzugefügt.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBFILECOUNT<br /><br /> **Optional**|Gibt die Anzahl von tempdb-Datendateien an, die von Setup hinzugefügt werden sollen. Dieser Wert kann bis zur Anzahl der Kerne heraufgesetzt werden. Standardwert:<br /><br /> 1 für [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]<br /><br /> 8 oder die Anzahl von Kernen, je nachdem, welcher Wert für alle anderen Editionen niedriger ist<br /><br /> **\*\* Wichtig \*\*** Die primäre Datenbankdatei für tempdb ist immer noch „tempdb.mdf“. Die zusätzlichen tempdb-Dateien werden nach dem Muster „tempdb_mssql_#.ndf“ benannt, wobei „#“ eine eindeutige Zahl für jede zusätzliche tempdb-Datenbankdatei darstellt, die beim Setup erstellt wurde. Diese Namenskonvention dient dazu, die Dateinamen eindeutig zu machen. Beim Deinstallieren einer Instanz von SQL Server werden die Dateien gelöscht, die der Namenskonvention „tempdb_mssql_#.ndf“ folgen. Verwenden Sie die Namenskonvention „tempdb_mssql_\*.ndf“ nicht für andere Datenbankdateien.<br /><br /> **\*\* Warnung \*\*** [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] wird für die Konfiguration dieses Parameters nicht unterstützt. Setup installiert nur 1 Tempdb-Datendatei.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBFILESIZE<br /><br /> **Optional**|Gibt die Anfangsgröße jeder tempdb-Datendatei in MB an. Das Setup ermöglicht eine Größe von bis zu 256 MB. Standardwert:<br /><br /> 4 für [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]<br /><br /> 8 für alle anderen Editionen<br /><br /> Zulässiger Bereich: Min = Standardwert (4 oder 8), Max = 256|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBFILEGROWTH<br /><br /> **Optional**|Gibt das Dateivergrößerungsinkrement jeder tempdb-Datendatei in MB an. Der Wert 0 zeigt an, dass die automatische Vergrößerung deaktiviert ist und kein zusätzlicher Platz zulässig ist. Das Setup ermöglicht eine Größe von bis zu 256 MB.<br /><br /> Standardwert: 64<br /><br /> Zulässiger Bereich: Min = 0, Max = 256|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBLOGFILESIZE<br /><br /> **Optional**|Gibt die Anfangsgröße einer tempdb-Protokolldatei in MB an. Das Setup ermöglicht eine Größe von bis zu 256 MB. Standardwert:<br /><br /> 4 für [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]<br /><br /> 8 für alle anderen Editionen<br /><br /> Zulässiger Bereich: Min = Standardwert (4 oder 8), Max = 256|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBLOGFILEGROWTH<br /><br /> **Optional**|Gibt das Dateivergrößerungsinkrement jeder tempdb-Datendatei in MB an. Der Wert 0 zeigt an, dass die automatische Vergrößerung deaktiviert ist und kein zusätzlicher Platz zulässig ist. Das Setup ermöglicht eine Größe von bis zu 256 MB.<br /><br /> Standardwert: 64<br /><br /> Zulässiger Bereich: Min = 0, Max = 256|  
  
##  <a name="a-nameuninstalla-uninstall-parameters"></a><a name="Uninstall"></a> Deinstallationsparameter  
...
##  <a name="a-nameclusterinstalla-failover-cluster-parameters"></a><a name="ClusterInstall"></a> Failoverclusterparameter  
...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBFILESIZE<br /><br /> **Optional**|Gibt die Anfangsgröße jeder tempdb-Datendatei in MB an. Das Setup ermöglicht eine Größe von bis zu 256 MB. Standardwert:<br /><br /> 4 für [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]<br /><br /> 8 für alle anderen Editionen<br /><br /> Zulässiger Bereich: Min = Standardwert (4 oder 8), Max = 256|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBFILEGROWTH<br /><br /> **Optional**|Gibt das Dateivergrößerungsinkrement jeder tempdb-Datendatei in MB an. Der Wert 0 zeigt an, dass die automatische Vergrößerung deaktiviert ist und kein zusätzlicher Platz zulässig ist. Das Setup ermöglicht eine Größe von bis zu 256 MB.<br /><br /> Standardwert: 64<br /><br /> Zulässiger Bereich: Min = 0, Max = 256|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBLOGFILESIZE<br /><br /> **Optional**|Gibt die Anfangsgröße einer tempdb-Protokolldatei in MB an. Das Setup ermöglicht eine Größe von bis zu 256 MB. <br /> Standardwert:<br /><br /> 4 für [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]<br /><br /> 8 für alle anderen Editionen<br /><br /> Zulässiger Bereich: Min = Standardwert (4 oder 8), Max = 256|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBLOGFILEGROWTH<br /><br /> **Optional**|Gibt das Dateivergrößerungsinkrement jeder tempdb-Datendatei in MB an. Der Wert 0 zeigt an, dass die automatische Vergrößerung deaktiviert ist und kein zusätzlicher Platz zulässig ist. Das Setup ermöglicht eine Größe von bis zu 256 MB.<br /><br /> Standardwert: 64<br /><br /> Zulässiger Bereich: Min = 0, Max = 256|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLUSERDBLOGDIR<br /><br /> **Optional**|Gibt das Verzeichnis für die Protokolldateien der Benutzerdatenbanken an.<br /><br /> Standardwert: \<InstallSQLDataDir>\ \<SQLInstanceID>\MSSQL\Data|  
|FILESTREAM|/FILESTREAMLEVEL<br /><br /> **Optional**|Gibt die Zugriffsebene für die FILESTREAM-Funktion an. Unterstützte Werte:<br /><br /> 0 = FILESTREAM-Unterstützung für diese Instanz deaktivieren. (Standardwert)<br /><br /> 1 = FILESTREAM für den [!INCLUDE[tsql](../../includes/tsql-md.md)] -Zugriff aktivieren.<br /><br /> 2 = FILESTREAM für den [!INCLUDE[tsql](../../includes/tsql-md.md)] - und E/A-Streamingzugriff auf Datei aktivieren. (Nicht gültig für Clusterszenarien)<br /><br /> 3 = Streamingzugriff von Remoteclients auf FILESTREAM-Daten zulassen.|  
|FILESTREAM|/FILESTREAMSHARENAME<br /><br /> **Optional**<br /><br /> **Erforderlich, wenn FILESTREAMLEVEL größer als 1 ist.**|Gibt den Namen der Windows-Freigabe an, in der die FILESTREAM-Daten gespeichert werden.|  
...
####  <a name="a-nameaddnodea-add-node-parameters"></a><a name="AddNode"></a> Parameter zum Hinzufügen von Knoten  
...
##  <a name="a-nameaccountsa-service-account-parameters"></a><a name="Accounts"></a> Dienstkontoparameter  
...
##  <a name="a-namefeaturea-feature-parameters"></a><a name="Feature"></a> Funktionsparameter  
 Um bestimmte Funktionen zu installieren, verwenden Sie den /FEATURES-Parameter und geben in der folgenden Tabelle die übergeordnete Funktion oder die Funktionswerte an. Eine Liste der Funktionen, die von den SQL Server-Editionen unterstützt werden, finden Sie unter [Von den SQL Server 2016-Editionen unterstützte Funktionen](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
...
##  <a name="a-namerollownershipa-controlling-failover-behavior-using-the-failoverclusterrollownership-parameter"></a><a name="RollOwnership"></a> Steuern des Failoververhaltens mithilfe des Parameters /FAILOVERCLUSTERROLLOWNERSHIP  
...
##  <a name="a-nameinstanceida-instance-id-or-instanceid-configuration"></a><a name="InstanceID"></a> Instanz-ID- oder InstanceID-Konfiguration  
...
> **HINWEIS:** Wenn INSTANCEID in der Befehlszeile nicht angegeben wurde, wird in der Standardeinstellung beim Setupvorgang \<INSTANZ-ID> durch \<INSTANZNAME> ersetzt.  
  
## <a name="see-also"></a>Siehe auch  
 [Installieren von SQL Server 2016 vom Installations-Assistenten](../../database-engine/install-windows/install-sql-server-2016-from-the-installation-wizard-setup.md)   
