---
title: "Failoverclustering und AlwaysOn-Verf&#252;gbarkeitsgruppen (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  ...
  - "Failoverclusterinstanzen [SQL Server], siehe Failoverclustering [SQL Server]"
  - "Quorum [SQL Server]"
...
-   **Blogs:**  
     ...
     [Konfigurieren von Windows-Failoverclustering für SQL Server (Verfügbarkeitsgruppe oder Failoverclusterinstanz) mit beschränkter Sicherheit](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/06/05/configure-windows-failover-clustering-for-sql-server-availability-group-or-fci-with-limited-security.aspx)  
