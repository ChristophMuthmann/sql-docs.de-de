---
title: "&#220;bersicht &#252;ber Always On-Verf&#252;gbarkeitsgruppen (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  ...
  - "Verfügbarkeitsgruppen [SQL Server], Info"
  - "Verfügbarkeitsgruppen [SQL Server], Datenverschiebung"
...
-   [Verfügbarkeitsreplikate](#AGsARsADBs)  
  
-   [Verfügbarkeitsmodi](#AvailabilityModes)  
  
-   [Failovertypen](#FormsOfFailover)  
  
-   [Clientverbindungen](#ClientConnections)  
  
-   [Aktive sekundäre Replikate](#ActiveSecondaries)  
  
-   [Sitzungstimeout](#SessionTimeoutPerios)  
  
-   [Automatische Seitenreparatur](#APR)  
  
-   [Verwandte Aufgaben](#RelatedTasks)  
  
-   [Verwandte Inhalte](#RelatedContent)  
  
##  <a name="AvDbs"></a> Verfügbarkeitsdatenbanken  
...
-   **Blogs:**  
     ...
     [Always ON - HADRON-Lernreihe: Nutzung des Arbeitsthreadpools für HADRON-fähige Datenbanken](http://blogs.msdn.com/b/psssql/archive/2012/05/17/Always%20On-hadron-learning-series-worker-pool-usage-for-hadron-enabled-databases.aspx)  
...
-   **Videos:**  
     ...
     [Microsoft SQL Server Code-Named "Denali" Always On Series,Part 1: Introducing the Next Generation High Availability Solution (in englischer Sprache)](http://channel9.msdn.com/Events/TechEd/NorthAmerica/2011/DBI302)  
