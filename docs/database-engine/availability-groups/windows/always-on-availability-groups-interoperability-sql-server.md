---
title: "Always On-Verf&#252;gbarkeitsgruppen: Interoperabilit&#228;t (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
-   [Funktionen, die mit Always On-Verfügbarkeitsgruppen zusammenwirken](../../../database-engine/availability-groups/windows/always-on-availability-groups-interoperability-sql-server.md#Interop)  
  
-   [Features, die mit Einschränkungen mit Always On-Verfügbarkeitsgruppen zusammenwirken](../../../database-engine/availability-groups/windows/always-on-availability-groups-interoperability-sql-server.md#restrictions)  
  
-   [Funktionen, die nicht mit Always On-Verfügbarkeitsgruppen zusammenwirken](../../../database-engine/availability-groups/windows/always-on-availability-groups-interoperability-sql-server.md#NoInterop)  
  
-   [Verwandte Inhalte](../../../database-engine/availability-groups/windows/always-on-availability-groups-interoperability-sql-server.md#RelatedContent)  
...
-   Datenbankübergreifende Transaktionen/verteilte Transaktionen ([!INCLUDE[ssSQL15](../../../includes/sssql15-md.md)] und Windows Server 2016 Technical Preview 2). Weitere Informationen finden Sie unter [Datenbankübergreifende Transaktionen und verteilte Transaktionen für Always On-Verfügbarkeitsgruppen oder Datenbankspiegelung &#40;SQL Server&#41;](../../../database-engine/availability-groups/windows/transactions - always on availability and database mirroring.md).  
...
-   **Blogs:**  
     ...
     [Migrationshandbuch: Migrieren zu SQL Server 2012-Failoverclustering und -Verfügbarkeitsgruppen von vorherigen Clustering- und Spiegelungsbereitstellungen](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/04/09/now-available-migration-guide-migrating-to-sql-server-2012-failover-clustering-and-availability-groups-from-prior-clustering-and-mirroring-deployments.aspx)  
