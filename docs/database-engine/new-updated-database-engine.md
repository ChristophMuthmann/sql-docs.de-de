...
1. [Automatisches Seeding für sekundäre Replikate](availability-groups/windows/automatic-seeding-secondary-replicas.md)
2. [Configure availability group for distributed transactions (Konfigurieren der Verfügbarkeitsgruppe für verteilte Transaktionen)](availability-groups/windows/configure-availability-group-for-distributed-transactions.md)
3. [Konfigurieren verteilter Verfügbarkeitsgruppen](availability-groups/windows/configure-distributed-availability-groups.md)
4. [Verteilte Verfügbarkeitsgruppen](availability-groups/windows/distributed-availability-groups.md)
5. [Domänenunabhängige Verfügbarkeitsgruppen](availability-groups/windows/domain-independent-availability-groups.md)
6. [Als veraltet markierte Funktionen des Datenbankmoduls in SQL Server 2017](deprecated-database-engine-features-in-sql-server-2017.md)
