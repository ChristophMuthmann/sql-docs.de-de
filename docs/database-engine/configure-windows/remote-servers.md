---
title: "Remoteserver | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Serververwaltung [SQL Server], Remoteserver"
  - "Remoteserver [SQL Server], konfigurieren"
  - "Remoteserver [SQL Server]"
  - "Server [SQL Server], Remote-"
  - "Remotezugriff-Option"
