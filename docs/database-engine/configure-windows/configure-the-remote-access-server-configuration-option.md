---
title: "Konfigurieren der Serverkonfigurationsoption Remotezugriff | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Remoteserver [SQL Server], Ausführung gespeicherter Prozeduren"
...
-   [Herstellen einer Verbindung mit dem Datenbankmodul mithilfe von sqlcmd](../../relational-databases/scripting/connect-to-the-database-engine-with-sqlcmd.md)  
...
-   [Herstellen einer Verbindung zu einer Instanz von SQL Server](https://msdn.microsoft.com/library/ms162132.aspx)  
...
#### So konfigurieren Sie die Option Remotezugriff  
...
```  
 ...
 Weitere Informationen finden Sie unter [Server Configuration Options &#40;SQL Server&#41;](../../database-engine/configure-windows/server-configuration-options-sql-server.md)konfiguriert wird.  
