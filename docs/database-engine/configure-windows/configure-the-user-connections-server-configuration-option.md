---
title: "Konfigurieren der Serverkonfigurationsoption Benutzerverbindungen | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Gleichzeitige Verbindungen [SQL Server]"
  - "Benutzerverbindungen (Option) [SQL Server]"
  - "Benutzer [SQL Server], gleichzeitige Verbindungen"
  - "Maximale Anzahl gleichzeitiger Benutzerverbindungen"
  - "Verbindungen [SQL Server], gleichzeitig"
...
---
# Konfigurieren der Serverkonfigurationsoption Benutzerverbindungen
...
#### So konfigurieren Sie die Option Benutzerverbindungen  
