---
title: "Serverkonfigurationsoptionen f&#252;r den Serverarbeitsspeicher | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
helpviewer_keywords: 
  ...
  - "Max. Serverarbeitsspeicher (Option)"
  - "Virtueller Arbeitsspeicher [SQL Server]"
  - "VMM"
  - "Serverarbeitsspeicher-Optionen [SQL Server]"
  - "Server [SQL Server], Arbeitsspeicher"
  - "Pufferpools [SQL Server]"
  - "Min. Serverarbeitsspeicher (Option)"
  - "Manuelle Arbeitsspeicheroptionen [SQL Server]"
  - "Arbeitsspeicher [SQL Server], Server"
