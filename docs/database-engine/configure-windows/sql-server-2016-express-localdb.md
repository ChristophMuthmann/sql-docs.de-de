...
helpviewer_keywords: 
  - "Benutzerinstanzen"
  - "LocalDB, beschrieben"
  - "Laufzeit der lokalen Datenbank"
  - "Datei-Datenbank"
  - "LocalDB"
...
-   Um SQL Server 2016 Express herunterzuladen und zu installieren, navigieren Sie zum **[Download Center](http://www.microsoft.com/download/details.aspx?id=52679)**. LocalDB ist ein Feature, das Sie während der Installation auswählen. Im **Download Center**, ist LocalDB über die **Benutzerdefinierte Installation** oder durch den Download der Medien verfügbar. Wenn Sie die Medien herunterladen, wählen Sie **Express Advanced** oder das **LocalDB**Paket aus. 
  
-   Sie haben ein Azure-Konto?  Wechseln Sie anschließend **[hierhin](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016ctp33evaluationwindowsserver2012r2/?wt.mc_id=sqL16_vm)**, um einen virtuellen Computer zu starten, auf dem [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] bereits installiert ist.  
