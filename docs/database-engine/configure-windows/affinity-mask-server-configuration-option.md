---
title: "Affinit&#228;tsmaske (Serverkonfigurationsoption) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
helpviewer_keywords: 
  ...
  - "Erneutes Laden des Prozessorcaches"
  - "Prozessorcache [SQL Server]"
  - "CPU [SQL Server], Lizenzierung"
  - "Deferred Process Call"
  - "Affinitätsmaske (Option)"
