---
title: "Starten, Beenden, Anhalten, Fortsetzen und Neustarten des Datenbankmoduls, SQL&#160;Server-Agent oder des SQL&#160;Server-Browsers | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server-Konfigurations-Manager, Dienste starten und beenden"
  - "Beenden des SQL Server-Agents"
  - "Parameter [SQL Server], Startoptionen"
  - "SQL Server, Startoptionen"
  - "Datenbankmodul [SQL Server], Dienste starten und beenden"
  - "Anhalten von SQL Server"
  - "PowerShell [SQL Server], Dienste starten und beenden"
  - "Einzelbenutzermodus [SQL Server], starten im"
  - "SQL Server Management Studio [SQL Server], Dienste starten und beenden"
  - "Beenden des SQL Server-Browserdiensts"
  - "Starten des SQL Server-Agents"
  - "Standardinstanzen [SQL Server], starten und beenden"
  - "SQL Server-Agent, starten und beenden"
  - "Eingabeaufforderung [SQL Server], SQL Server-Dienste starten und beenden"
  - "Fortsetzen von SQL Server"
  - "Starten des SQL Server-Datenbankmoduls"
  - "Nettobeendigungsbefehle [SQL Server]"
  - "Eingabeaufforderung [SQL Server], SQL-Browser-Dienst"
  - "Konfigurations-Manager, Dienste starten und beenden"
  - "Fortsetzen einer Instanz von SQL Server"
  - "Startoptionen [SQL Server]"
  - "Benannte Instanzen [SQL Server], starten und beenden"
  - "Nettostartbefehle [SQL Server]"
  - "SQL Server, starten und beenden"
  - "Beenden von SQL Server"
  - "Starten des SQL Server-Browserdiensts"
  - "SQL Server-Datenbankmodul – Einstellungsstartoptionen"
  - "Verwalten von SQL Server, Dienste starten und beenden"
  - "Management Studio [SQL Server], Dienste starten und beenden"
...
#### Starten des [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Konfigurations-Managers  
...
#### So wird eine [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
...
> [!NOTE]  
>  Weitere Informationen zum Starten einer [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]-Instanz mit Startoptionen finden Sie unter [Konfigurieren von Serverstartoptionen &#40;SQL Server-Konfigurations-Manager&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md).  
  
#### So wird der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Browser oder eine [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Agent-Instanz gestartet, beendet, angehalten, fortgesetzt oder neu gestartet  
...
#### So wird eine [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Agent-Instanz gestartet, beendet oder neu gestartet  
...
##  <a name="CommandPrompt"></a> Über das Eingabeaufforderungsfenster mit Net-Befehlen  
 Die [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Dienste können anhand von **net**-Befehlen von [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows gestartet, beendet oder angehalten werden.  
...
#### So beenden Sie [!INCLUDE[ssDE](../../includes/ssde-md.md)] mit [!INCLUDE[tsql](../../includes/tsql-md.md)]  
...
#### So starten und beenden Sie [!INCLUDE[ssDE](../../includes/ssde-md.md)] -Dienste  
...
## Siehe auch  
 [Übersicht über die SQL Server-Setupdokumentation](../Topic/Overview%20of%20SQL%20Server%20Setup%20Documentation.md)   
