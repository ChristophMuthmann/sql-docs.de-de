---
title: "Konfigurieren von Windows-Dienstkonten und -Berechtigungen | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Startdienststatus [SQL Server]"
  - "Setup [SQL Server], Benutzerkonten"
  - "Windows-Berechtigungen [SQL Server]"
  - "Ändern von Benutzerkonten"
  - "Standardkonten"
  - "Domänen [SQL Server], Benutzerkonten"
  - "Startkonten [SQL Server]"
  - "Systemkonten [SQL Server]"
  - "Dienste [SQL Server], Berechtigungen"
  - "ACL (Access Control List, Zugriffssteuerungsliste)"
  - "Lokales Systemkonto [SQL Server]"
  - "Instanzabhängige Dienste [SQL Server]"
  - "Berechtigungen [SQL Server], Dienste"
  - "SQL Server-Agent-Dienst, Benutzerkonten"
  - "Windows NT-Berechtigungen [SQL Server]"
  - "Benutzerkonten [SQL Server]"
  - "Identifizieren nicht instanzabhängiger Dienste [SQL Server]"
  - "Installieren von SQL Server, Benutzerkonten"
  - "Deaktivieren des automatischen Startens [SQL Server]"
  - "Benutzerkonten [SQL Server], Benutzer"
  - "Lokales Dienstkonto [SQL Server]"
  - "SQL Server-Installations-Assistent"
  - "Nicht instanzabhängige Dienste [SQL Server]"
  - "Dienste [SQL Server], Konfigurieren bei Installation"
  - "Windows-Konten [SQL Server]"
  - "SQL Server-Dienste, Benutzerkonten"
  - "Benutzerkonten [SQL Server], Dienste"
  - "MSSQLServer"
  - "Identifizieren instanzabhängiger Dienste [SQL Server]"
  - "Dienste [SQL Server], Konten"
  - "Zugriffssteuerungslisten"
  - "Optionale Konten [SQL Server]"
  - "Dienstkonten [SQL Server]"
  - "Konten [SQL Server], Dienste"
  - "Integrierte Systemkonten [SQL Server]"
  - "Automatisches Starten"
  - "Domänen [SQL Server]"
  - "Manuelles Starten [SQL Server]"
  - "Konten [SQL Server], Benutzer"
...
##  <a name="a-nameservicedetailsa-services-installed-by-includessnoversiontokenssnoversionmdmd"></a><a name="Service_Details"></a> Von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] installierte Dienste  
...
-   **[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Datenbankdienste** – Der Dienst für das relationale [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)]. Die ausführbare Datei ist „\<MSSQL PFAD>\MSSQL\Binn\sqlservr.exe“.  
  
-   **[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Agent** – Führt Aufträge aus, überwacht [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], löst Warnungen aus und ermöglicht die Automatisierung bestimmter Verwaltungsaufgaben. Der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Agent-Dienst ist vorhanden, aber in Instanzen von [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] deaktiviert. Die ausführbare Datei ist „\<MSSQL PFAD>\MSSQL\Binn\sqlagent.exe“.  
  
-   **[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]** – Bietet OLAP-Funktionalität (Online Analytical Processing, Analytische Onlineverarbeitung) und Data Mining-Funktionalität für Business Intelligence-Anwendungen. Die ausführbare Datei ist „\<MSSQL PFAD>\OLAP\Bin\msmdsrv.exe“.  
  
-   **[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]** – Wird zum Verwalten, Ausführen, Erstellen, Planen und Übermitteln von Berichten verwendet. Die ausführbare Datei ist „\<MSSQLPFAD>\Reporting Services\ReportServer\Bin\ReportingServicesService.exe“.  
  
-   **[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]** – Stellt Verwaltungsunterstützung für das Speichern und Ausführen von [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]-Paketen bereit. Der Pfad der ausführbaren Datei ist „\<MSSQLPFAD>\130\DTS\Binn\MsDtsSrvr.exe“.  
...
##  <a name="a-nameservpropa-service-properties-and-configuration"></a><a name="Serv_Prop"></a> Diensteigenschaften und -konfiguration  
...
###  <a name="a-namedefaultacctsa-default-service-accounts"></a><a name="Default_Accts"></a> Standarddienstkonten  
...
####  <a name="a-namechangingaccountsa-changing-account-properties"></a><a name="Changing_Accounts"></a> Ändern von Kontoeigenschaften  
...
###  <a name="a-namenewaccountsa-managed-service-accounts-group-managed-service-accounts-and-virtual-accounts"></a><a name="New_Accounts"></a> Verwaltete Dienstkonten, gruppenverwaltete Dienstkonten und virtuellen Konten  
...
###  <a name="a-nameautostarta-automatic-startup"></a><a name="Auto_Start"></a> Automatischer Start  
...
###  <a name="a-nameconfigureservicesa-configuring-services-during-unattended-installation"></a><a name="Configure_services"></a> Konfigurieren von Diensten während der unbeaufsichtigten Installation  
...
###  <a name="a-namefirewalla-firewall-port"></a><a name="Firewall"></a> Firewallport  
...
##  <a name="a-nameservperma-service-permissions"></a><a name="Serv_Perm"></a> Dienstberechtigungen  
...
###  <a name="a-nameservsida-service-configuration-and-access-control"></a><a name="Serv_SID"></a> Dienstkonfiguration und Zugriffssteuerung  
 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] aktiviert die Pro-Dienst-SID für alle seine Dienste, um Dienstisolierung und tiefgreifende Vorbeugungsmaßnahmen zu ermöglichen. Die Pro-Dienst-SID ergibt sich aus dem Dienstnamen und ist für diesen Dienst eindeutig. Ein Beispiel eines Dienst-SID-Namens für den [!INCLUDE[ssDE](../../includes/ssde-md.md)]-Dienst wäre **NT Service\MSSQL$***\<Instanzname>*. Die Dienstisolierung ermöglicht den Zugriff auf bestimmte Objekte, ohne dass hierzu ein Konto mit umfangreichen Berechtigungen verwendet oder die Sicherheit des Objekts gefährdet werden muss. Durch die Verwendung eines Zugriffssteuerungseintrags mit einer Dienst-SID kann ein [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Dienst den Zugriff auf die eigenen Ressourcen einschränken.  
...
###  <a name="a-namewindowsa-windows-privileges-and-rights"></a><a name="Windows"></a> Windows-Berechtigungen und -Rechte  
...
|**[!INCLUDE[ssRS](../../includes/ssrs-md.md)]:**<br /><br /> (Der Pro-Dienst-SID werden alle Rechte gewährt. Standardinstanz: **NT SERVICE\ReportServer**. Benannte Instanz: **NT SERVICE\\$***Instanzname*.)|**Als Dienst anmelden** (SeServiceLogonRight)|  
...
###  <a name="a-namereviewingaclsa-file-system-permissions-granted-to-sql-server-per-service-sids-or-local-windows-groups"></a><a name="Reviewing_ACLs"></a> Pro-Dienst-SIDs für SQL Server oder lokalen Windows-Gruppen gewährte Dateisystemberechtigungen  
...
###  <a name="a-namefilesystemothera-file-system-permissions-granted-to-other-windows-user-accounts-or-groups"></a><a name="File_System_Other"></a> Anderen Windows-Benutzerkonten oder -Gruppen gewährte Dateisystemberechtigungen  
...
||\<Report Server-Webdienstkonto>|*\<Installationsverzeichnis>*\Reporting Services\ReportServer|Lesen|  
||\<Report Server-Webdienstkonto>|*\<Installationsverzeichnis>*\Reporting Services\ReportServer\global.asax|Full|  
...
###  <a name="a-nameunusuallocationsa-file-system-permissions-related-to-unusual-disk-locations"></a><a name="Unusual_Locations"></a> Auf ungewöhnliche Speicherorte auf einem Datenträger bezogene Dateisystemberechtigungen  
...
###  <a name="a-namereviewadditionalconsiderationsa-reviewing-additional-considerations"></a><a name="Review_additional_considerations"></a> Überprüfen zusätzlicher Aspekte  
...
###  <a name="a-nameregistrya-registry-permissions"></a><a name="Registry"></a> Registrierungsberechtigungen  
...
###  <a name="a-namepipesa-named-pipes"></a><a name="Pipes"></a> Named Pipes  
...
##  <a name="a-nameprovisioninga-provisioning"></a><a name="Provisioning"></a> Bereitstellung  
...
###  <a name="a-namedeprova-database-engine-provisioning"></a><a name="DE_Prov"></a> Bereitstellung des Datenbankmoduls  
 Die folgenden Konten werden als Anmeldungen in [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]hinzugefügt.  
  
####  <a name="a-namewinprincipalsa-windows-principals"></a><a name="Win_Principals"></a> Windows-Prinzipale  
...
####  <a name="a-namesaa-sa-account"></a><a name="sa"></a> sa-Konto  
...
####  <a name="a-nameloginsa-sql-server-per-service-sid-login-and-privileges"></a><a name="Logins"></a> Pro-Dienst-SID-Anmeldung für SQL Server und Berechtigungen  
...
####  <a name="a-nameagenta-sql-server-agent-login-and-privileges"></a><a name="Agent"></a> SQL Server-Agent-Anmeldung und Berechtigungen  
...
####  <a name="a-namehadrona-includesshadrctokensshadrcmdmd-and-sql-failover-cluster-instance-and-privileges"></a><a name="Hadron"></a> [!INCLUDE[ssHADRc](../../includes/sshadrc-md.md)]- und SQL-Failoverclusterinstanz und Berechtigungen  
...
####  <a name="a-namewritera-sql-writer-and-privileges"></a><a name="Writer"></a> SQL Writer und Berechtigungen  
...
####  <a name="a-namesqlwmia-sql-wmi-and-privileges"></a><a name="SQLWMI"></a> SQL WMI und Berechtigungen  
...
###  <a name="a-namessasa-ssas-provisioning"></a><a name="SSAS"></a> SSAS-Bereitstellung  
...
###  <a name="a-namessrsa-ssrs-provisioning"></a><a name="SSRS"></a> SSRS-Bereitstellung  
...
##  <a name="a-nameupgradea-upgrading-from-previous-versions"></a><a name="Upgrade"></a> Aktualisieren von früheren Versionen  
...
##  <a name="a-nameappendixa-appendix"></a><a name="Appendix"></a> Anhang  
...
###  <a name="a-nameservacctsa-description-of-service-accounts"></a><a name="Serv_Accts"></a> Beschreibung von Dienstkonten  
...
####  <a name="a-nameanyosa-accounts-available-with-any-operating-system"></a><a name="Any_OS"></a> Mit einem beliebigen Betriebssystem verfügbare Konten  
...
###  <a name="a-nameidentifyinstanceawareandunawarea-identifying-instance-aware-and-instance-unaware-services"></a><a name="Identify_instance_aware_and_unaware"></a> Identifizieren von instanzabhängigen und nicht instanzabhängigen Diensten  
...
###  <a name="a-namelocalizedservicenamesa-localized-service-names"></a><a name="Localized_service_names"></a> Lokalisierte Dienstnamen  
