---
title: "Anmelden an SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "[SQL Server], anmelden"
  - "Dienste [SQL Server], anmelden"
  - "TCP-Verbindungszeichenfolge"
  - "Herstellen einer Verbindung mit dem Datenbankmodul"
  - "Anmeldungen [SQL Server], Informationen zur Anmeldung"
  - "Named Pipe-Verbindungszeichenfolge"
  - "Anmeldungen [SQL Server]"
  - "Shared Memory-Verbindungszeichenfolge"
  - "Anmelden [SQL Server]"
  - "Anmeldungen [SQL Server]"
...
## Verwandte Inhalte  
 ...
 [Erstellen einer Anmeldung](../../t-sql/creating-a-login.md)  
