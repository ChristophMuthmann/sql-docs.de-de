---
title: "Server-Netzwerkkonfiguration | Microsoft Docs"
ms.custom: ""
ms.date: "07/27/2016"
...
helpviewer_keywords: 
  ...
  - "Verbindungen [SQL Server], Server-Netzwerkkonfiguration"
  - "Datenbankmodul [SQL Server], Netzwerkkonfigurationen"
  - "Server-Netzwerkkonfiguration [SQL Server]"
  - "Protokolle [SQL Server], Auswählen"
  - "Ports [SQL Server], Ändern"
