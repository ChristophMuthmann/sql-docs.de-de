---
title: "Lightweightpooling (Serverkonfigurationsoption) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Standard-Lightweightpooling"
  - "Verringern des Verwaltungsaufwands"
  - "Lightweightpooling (Option)"
  - "Systemverwaltungsaufwand [SQL Server]"
  - "Leistung [SQL Server], Lightweightpooling"
  - "Kontextwechsel [SQL Server], Option „Lightweightpooling“"
  - "Häufiger Kontextwechsel [SQL Server]"
  - "Reduzieren des Verwaltungsaufwands"
  - "Verwaltungsaufwand [SQL Server]"
