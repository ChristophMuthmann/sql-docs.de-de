---
title: "Client-Netzwerkkonfiguration | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Clientkonfiguration [SQL Server], Verbindungen"
  - "Datenbankmodul [SQL Server], Netzwerkkonfigurationen"
  - "Verbindungen [SQL Server], Clientkonfiguration"
  - "Clientverbindungen [SQL Server], Informationen zu Clientnetzwerkverbindungen"
  - "Clientcomputer [SQL Server]"
  - "Clientverbindungen [SQL Server]"
  - "Netzwerkverbindungen [SQL Server], Clientkonfiguration"
