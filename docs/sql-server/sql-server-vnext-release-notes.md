---
title: "Versionsanmerkungen zu SQL Server vNext | Microsoft Docs"
ms.custom: ""
ms.date: "03/12/2017"
ms.prod: "sql-vnext"
ms.reviewer: ""
...
---
# Versionsanmerkungen zu SQL Server vNext
...
- [SQL Server Reporting Services release notes (Versionshinweise für SQL Server Reporting Services)](../reporting-services/reporting-services-versionshinweise.md) werden im Abschnitt Reporting Services veröffentlicht.
...
**Problem und Kundenbeeinträchtigung:** Wenn der Typ des Entitätstransaktionsprotokolls in [!INCLUDE[ssMDSshort_md](../includes/ssmdsshort-md.md)] auf **Attribut** festgelegt ist, (der Standardwert ist **Member**), tritt bei den folgenden Szenarien ein Fehler auf:
...
Im Besonderen wurden die folgenden Szenarien, auch wenn sie bei Ihnen funktionieren können, nicht gründlich getestet und werden in [!INCLUDE[ssSQLv14_md](../includes/sssqlv14-md.md)] **nicht** unterstützt:
