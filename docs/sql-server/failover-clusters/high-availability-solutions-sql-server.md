---
title: "L&#246;sungen mit hoher Verf&#252;gbarkeit (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/19/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Hohe Verfügbarkeit [SQL Server], Lösungen"
  - "Datenbankmodul [SQL Server], Verfügbarkeit"
  - "Datenbankverfügbarkeit [SQL Server]"
  - "Verfügbarkeit [SQL Server]"
  - "Serververfügbarkeit [SQL Server]"
