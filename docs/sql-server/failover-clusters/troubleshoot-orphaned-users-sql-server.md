---
title: "Problembehandlung bei verwaisten Benutzern (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/14/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Verwaiste Benutzer [SQL Server]"
  - "Anmeldungen [SQL Server], verwaiste Benutzer"
  - "Problembehandlung [SQL Server], Benutzerkonten"
  - "Benutzerkonten [SQL Server], verwaiste Benutzer"
  - "Failover [SQL Server], Verwalten von Metadaten"
  - "Datenbankspiegelung [SQL Server], Metadaten"
  - "Benutzer [SQL Server], verwaist"
...
```  
 ...
 Führen Sie in der Benutzerdatenbank die Anweisung [ALTER USER](../../t-sql/statements/alter-user-transact-sql.md) aus, und geben Sie den Anmeldenamen ein, um verwaiste Benutzer einem Anmeldenamen zuzuordnen, der bereits im **Master** vorhanden ist.  
