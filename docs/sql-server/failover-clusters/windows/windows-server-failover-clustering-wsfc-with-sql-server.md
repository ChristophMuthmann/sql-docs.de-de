---
title: "Windows Server-Failoverclustering (WSFC) mit SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
> **:** Die Bereitstellung einer Failoverclusterinstanz oder die Verwendung von symmetrischem, freigegebenem Speicher (SAN oder SMB) ist für [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)]nicht erforderlich.  
>   
...
##  <a name="AlwaysOnWsfcRelationship"></a> Beziehung der AlwaysOn-Komponenten in SQL Server mit WSFC  
 ...
 ![Diagramm zum SQL Server-Komponentenkontext "AlwaysOn"](../../../sql-server/failover-clusters/windows/media/alwaysoncomponentcontextdiagram.gif "Diagramm zum SQL Server-Komponentenkontext "AlwaysOn"")  
