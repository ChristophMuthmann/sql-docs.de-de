---
title: "Verwaltung und Wartung von Failoverclusterinstanzen | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Benutzerkonten [SQL Server], Failoverclustering"
  - "Cluster [SQL Server], warten"
  - "Knoten [Failoverclustering]"
  - "Failoverclustering [SQL Server], warten"
  - "Hinzufügen von Knoten"
  - "Virtuelle Server [SQL Server], Entfernen von Knoten"
  ...
  - "Virtuelle Server [SQL Server], Hinzufügen von Knoten"
...
## Warten einer Failoverclusterinstanz  
...
## Verwalten einer Failoverclusterinstanz  
