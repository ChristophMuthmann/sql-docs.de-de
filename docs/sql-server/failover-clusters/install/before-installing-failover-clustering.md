---
title: "Vor dem Installieren des Failoverclusterings | Microsoft Docs"
ms.custom: ""
ms.date: "08/24/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Cluster [SQL Server], Prüfliste vor der Installation"
  - "Installieren von Failoverclustern"
  - "Failover-Clusterunterstützung [SQL Server], Prüfliste vor der Installation"
...
-   Die SMB-Dateifreigabe wird ebenfalls für die Installation von Datendateien unterstützt. Weitere Informationen finden Sie unter [Storage Types for Data Files](../../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#StorageTypes).  
...
### Konfigurieren von [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Distributed Transaction Coordinator  
