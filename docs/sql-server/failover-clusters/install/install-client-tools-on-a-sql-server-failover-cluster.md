---
title: "Installieren von Clienttools auf einem SQL Server-Failovercluster | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
#### Installieren der [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] -Clienttools mit dem Setup für die Benutzeroberfläche  
...
#### Installieren von [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]-Clienttools über die Eingabeaufforderung  
...
### Deinstallieren von [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]-Clienttools  
