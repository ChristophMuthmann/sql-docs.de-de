---
title: "Spezifikationen der maximalen Kapazit&#228;t f&#252;r SQL Server | Microsoft Docs"
ms.date: "03/09/2017"
...
helpviewer_keywords: 
  - "Objekte [SQL Server]"
  - "Anzahl für Kapazitätsspezifikationen [SQL Server]"
  - "Größe [SQL Server], Kapazitätsspezifikationen"
  - "Anzahl der Objekte"
  - "Kapazitätsspezifikationen [SQL Server]"
  - "Spezifikationen der maximalen Kapazität [SQL Server]"
  - "Größe [SQL Server]"
  - "Replikationskapazitätsspezifikationen [SQL Server]"
  - "Objekte [SQL Server], Kapazitätsspezifikationen"
  - "Datenbankmodul [SQL Server], Kapazitätsspezifikationen"
...
|Verweise auf Fremdschlüsseltabellen pro Tabelle||Ausgehend = 253. Eingehend = 10.000.|Einschränkungen finden Sie unter [Create Foreign Key Relationships](../relational-databases/tables/erstellen-von-fremdschlüssel-beziehungen.md).|  
