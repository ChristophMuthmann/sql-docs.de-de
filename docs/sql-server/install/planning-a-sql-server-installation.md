---
title: "Planen einer SQL Server-Installation | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/08/2016"
...
helpviewer_keywords: 
  - "Installieren von SQL Server, planen"
...
-   Führen Sie [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Setup aus, um eine höhere Version zu installieren bzw. darauf zu aktualisieren. Lesen Sie vor dem Upgrade [Upgrade to SQL Server 2016](../../database-engine/install-windows/upgrade-to-sql-server-2016.md).  
