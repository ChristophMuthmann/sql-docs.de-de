---
title: "Neuigkeiten in der SQL Server-Installation | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
# Neuigkeiten in der SQL Server-Installation
 ...
 Die Installation wird nur für x64-Prozessoren unterstützt. Weitere Informationen finden Sie unter [Hardware- und Softwareanforderungen für die Installation von SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md).
 ...
 SysPrep wird für alle [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Installationen unterstützt. SysPrep unterstützt jetzt Failoverclusterinstallationen. Weitere Informationen finden Sie unter [Überlegungen zur Installation von SQL Server mit SysPrep](../../database-engine/install-windows/considerations-for-installing-sql-server-using-sysprep.md) und [Installieren von SQL Server mit SysPrep](../../database-engine/install-windows/install-sql-server-2016-using-sysprep.md).  
...
## Siehe auch  
 [Was ist neu in SQL Server 2016](../../sql-server/what-s-new-in-sql-server-2016.md)
 [Produktspezifikationen für SQL Server 2016](Product%20Specifications%20for%20SQL%20Server%202016.md)   
