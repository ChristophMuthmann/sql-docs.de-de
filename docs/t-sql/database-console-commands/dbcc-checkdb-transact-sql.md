...
Beginnend mit [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] SP2, Ausführen von DBCC CHECKDB **nicht mehr** löscht der Plancache für die Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Vor dem [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] SP2 Ausführen von DBCC CHECKDB der Plancache gelöscht. Durch das Löschen des Plancaches wird eine Neukompilierung aller späteren Ausführungspläne verursacht, und möglicherweise entsteht plötzlich eine temporäre Verringerung der Abfrageleistung. 
