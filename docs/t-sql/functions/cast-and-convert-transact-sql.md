...
### <a name="l-using-cast-to-concatenate"></a>L. Verwenden von CAST zur Verkettung  
...
### <a name="m-using-cast-to-produce-more-readable-text"></a>M. Verwenden von CAST zur Generierung besser lesbaren Texts  
