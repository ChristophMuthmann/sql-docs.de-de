...
## [TABLE (SQL-Diagramm)](create-table-sql-graph.md)  
## [TABLE AS SELECT (Azure SQL Data Warehouse)](create-table-as-select-azure-sql-data-warehouse.md)
## [TABLE IDENTITY (Eigenschaft)](create-table-transact-sql-identity-property.md) 
...
## [DENY – Serverberechtigungen](deny-server-permissions-transact-sql.md)  
...
## [GRANT – Sucheigenschaftenlisten-Berechtigungen](grant-search-property-list-permissions-transact-sql.md)  
...
## [REVOKE – Volltextberechtigungen](revoke-full-text-permissions-transact-sql.md)  
...
# SET 
## [Übersicht](set-statements-transact-sql.md)
