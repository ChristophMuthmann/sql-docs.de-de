...
## <a name="remarks"></a>Hinweise  
 Sie müssen den Status einer Überwachungsspezifikation auf die OFF-Option, um Änderungen an einer Überwachungsspezifikation festlegen. Wenn ALTER SERVER AUDIT SPECIFICATION ausgeführt wird, während eine Überwachungsspezifikation mit einer anderen Option als STATE=OFF aktiviert ist, erhalten Sie eine Fehlermeldung.  
...
## <a name="examples"></a>Beispiele  
 Im folgenden Beispiel wird eine Serverüberwachungsspezifikation mit dem Namen `HIPPA_Audit_Specification` erstellt. Es löscht die Überwachungsaktionsgruppe für fehlgeschlagene Anmeldungen und eine Überwachungsaktionsgruppe für Database Object Access für Fügt eine [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Überwachung namens `HIPPA_Audit`.  
