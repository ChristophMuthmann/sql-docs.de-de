...
|-----------------|---------------|--------------------------------------------|  
|**Sicherungsname**|**vom Datentyp nvarchar(128)**|Name des Sicherungssatzes.|  
...
|**Gerätetyp**|**tinyint**|Zahl, die dem für den Sicherungsvorgang verwendeten Medientyp entspricht.<br /><br /> Datenträger:<br /><br /> **2** = logisch<br /><br /> **102** = physisch<br /><br /> Band:<br /><br /> **5** = logisch<br /><br /> **105** = physisch<br /><br /> Virtuelles Medium:<br /><br /> **7** = logisch<br /><br /> **107** = physisch<br /><br /> Logisches Gerätenamen und Nummern werden **backup_devices**; Weitere Informationen finden Sie unter [backup_devices &#40; Transact-SQL &#41; ](../../relational-databases/system-catalog-views/sys-backup-devices-transact-sql.md).|  
|**UserName**|**vom Datentyp nvarchar(128)**|Name des Benutzers, der den Sicherungsvorgang ausgeführt hat.|  
|**ServerName**|**vom Datentyp nvarchar(128)**|Name des Servers, der den Sicherungssatz geschrieben hat.|  
|**DatabaseName**|**vom Datentyp nvarchar(128)**|Name der Datenbank, die gesichert wurde.|  
...
|**MachineName**|**vom Datentyp nvarchar(128)**|Name des Computers, der den Sicherungsvorgang ausgeführt hat.|  
...
|**Sortierung**|**vom Datentyp nvarchar(128)**|Die von der Datenbank verwendete Sortierung.|  
...
|**Kapselung**|**"tinyint"** not NULL|**Gilt für**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] bis [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Zeigt den Kapselungsstatus der Datenbank an.<br /><br /> 0 = Datenbankkapselung ist deaktiviert<br /><br /> 1 = Datenbank ist in Teilkapselung|  
