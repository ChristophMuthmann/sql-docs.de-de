...
## <a name="permissions"></a>Berechtigungen  
 Erfordert **ALTER ANY ROLE** Berechtigung für die Datenbank oder **VERWALTUNGSGRUPPEN** -Berechtigung für die Rolle oder die Mitgliedschaft in der **Db_securityadmin**.  
