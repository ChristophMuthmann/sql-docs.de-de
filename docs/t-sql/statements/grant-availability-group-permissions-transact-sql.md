...
|VIEW DEFINITION|CONTROL|VIEW ANY DEFINITION|  
 ...
 Ein Diagramm sämtlicher [!INCLUDE[ssDE](../../includes/ssde-md.md)]-Berechtigungen finden Sie im [Poster der Datenbank-Engine-Berechtigungen](http://go.microsoft.com/fwlink/?LinkId=229142).  
