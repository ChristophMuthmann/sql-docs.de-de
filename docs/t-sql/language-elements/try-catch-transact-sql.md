...
```  
 ...
 Die RFRI * Funktionen funktionieren auch in einem `CATCH` -Block ein [systemintern kompilierte gespeicherte Prozedur](../../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md).  
