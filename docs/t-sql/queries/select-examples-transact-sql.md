---
title: Beispiele (Transact-SQL) | Microsoft Docs
ms.custom: 
ms.date: 03/16/2017
...
[!INCLUDE[tsql-appliesto-ss2008-asdb-xxxx-xxx_md](../../includes/tsql-appliesto-ss2008-asdb-xxxx-xxx-md.md)]
  ...
  Dieses Thema enthält Beispiele für die Verwendung der [wählen](../../t-sql/queries/select-transact-sql.md) Anweisung.  
...
## <a name="a-using-select-to-retrieve-rows-and-columns"></a>A. Verwenden von SELECT zum Abrufen von Zeilen und Spalten  
 ...
 [!code-sql[Wählen Sie #SelectExamples1](../../t-sql/queries/codesnippet/tsql/select-examples-transact_1.sql)]  
 ...
 [!code-sql[Wählen Sie #SelectExamples2](../../t-sql/queries/codesnippet/tsql/select-examples-transact_2.sql)]  
 ...
 [!code-sql[Wählen Sie #SelectExamples3](../../t-sql/queries/codesnippet/tsql/select-examples-transact_3.sql)]  
...
## <a name="b-using-select-with-column-headings-and-calculations"></a>B. Verwenden von SELECT mit Spaltenüberschriften und Berechnungen  
 ...
 [!code-sql[Wählen Sie #SelectExamples4](../../t-sql/queries/codesnippet/tsql/select-examples-transact_4.sql)]  
  
 Diese Abfrage berechnet die Einnahmen für jedes Produkt in dem jeweiligen Kaufauftrag.  
  
 [!code-sql[Wählen Sie #SelectExamples5](../../t-sql/queries/codesnippet/tsql/select-examples-transact_5.sql)]  
...
## <a name="c-using-distinct-with-select"></a>C. Verwenden von DISTINCT mit SELECT  
 ...
 [!code-sql[Wählen Sie #SelectExamples6](../../t-sql/queries/codesnippet/tsql/select-examples-transact_6.sql)]  
...
## <a name="d-creating-tables-with-select-into"></a>D. Erstellen von Tabellen mit SELECT INTO  
 ...
 [!code-sql[Wählen Sie #SelectExamples7](../../t-sql/queries/codesnippet/tsql/select-examples-transact_7.sql)]  
  
 In diesem zweiten Beispiel wird eine dauerhafte Tabelle namens `NewProducts` erstellt.  
  
 [!code-sql[Wählen Sie #SelectExamples8](../../t-sql/queries/codesnippet/tsql/select-examples-transact_8.sql)]  
...
## <a name="e-using-correlated-subqueries"></a>E. Verwenden von abhängigen Unterabfragen  
 ...
 [!code-sql[Wählen Sie #SelectExamples9](../../t-sql/queries/codesnippet/tsql/select-examples-transact_9.sql)]  
 ...
 [!code-sql[Wählen Sie #SelectExamples10](../../t-sql/queries/codesnippet/tsql/select-examples-transact_10.sql)]  
 ...
 [!code-sql[Wählen Sie #SelectExamples11](../../t-sql/queries/codesnippet/tsql/select-examples-transact_11.sql)]  
 ...
 [!code-sql[Wählen Sie #SelectExamples12](../../t-sql/queries/codesnippet/tsql/select-examples-transact_12.sql)]  
...
## <a name="f-using-group-by"></a>F. Verwenden von GROUP BY  
 ...
 [!code-sql[Wählen Sie #SelectExamples13](../../t-sql/queries/codesnippet/tsql/select-examples-transact_13.sql)]  
...
## <a name="g-using-group-by-with-multiple-groups"></a>G. Verwenden von GROUP BY mit mehreren Gruppen  
 ...
 [!code-sql[Wählen Sie #SelectExamples14](../../t-sql/queries/codesnippet/tsql/select-examples-transact_14.sql)]  
...
## <a name="h-using-group-by-and-where"></a>H. Verwenden von GROUP BY und WHERE  
 ...
 [!code-sql[Wählen Sie #SelectExamples15](../../t-sql/queries/codesnippet/tsql/select-examples-transact_15.sql)]  
...
## <a name="i-using-group-by-with-an-expression"></a>I. Verwenden von GROUP BY mit einem Ausdruck  
 ...
 [!code-sql[Wählen Sie #SelectExamples16](../../t-sql/queries/codesnippet/tsql/select-examples-transact_16.sql)]  
...
## <a name="j-using-group-by-with-order-by"></a>J. Verwenden von GROUP BY mit ORDER BY  
 ...
 [!code-sql[Wählen Sie #SelectExamples18](../../t-sql/queries/codesnippet/tsql/select-examples-transact_17.sql)]  
...
## <a name="k-using-the-having-clause"></a>K. Verwenden der HAVING-Klausel  
 ...
 [!code-sql[Wählen Sie #SelectExamples19](../../t-sql/queries/codesnippet/tsql/select-examples-transact_18.sql)]  
...
## <a name="l-using-having-and-group-by"></a>L. Verwenden von HAVING und GROUP BY  
 ...
 [!code-sql[Wählen Sie #SelectExamples21](../../t-sql/queries/codesnippet/tsql/select-examples-transact_19.sql)]  
...
## <a name="m-using-having-with-sum-and-avg"></a>M. Verwenden von HAVING mit SUM und AVG  
 ...
 [!code-sql[Wählen Sie #SelectExamples22](../../t-sql/queries/codesnippet/tsql/select-examples-transact_20.sql)]  
 ...
 [!code-sql[Wählen Sie #SelectExamples23](../../t-sql/queries/codesnippet/tsql/select-examples-transact_21.sql)]  
 ...
 [!code-sql[Wählen Sie #SelectExamples24](../../t-sql/queries/codesnippet/tsql/select-examples-transact_22.sql)]  
...
## <a name="n-using-the-index-optimizer-hint"></a>N. Verwenden des INDEX-Optimiererhinweises  
 ...
 [!code-sql[Wählen Sie #SelectExamples45](../../t-sql/queries/codesnippet/tsql/select-examples-transact_23.sql)]  
...
## <a name="m-using-option-and-the-group-hints"></a>M. Verwenden der OPTION- und GROUP-Hinweise  
 ...
 [!code-sql[Wählen Sie #SelectExamples46](../../t-sql/queries/codesnippet/tsql/select-examples-transact_24.sql)]  
...
## <a name="o-using-the-union-query-hint"></a>O. Verwenden des UNION-Abfragehinweises  
 ...
 [!code-sql[Wählen Sie #SelectExamples47](../../t-sql/queries/codesnippet/tsql/select-examples-transact_25.sql)]  
...
## <a name="p-using-a-simple-union"></a>P. Verwenden einer einfachen UNION-Klausel  
 ...
 [!code-sql[Wählen Sie #SelectExamples48](../../t-sql/queries/codesnippet/tsql/select-examples-transact_26.sql)]  
...
## <a name="q-using-select-into-with-union"></a>Q. Verwenden von SELECT INTO mit UNION  
 ...
 [!code-sql[Wählen Sie #SelectExamples49](../../t-sql/queries/codesnippet/tsql/select-examples-transact_27.sql)]  
...
## <a name="r-using-union-of-two-select-statements-with-order-by"></a>R. Verwenden von UNION in zwei SELECT-Anweisungen mit ORDER BY  
 ...
 [!code-sql[Wählen Sie #SelectExamples50](../../t-sql/queries/codesnippet/tsql/select-examples-transact_28.sql)]  
...
## <a name="s-using-union-of-three-select-statements-to-show-the-effects-of-all-and-parentheses"></a>S. Verwenden von UNION mit drei SELECT-Anweisungen, wobei die Auswirkung von ALL und Klammern gezeigt wird  
 ...
 [!code-sql[Wählen Sie #SelectExamples51](../../t-sql/queries/codesnippet/tsql/select-examples-transact_29.sql)]  
...
## <a name="see-also"></a>Siehe auch  
 ...
 [IN-Klausel &#40; Transact-SQL &#41;](../../t-sql/queries/select-into-clause-transact-sql.md)  
