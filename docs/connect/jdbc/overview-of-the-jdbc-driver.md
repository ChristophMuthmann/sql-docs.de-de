...
|[Featureabhängigkeiten von Microsoft JDBC Driver für SQL Server](../../connect/jdbc/feature-dependencies-of-microsoft-jdbc-driver-for-sql-server.md)|Featureabhängigkeiten von Microsoft JDBC Driver für SQL Server.|
