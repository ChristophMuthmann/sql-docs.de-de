---
title: GetReference-Methode (SQLServerXADataSource) | Microsoft Docs
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Gibt einen Verweis auf diese [SQLServerXADataSource](../../../connect/jdbc/reference/sqlserverxadatasource-class.md) Objekt.  
