---
title: CONCUR_SS_OPTIMISTIC_CC-Feld (SQLServerResultSet) | Microsoft Docs
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="concurssoptimisticcc-field-sqlserverresultset"></a>CONCUR_SS_OPTIMISTIC_CC-Feld (SQLServerResultSet)
