---
title: GetFetchSize-Methode (SQLServerResultSet) | Microsoft Docs
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Ruft die Abrufgröße für dieses [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) Objekt.  
...
## <a name="return-value"></a>Rückgabewert  
 Ein **Int** , der die aktuellen Abrufgröße angibt.  
