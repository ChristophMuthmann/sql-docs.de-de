---
title: JdbcCompliant-Methode (SQLServerDriver) | Microsoft Docs
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Überprüft, ob die [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)] mit der JDBC-Spezifikation kompatibel ist.  
