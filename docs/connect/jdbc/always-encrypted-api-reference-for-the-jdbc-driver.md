...
|public final boolean getSendTimeAsDatetime()|Gibt die Einstellung der-Verbindungseigenschaft SendTimeAsDatetime zurück.|
...
|public String getKeyStoreLocation()|Ruft die KeyStoreLocation für die Java-Schlüsselspeicher ab.|
...
|Name|Description|  
|----------|-----------------|  
|public SQLServerColumnEncryptionAzureKeyVaultProvider (String clientId, String clientKey)|Schlüsselspeicheranbieter für Azure Key Vault.  Sie müssen die ID und den Schlüssel der anfordernde Client das Token zur Authentifizierung beim Azure-Schlüsseltresor bereitstellen.|  
