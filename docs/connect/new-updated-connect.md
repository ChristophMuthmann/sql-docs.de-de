...
1. [Startseite für den Client für Microsoft SQL Server-Programmierung](homepage-sql-connection-programming.md)
2. [Herstellen einer Verbindung mithilfe von Azure Active Directory-Authentifizierung](php/azure-active-directory.md)
3. [Verbindungsstabilität im Leerlauf](php/connection-resiliency.md)
4. [PHP Linux- und Macintosh-Treiber Installation Lernprogramm](php/installation-tutorial-linux-mac.md)
5. [Verbindung von Modulen für Microsoft SQL-Datenbanken](sql-connection-libraries.md)
