...
description: "Sie können überwachen, aktive und aktuelle [dwloader](dwloader.md) lädt mithilfe der Verwaltungskonsole Analytics Platform System (APS) oder die Parallel Data Warehouse (PDW)-Systemsichten auf."
ms.date: 10/20/2016
ms.topic: article
