---
title: Menübefehle und andere Tastenkombinationen (MySQLToSQL) | Microsoft Docs
...
|Herstellen anzeigen oder das erneute Verbinden mit MySQL-Dialogfeld.|ALT + F + T|  
...
|Aktualisieren von MySQL-Datenbank.|ALT+T + R|  
...
|ZU DIESEM ZWECK|DRÜCKEN SIE|  
|--------------|---------|  
|Zu SSMA für MySQL-Dialogfeld angezeigt.|ALT + H + A|  
