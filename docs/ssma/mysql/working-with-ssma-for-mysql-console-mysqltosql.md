...
|[Erstellen Variablenwert Dateien &#40; MySQLToSQL &#41;](../../ssma/mysql/creating-variable-value-files-mysqltosql.md)|Erläutert, wie eine Variablenwert-Datei erstellt.|  
|[Erstellen die Server-Connection-Dateien &#40; MySQLToSQL &#41;](../../ssma/mysql/creating-the-server-connection-files-mysqltosql.md)|Erläutert, wie eine Server-Verbindungsdatei zu erstellen.|  
