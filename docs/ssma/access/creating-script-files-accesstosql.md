...
4.  **Verbinden Sie die Anbieter:** Dies ermöglicht dem Benutzer die erneute Verbindung-Einstellungen bei einem Verbindungsfehler festgelegt. Dies kann für die Quell-und Zielserver festgelegt werden.  
...
7.  **Der Beendigungsvorgang:** während des Mid-Vorgangs, ob der Benutzer möchte, klicken Sie dann den Vorgang Abbrechen **"STRG + C"** Hotkey verwendet werden kann. SSMA für Access-Konsole zum Abschließen des Vorgangs wartet, und beendet die Ausführung der Konsole.  
