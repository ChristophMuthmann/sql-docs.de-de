title: "Ereignisklasse „Auto Stats“ | Microsoft-Dokumentation" ms.custom: "" ms.date: "14.3.2017" ms.prod: "sql" ms.prod_service: "database-engine, sql-database" ms.service: "" ms.component: "event-classes" ms.reviewer: "" ms.suite: "sql" ms.technology: 
