---
title: Aktualisiert - MDX für SQL Server-Dokumentation | Microsoft Docs
description: Codeausschnitte anzeigen aktualisierter Inhalt in zuletzt geänderten Dokumentation für MDX (Multidimensional Expressions) für Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
- *Bereich für die Themenbereichsdatenbank:* &nbsp; **MDX (Multidimensional Expressions) für SQL Server**.
