---
title: Benennen Sie Element für Schema (DTA) | Microsoft Docs
ms.custom: ''
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Enthält den Namen des Schemas.  
