...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Mit dem **dta**-Befehlszeilenprogramm wird die Funktionalität des Datenbankoptimierungsratgebers erweitert.  
