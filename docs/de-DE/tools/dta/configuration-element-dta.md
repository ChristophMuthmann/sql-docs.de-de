...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Gibt eine benutzerdefinierte Konfiguration an, die aus vorhandenen und hypothetischen Strukturen des physischen Designs besteht, die vom Datenbankoptimierungsratgeber beim Optimieren einer Arbeitsauslastung analysiert werden sollen.  
