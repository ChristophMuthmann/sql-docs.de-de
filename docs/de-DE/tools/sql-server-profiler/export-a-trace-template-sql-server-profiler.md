...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] In diesem Artikel wird beschrieben, wie eine vorhandene Ablaufverfolgungsvorlage mit [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] exportiert und als Vorlagedatei (TDF-Datei) gespeichert wird. Wenn Sie eine Vorlagedatei exportieren und als Datei speichern, können Sie die Vorlage für andere Instanzen von [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]verwenden.  
