...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] In diesem Artikel wird die Vorgehensweise zum Öffnen einer vorhandenen Ablaufverfolgungstabelle mithilfe von [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] beschrieben.  
