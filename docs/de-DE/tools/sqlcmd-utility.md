...
-   **:Error**, **:Out** und **:Perftrace** sollten verschiedene **\<***filename***>**-Parameter verwendet werden. Wird derselbe **\<***filename***>**-Parameter verwendet, werden Eingaben von den Befehlen womöglich vermischt.  
