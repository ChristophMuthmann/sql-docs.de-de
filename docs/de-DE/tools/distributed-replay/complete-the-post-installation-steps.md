...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Nach der Installation von Distributed Replay müssen Sie den Distributed Replay-Controller und die zugehörigen Clientdienstkonten ändern.  
