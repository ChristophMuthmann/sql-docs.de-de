---
title: "Erstellen eindeutiger Indizes | Microsoft Docs"
ms.custom: ""
ms.date: "02/17/2017"
...
helpviewer_keywords: 
  - "Eindeutige Indizes"
  - "Entwerfen von Indizes [SQL Server], eindeutige"
  - "gruppierte Indizes, eindeutige"
  - "Indizes [SQL Server], eindeutige"
  - "Nicht gruppierte Indizes [SQL Server], eindeutige"
  - "Eindeutige Indizes, Richtlinien zum Entwerfen"
...
#### So erstellen Sie einen eindeutigen Index mit dem Tabellen-Designer  
...
#### Erstellen eines eindeutigen Indexes mit dem Objekt-Explorer  
...
#### So erstellen Sie einen eindeutigen Index auf einer Tabelle  
