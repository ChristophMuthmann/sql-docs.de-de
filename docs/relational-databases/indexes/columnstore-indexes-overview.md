...
ms.topic: "article"
helpviewer_keywords: 
  - "Indexerstellung, Columnstore"
  - "Indizes [SQL Server], Columnstore"
  - "columnstore-Index"
  - "Beschreibung von Columnstore-Indizes"
  - "xVelocity, Columnstore-Indizes"
...
## Verwandte Aufgaben  
 Alle relationalen Tabellen, sofern Sie sie nicht als gruppierten Columnstore-Index festlegen, verwenden Rowstore als zugrundeliegendes Datenformat. CREATE TABLE erstellt eine Rowstore-Tabelle, sofern Sie nicht die Option WITH CLUSTERED COLUMNSTORE INDEX angeben.  
  
 Beim Erstellen einer Tabelle mit der CREATE TABLE-Anweisung können Sie die Tabelle als Columnstore erstellen, indem Sie die Option WITH CLUSTERED COLUMNSTORE INDEX angeben. Wenn Sie bereits über eine Rowstore-Tabelle verfügen, die Sie in einen Columnstore konvertieren möchten, können Sie die Anweisung CREATE COLUMNSTORE INDEX verwenden. Beispiele finden Sie unter.  
...
|Erstellen leistungsfähiger Columnstore-Indizes für Data Warehousing|[Columnstore-Indizes für Data Warehousing](../Topic/Columnstore%20Indexes%20for%20Data%20Warehousing.md)|Beschreibt, wie B-Strukturindizes für Columnstore-Tabellen verwendet werden können, um leistungsstarke Data Warehousing-Abfragen zu erstellen.|  
|Verwenden eines B-Strukturindex zum Durchsetzen einer Primärschlüsseleinschränkung für einen Columnstore-Index.|[Columnstore-Indizes für Data Warehousing](../Topic/Columnstore%20Indexes%20for%20Data%20Warehousing.md)|Zeigt, wie B-Struktur- und Columnstore-Indizes kombiniert werden können, um Primärschlüsseleinschränkungen für den Columnstore-Indizes durchzusetzen.|  
...
|Laden von Daten in einen Columnstore-Index|[Laden von Daten für Columnstore-Indizes](../Topic/Columnstore%20Indexes%20Data%20Loading.md)||  
