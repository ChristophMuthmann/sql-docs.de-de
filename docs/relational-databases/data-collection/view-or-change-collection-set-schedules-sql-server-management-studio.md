---
title: "Anzeigen oder &#196;ndern von Sammlungssatz-Zeitpl&#228;nen (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Sammlungssätze [SQL Server], Ändern von Zeitplänen"
  - "Zeitpläne [SQL Server], Ändern des Sammlungssatzes"
  - "Sammlungssätze [SQL Server], Anzeigen von Zeitplänen"
  - "Zeitpläne [SQL Server], Anzeigen eines Sammlungssatzes"
...
---
# Anzeigen oder &#196;ndern von Sammlungssatz-Zeitpl&#228;nen (SQL Server Management Studio)
...
### So zeigen Sie Sammlungssatz-Zeitpläne an  
...
### So ändern Sie die Zeitpläne für einen Sammlungssatz im Modus mit Zwischenspeicherung  
...
### So ändern Sie den Zeitplan für einen Sammlungssatz im Modus ohne Zwischenspeicherung  
