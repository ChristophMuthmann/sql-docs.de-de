---
title: "Berichte der Systemdaten-Sammlungss&#228;tze | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Datensammler [SQL Server], Serveraktivität"
  - "Serveraktivität [SQL Server]"
  - "Berichte [SQL Server], Datensammlung"
  - "Berichte [SQL Server], Datenträgerverwendung"
  - "Sammlungssätze [SQL Server], Berichte"
  - "Datensammler [SQL Server], Berichte"
  - "Berichte [SQL Server], Abfragestatistik"
  - "Abfragestatistik-Bericht [SQL Server]"
  - "Datenträgerverwendungsberichte [SQL Server]"
...
### Bericht über den Sammlungssatz für Datenträgerverwendung  
...
#### Unterbericht "Sammlungssatz für Datenträgerverwendung – Datenbank: <Datenbankname>"  
...
#### Unterbericht "Datenträgerverwendung für Datenbank: <Datenbankname>"  
...
### Auswählen von Daten zum Einschließen in den Bericht  
...
#### Bericht "Abfragestatistik - Verlauf"  
...
#### Unterbericht "Abfrageplandetails"  
...
## Bericht "Serveraktivität - Verlauf"  
