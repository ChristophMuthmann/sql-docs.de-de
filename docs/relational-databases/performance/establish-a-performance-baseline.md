---
title: "Festlegen einer Leistungsbasislinie | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Datenbankleistung [SQL Server], Grundwerte"
  - "Überwachen der Leistung [SQL Server-Replikation], Grundwerte"
  - "Optimieren von Datenbanken [SQL Server], Grundwerte"
  - "Serverleistung [SQL Server], Grundwerte"
  - "Leistung [SQL Server], Grundwerte"
  - "Grundleistung [SQL Server]"
  - "Messungen für Grundwertstatistiken [SQL Server]"
  - "Überwachen der Serverleistung [SQL Server], Festlegen von Grundwerten"
  - "Datenbanküberwachung [SQL Server], Grundwerte"
