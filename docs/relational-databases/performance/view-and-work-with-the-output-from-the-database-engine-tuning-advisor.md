---
title: "Anzeigen und Verwenden der Ausgabe des Datenbankoptimierungsratgebers | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "Empfehlungen [Datenbankoptimierungsratgeber]"
  - "Zusammenfassende Optimierungsinformationen [SQL Server]"
  - "Datenbankoptimierungsratgeber [SQL Server], Empfehlungen"
  - "Datenbankoptimierungsratgeber [SQL Server], Protokolle"
  - "Datenbankoptimierungsratgeber [SQL Server], Anzeige von Ausgabe"
  - "Datenbankoptimierungsratgeber [SQL Server], Berichte"
  - "Protokolle [SQL Server], Optimierung"
  - "Berichte [SQL Server], Optimierung"
  - "Anzeigen der Optimierungsaugabe"
...
> [!NOTE]  
>  Falls Sie das Befehlszeilen-Hilfsprogramm **dta** verwenden und mithilfe des Arguments **-ox** angeben, dass die Ausgabe in eine XML-Datei geschrieben wird, können Sie die XML-Ausgabedatei öffnen und anzeigen, indem Sie im Menü **Datei** von [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] auf **Datei öffnen** klicken. Weitere Informationen finden Sie unter [Use SQL Server Management Studio](../../ssms/use-sql-server-management-studio.md). Informationen zum Befehlszeilen-Hilfsprogramm **dta** finden Sie unter [dta (Hilfsprogramm)](../../tools/dta/dta-utility.md).  
