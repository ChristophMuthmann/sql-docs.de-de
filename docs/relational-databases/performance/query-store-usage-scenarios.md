...
## <a name="keep-performance-stability-during-the-upgrade-to-sql-server-2016"></a>Aufrechterhalten einer stabilen Leistung während des Upgrades auf SQL Server 2016  
