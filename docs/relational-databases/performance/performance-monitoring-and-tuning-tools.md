---
title: "Tools f&#252;r die Leistungs&#252;berwachung und -optimierung | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Tools [SQL Server], Überwachen der Leistung"
  - "Überwachen der Serverleistung [SQL Server], Tools"
  - "Überwachen der Leistung [SQL Server], Tools"
  - "Datenbankleistung [SQL Server], Tools"
  - "Optimieren von Datenbanken [SQL Server], Tools"
  - "Datenbanküberwachung [SQL Server], Tools"
  - "Leistung [SQL Server], Überwachungstools"
  - "Serverleistung [SQL Server], Tools"
