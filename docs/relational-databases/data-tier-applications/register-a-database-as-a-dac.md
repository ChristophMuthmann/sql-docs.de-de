---
title: "Registrieren einer Datenbank als eine DAC | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "Assistent [DAC], registrieren"
  - "Vorgehensweise [DAC], registrieren"
  - "DAC registrieren"
  - "Datenebenenanwendung [SQL Server], registrieren"
 ...
 **Prüfung**  *SchemaName* **.** *ObjectName* **.** – Zeigt eine Statusanzeige an, während der Assistent die Abhängigkeiten der abgerufenen Objekten überprüft und sicherstellt, dass sie alle für eine DAC gültig sind. *SchemaName***.***ObjectName* gibt das derzeit überprüfte Objekt an.  
