---
title: "SQL Server PowerShell-Anbieter | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "PowerShell [SQL Server], Anbieter"
  - "PowerShell [SQL Server], SQL Server PowerShell-Anbieter"
  - "Anbieter [PowerShell]"
