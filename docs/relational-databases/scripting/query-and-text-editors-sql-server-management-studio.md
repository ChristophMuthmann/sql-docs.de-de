---
title: "Abfrage- und Text-Editoren (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "Code-Editor [SQL Server Management Studio], Informationen zum Abfrage-Editor"
  - "Abfrage-Editor [SQL Server Management Studio], Vollbildmodus"
  - "Abfrage-Editor [Datenbankmodul], Vorlagen"
  - "Vollbildmodus [SQL Server Management Studio]"
  - "SQL Server Management Studio [SQL Server], Vorlagen"
  - "Schreiben von Skripts"
  - "Ändern von Skripts"
  - "SQL Server Management Studio [SQL Server], Abfrage-Editor"
  - "Abfrage-Editor [SQL Server Management Studio], Informationen zum Abfrage-Editor"
  - "Schreiben von Abfragen"
  - "SQL Server Management Studio [SQL Server], Editor"
  - "Skripts [SQL Server], SQL Server Management Studio"
  - "Abfragen [SQL Server], SQL Server Management Studio"
...
## Komponenten des Datenbankmodul-Abfrage-Editors  
 ...
 **SQLCMD-Modus**  
 Führt [!INCLUDE[tsql](../../includes/tsql-md.md)]-Skripts aus, die den vom sqlcmd-Hilfsprogramm unterstützten Satz von Befehlen enthalten. Weitere Informationen finden Sie in den [Themen zur Vorgehensweise für sqlcmd](../Topic/sqlcmd%20How-to%20Topics.md).  
...
|Beschreibt, wie die grundlegenden Funktionen im MDX-Abfrage-Editor angezeigt und verwendet werden.|[MDX-Abfrage-Editor &#40;Analysis Services – Mehrdimensionale Daten&#41;](../Topic/MDX%20Query%20Editor%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)|  
|Beschreibt, wie die grundlegenden Funktionen im DMX-Abfrage-Editor angezeigt und verwendet werden.|[DMX-Abfrage-Editor &#40;Analysis Services &mdash; Data Mining&#41;](../Topic/DMX%20Query%20Editor%20\(Analysis%20Services%20-%20Data%20Mining\).md)|  
