---
title: "&#196;ndern von Schriftfarbe, Schriftgrad und Schriftschnitt | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Größe [SQL Server], Schriftarten"
  - "Ändern von Schriftarten"
  - "Schriftarten [SQL Server Management Studio]"
  - "Anpassen von Schriftarten [SQL Server]"
  - "Abfrage-Editor [SQL Server Management Studio], Verwalten von Schriftarten"
  - "Textschriftarten [SQL Server Management Studio]"
...
---
# &#196;ndern von Schriftfarbe, Schriftgrad und Schriftschnitt
...
### So ändern Sie Schriftfarbe, Schriftgrad und Schriftschnitt im Editor  
