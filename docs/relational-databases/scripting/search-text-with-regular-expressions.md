---
title: "Suchen von Text mit regul&#228;ren Ausdr&#252;cken | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Reguläre Ausdrücke [SQL Server Management Studio]"
  - "Abfrage-Editor [SQL Server Management Studio], Suchen mit regulären Ausdrücken"
  - "Suchen [SQL Server Management Studio], reguläre Ausdrücke"
...
# Suchen von Text mit regul&#228;ren Ausdr&#252;cken
  Reguläre Ausdrücke sind eine präzise und flexible Notation zum Suchen und Ersetzen von Textmustern. Im Feld **Suchen nach** des Dialogfelds **Suchen und Ersetzen** in [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] kann ein spezifischer Satz regulärer Ausdrücke verwendet werden.  
  
#### So können Sie Suchvorgänge mithilfe von regulären Ausdrücken ausführen  
