---
title: "Angeben einer Breakpointaktion | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Transact-SQL-Debugger, Breakpointaktion"
  - "Transact-SQL-Debugger, Breakpointaktion bei Treffer"
...
-   Ein [!INCLUDE[tsql](../../includes/tsql-md.md)]-Ausdruck in geschweiften Klammern ({}). Die Ausdrücke können [!INCLUDE[tsql](../../includes/tsql-md.md)]-Variablen, -Parameter und integrierte Funktionen enthalten. Beispiele sind {@MyVariable}, {@NameParameter}, {@@SPID} oder {SERVERPROPERTY ('ProcessID')}.  
