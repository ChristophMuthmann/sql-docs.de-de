---
title: "Abfrage-Editor des Datenbankmoduls (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "Abfrage-Editor [Datenbankmodul]"
  - "Transact-SQL-Editor siehe Abfrage-Editor [Datenbankmodul]"
  - "Abfrage-Editor des Datenbankmoduls siehe Abfrage-Editor [Datenbankmodul]"
  - "Abfrage-Editor [Datenbankmodul], Symbolleiste"
  - "Editoren [SQL Server Management Studio], Abfrage-Editor des Datenbankmoduls"
  - "Abfrage-Editor [Datenbankmodul], Funktionen"
  - "SQL Server Management Studio [SQL Server], Abfrage-Editor des Datenbankmoduls"
