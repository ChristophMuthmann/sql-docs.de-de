---
title: "Ausf&#252;hren des Transact-SQL-Debuggers | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Transact-SQL-Debugger, sysadmin-Anforderung"
  - "Transact-SQL-Debugger, unterstützte Versionen"
  - "Abfrage-Editor [Datenbankmodul], Kontextmenü"
  - "Debuggen [SQL Server], T-SQL-Debugger"
  - "Transact-SQL-Debugger, Abfrage-Editor, Kontextmenü"
  - "Transact-SQL-Debugger, beenden"
  - "Transact-SQL-Debugger, Debuggen (Menü)"
  - "Debuggen [SQL Server]"
  - "Transact-SQL-Debugger, Debuggen (Symbolleiste)"
  - "Transact-SQL-Debugger, Tastenkombinationen"
  - "Transact-SQL-Debugger, starten"
...
|**Alle trennen**|Nicht verfügbar|Nicht verfügbar|Nicht verfügbar|Beendet den Debugmodus, führt jedoch die übrigen Anweisungen im Abfrage-Editor-Fenster aus.|  
