---
title: "Verwenden von sqlcmd mit Skriptvariablen | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "Skripts [SQL Server], Hilfsprogramm sqlcmd"
  - "Variablen [SQL Server], Skripts"
  - "Skriptvariablen [SQL Server]"
  - "Hilfsprogramm sqlcmd, Skripts"
  - "setvar-Befehl"
