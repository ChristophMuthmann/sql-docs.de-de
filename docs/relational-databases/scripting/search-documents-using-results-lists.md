---
title: "Durchsuchen von Dokumenten mithilfe von Ergebnislisten | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Suchvorgänge [SQL Server Management Studio], Ergebnislisten"
  - "Ergebnislisten-Suchvorgänge [SQL Server Management Studio]"
  - "Suchvorgänge [SQL Server Management Studio], mehrere Dateien"
  - "Abfrage-Editor [SQL Server Management Studio], Durchsuchen mehrerer Dateien"
...
---
# Durchsuchen von Dokumenten mithilfe von Ergebnislisten
...
### So durchsuchen Sie mehrere Dateien  
...
#### So ersetzen Sie Elemente in mehreren Dateien oder Ordnern  
