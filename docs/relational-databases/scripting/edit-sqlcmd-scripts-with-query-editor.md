---
title: "Bearbeiten von SQLCMD-Skripts mit dem Abfrage-Editor | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Skripts [SQL Server], SQLCMD-Skripts"
  - "SQLCMD-Skripts"
  - "Ändern von Skripts"
  - "Abfrage-Editor [Datenbankmodul], SQLCMD-Skripts"
...
#### So wechseln Sie in einem Abfrage-Editorfenster des Datenbankmoduls in den SQLCMD-Modus  
