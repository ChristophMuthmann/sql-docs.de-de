---
title: "Herstellen einer Verbindung mit dem Datenbankmodul mithilfe von sqlcmd | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "sqlcmd (Hilfsprogramm), Datenbankmodulverbindungen"
  - "Named Pipes [SQL Server], sqlcmd-Hilfsprogramm"
  - "TCP/IP [SQL Server], Clientprotokolle"
  - "Netzwerkprotokolle [SQL Server], sqlcmd-Hilfsprogramm"
  - "Protokolle [SQL Server], sqlcmd-Hilfsprogramm"
  - "VIA"
...
manager: "jhubbard"
---
# Herstellen einer Verbindung mit dem Datenbankmodul mithilfe von sqlcmd
