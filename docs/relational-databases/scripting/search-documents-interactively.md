---
title: "Interaktives Durchsuchen von Dokumenten | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Interaktive Suchvorgänge [SQL Server Management Studio]"
  - "Suchvorgänge [SQL Server Management Studio], interaktive"
  - "Abfrage-Editor [SQL Server Management Studio], interaktive Suchvorgänge"
...
---
# Interaktives Durchsuchen von Dokumenten
...
### So durchsuchen Sie alle geöffneten Dokumente  
...
#### So können Sie Elemente in allen aktiven Dateien interaktiv ersetzen  
