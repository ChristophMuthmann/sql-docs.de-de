---
title: "Erstellen der Richtlinie Finance Name | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
### So erstellen Sie die Datenbank "Finance"  
...
7.  Vervollständigen Sie im Feld **Ausdruck** den Ausdruck so, dass er **@Name = 'Finanzen'** umfasst, und klicken Sie anschließend auf **OK**, um die Bedingungsseite zu schließen.  
...
[Abonnieren und Überprüfen der Richtlinie 'Finanz_Name'](../../relational-databases/policy-based-management/subscribe-to-and-check-the-finance-name-policy.md)  
