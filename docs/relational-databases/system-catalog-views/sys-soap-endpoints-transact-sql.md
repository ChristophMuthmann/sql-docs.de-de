...
|**default_namespace**|**nvarchar(384)**|Der Standardnamespace, der in der Option NAMESPACE = angegeben ist, oder 'http://tempuri.org', wenn stattdessen DEFAULT angegeben wurde.|  
|**default_result_schema**|**tinyint**|Der Standardwert der Option SCHEMA = .<br /><br /> 0 = NONE<br /><br /> 1 = STANDARD|  
|**default_result_schema_desc**|**nvarchar(60)**|Die Beschreibung des Standardwerts der Option SCHEMA = .<br /><br /> NONE<br /><br /> Standardwert|  
