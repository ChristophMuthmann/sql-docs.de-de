...
|**Skalierung**|**tinyint**|Die maximalen Dezimalstellen des Typs, wenn es sich um einen zahlenbasierten Typ handelt; andernfalls 0.|  
|**Sortierungsname**|**sysname**|Der Name der Sortierung des Typs wird jedoch zeichenbasierte; andere Wise NULL.|  
