...
|**dem interval_length_minutes-Argument**|**bigint**|Statistiken aggregationsintervalls. Beliebige Werte sind nicht zulässig. Verwenden Sie eine der folgenden: 1, 5, 10, 15, 30, 60 und 1440 Minuten. Der Standardwert ist 60 Minuten.|  
...
|**wait_stats_capture_mode**|**smallint**|Steuert, ob der Abfragespeicher Erfassung von wartestatistik ausführt: <br /><br /> 0 = OFF <br /><br /> 1 = ON|
|**wait_stats_mode_capture_desc**|**nvarchar(60)**|Die textbeschreibung des Aufzeichnungsmodus die tatsächliche Wartezeit-Statistiken: <br /><br /> OFF <br /><br /> (Standard)| 
