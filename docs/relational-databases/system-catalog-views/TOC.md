...
# [Meldungen (für Fehler) – sys.messages](messages-for-errors-catalog-views-sys-messages.md)  
...
# Datenbankspiegelung
## [Datenbank-Spiegelungszeuge – sys.database_mirroring_witnesses](database-mirroring-witness-catalog-views-sys-database-mirroring-witnesses.md)  

# Datenebenenanwendungen
## [Datenebenenanwendungssichten – dbo.sysdac_instance](data-tier-application-views-dbo-sysdac-instances.md)  
...
# [Datenbank-E-Mail-Sichten](database-mail-views-transact-sql.md)  
...
## [sys.database_event_session_action (Azure SQL-Datenbank)](sys-database-event-session-actions-azure-sql-database.md)  
...
# [Partitionsfunktion](partition-function-catalog-views-transact-sql.md)  
