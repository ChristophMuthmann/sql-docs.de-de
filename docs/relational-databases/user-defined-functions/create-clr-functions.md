---
title: "Erstellen von CLR-Funktionen | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "CLR-Funktionen [SQL Server]"
  - "Benutzerdefinierte Funktionen [SQL Server], CLR"
