...
|**type**|**tinyint**|Gibt den Artikeltyp an, der einen der folgenden Werte aufweisen kann:<br /><br /> **0x0A** = Tabelle.<br /><br /> **0 x 20** = nur prozedurschema.<br /><br /> **0 x 40** = View Schema only oder indizierten Sicht Typ Schema only.<br /><br /> **0 x 80** = nur funktionsschema.|  
