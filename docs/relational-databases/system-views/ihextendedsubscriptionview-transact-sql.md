...
|**sync_type-Typ**|**tinyint**|Der Typ der Erstsynchronisierung:<br /><br /> **1** = automatisch<br /><br /> **2** = keine|  
...
|**agent_id-Wert**|**int**|Der eindeutige Bezeichner des Verteilungs-Agents.|  
