...
|**Servername**|**sysname**|Systemname.|  
|**Aktivität**|**vom Datentyp nvarchar(128)**|Die vom Datenbankwartungsplan durchgeführte Aktivität (z. B. Transaktionsprotokoll sichern usw.).|  
