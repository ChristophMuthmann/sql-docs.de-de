# [Übersicht](system-tables-transact-sql.md)  
# [Tabellen für erweiterte Ereignisse - "trace_xe_action_map"](extended-events-tables-trace-xe-action-map.md)  
# [Tabellen für erweiterte Ereignisse - "trace_xe_event_map"](extended-events-tables-trace-xe-event-map.md)  
# [Data-Tier-Anwendungstabellen - sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Data-Tier-Anwendungstabellen - "sysdac_instances_internal"](data-tier-application-tables-sysdac-instances-internal.md)  
# [Zuordnen von Systemtabellen zu Systemsichten](mapping-system-tables-to-system-views-transact-sql.md)  
# [Systembasistabellen](system-base-tables.md)  
# [Sichern und Wiederherstellen von Tabellen](backup-and-restore-tables-transact-sql.md)  
...
# [Change Data Capture-Tabellen](change-data-capture-tables-transact-sql.md)  
## [CDC. < Aufzeichnungsinstanz > _CT](cdc-capture-instance-ct-transact-sql.md)  
## [captured_columns](cdc-captured-columns-transact-sql.md)  
## [CDC. change_tables](cdc-change-tables-transact-sql.md)  
## [ddl_history](cdc-ddl-history-transact-sql.md)  
...
# [Replikationstabellen](replication-tables-transact-sql.md)  
