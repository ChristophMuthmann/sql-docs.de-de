...
# [Erweiterte Ereignistabelle: trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [Erweiterte Ereignistabelle: trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [Tabellen von Datenschichtanwendung: sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Tabellen von Datenschichtanwendung: sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
...
# [Change Data Capture (CDC)](change-data-capture-tables-transact-sql.md)  
