...
|**freq_recurrence_**<br /><br /> **factor**|**int**|Die Anzahl der Wochen oder Monate zwischen den geplanten Ausführungen eines Auftrags. **freq_recurrence_factor** is used only if **freq_type** is **8**, **16**, or **32**. Wenn diese Spalte enthält **0**, **Freq_recurrence_factor** wird nicht verwendet.|  
