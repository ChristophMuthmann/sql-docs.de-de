...
|**freq_recurrence_**<br /><br /> **Faktor**|**int**|Die Anzahl der Wochen oder Monate zwischen den geplanten Ausführungen eines Auftrags. **Freq_recurrence_factor** wird nur verwendet, wenn **Freq_type** ist **8**, **16**, oder **32**. Wenn diese Spalte enthält **0**, **Freq_recurrence_factor** wird nicht verwendet.|  
...
|**Versionsnummer**|**int**|Aktuelle Versionsnummer des Zeitplans. Wenn ein Zeitplan 10-Mal geändert wurde beispielsweise die **Version_number** ist 10.|  
