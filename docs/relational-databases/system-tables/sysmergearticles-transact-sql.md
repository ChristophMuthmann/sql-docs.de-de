...
|**type**|**tinyint**|Gibt den Artikeltyp an, der einen der folgenden Werte aufweisen kann:<br /><br /> **10** = Tabelle.<br /><br /> **32** = gespeicherte Prozedur (Schema only).<br /><br /> **64** = Sicht oder indizierte Sicht (Schema only).<br /><br /> **128** = User-defined Function (nur Schema).<br /><br /> **160** = Synonym (nur Schema).|  
