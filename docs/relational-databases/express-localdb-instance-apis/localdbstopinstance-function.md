...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Beendet die angegebene SQL Server Express LocalDB-Instanz ausgeführt wird.  
