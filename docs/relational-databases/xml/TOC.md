...
# [XML-Daten](xml-data-sql-server.md)
...
# [Große XML-Schemaauflistungen und Bedingungen des Typs Nicht genügend Arbeitsspeicher](large-xml-schema-collections-and-out-of-memory-conditions.md)
