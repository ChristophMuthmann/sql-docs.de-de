---
title: "Angeben von Metaeigenschaften in OPENXML | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  ...
  - "Metaeigenschaften [XML in SQL Server]"
  - "Nicht verbrauchte Daten"
  - "Extrahieren von Informationen aus XML-Knoten [SQL Server]"
  - "OPENXML-Anweisung, Metaeigenschaften"
...
-   Die **id**-Spalte wird dem **@mp:id**-Metaeigenschaftsattribut zugeordnet. Dies zeigt an, dass die systemgenerierte eindeutige XML-ID des Elements in der Spalte enthalten ist.  
  
-   Die **parent** -Spalte wird **@mp:parentid** zugeordnet. Dies zeigt an, dass die Spalte die XML-ID des übergeordneten Elements enthält.  
  
-   Die **parentLocalName** -Spalte wird **@mp:parentlocalname** zugeordnet. Dies zeigt an, dass die Spalte den lokalen Namen des übergeordneten Elements enthält.  
...
### C. Angeben der xmltext-Metaeigenschaft zur Abfrage der nicht verbrauchten Daten in einer Spalte  
 ...
 Es werden zwei zusätzliche Spalten im Rowset angegeben ( **parent** und **comment**). Die **parent** -Spalte wird **@mp:parentid** zugeordnet. Dies zeigt an, dass die Spalte die XML-ID des übergeordneten Elements des Elements enthält. Die comment-Spalte wird als Überlaufspalte durch Zuordnen zur **@mp:xmltext** -Metaeigenschaft identifiziert.  
