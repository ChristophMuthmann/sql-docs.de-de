---
title: "Verwenden von XML-Daten in Anwendungen | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "XML [SQL Server], ADO"
  - "Spalten [XML in SQL Server], ADO.NET"
  - "ADO [XML in SQL Server]"
  - "Spalten [XML in SQL Server], SQL Server Native Client"
  - "XML-Datentyp [SQL Server], ADO"
  - "SQLNCLI, XML"
  - "XML-Datentyp [SQL Server], SQL Server Native Client"
  - "SQL Server Native Client, XML"
  - "ADO.NET [XML in SQL Server]"
  - "XML [SQL Server], ADO.NET"
  - "Spalten [XML in SQL Server], ADO"
  - "XML-Datentyp [SQL Server], ADO.NET"
...
---
# Verwenden von XML-Daten in Anwendungen
