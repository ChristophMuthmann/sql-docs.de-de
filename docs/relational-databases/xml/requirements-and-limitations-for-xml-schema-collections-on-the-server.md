---
title: "Anforderungen und Einschr&#228;nkungen f&#252;r XML-Schemaauflistungen auf dem Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Bezeichner [XML-Schemaauflistungen]"
  - "XML-Schemaauflistungen [SQL Server], Einschränkungen"
  - "Ersetzungsgruppen [XML in SQL Server]"
  - "XML-Schemaauflistungen [SQL Server], Richtlinien"
  - "Nachlässige Überprüfung"
  - "Enumerationsfacets [XML in SQL Server]"
  - "Dezimalgenauigkeit [XML in SQL Server]"
  - "Wiederholte XML-Schemaauflistungswerte"
  - "Schemaauflistungen [SQL Server], Einschränkungen"
  - "Zeitzonen [XML in SQL Server]"
  - "Genauigkeitsdezimalstellen [XML in SQL Server]"
  - "Schemaauflistungen [SQL Server], Richtlinien"
...
|**\< xsd: redefine >**|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] unterstützt dieses Element nicht. Informationen über eine andere Möglichkeit, Schemas zu aktualisieren, finden Sie unter [Das &#60;xsd:redefine&#62;-Element](../../relational-databases/xml/the-xsd-redefine-element.md).|  
|**\<xsd:simpleType>**-Werte|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] unterstützt nur Millisekundengenauigkeit für simple-Datentypen, die Sekundenkomponenten besitzen – mit Ausnahme von **xs:time** und **xs:dateTime** –, sowie eine Genauigkeit von 100 Nanosekunden für **xs:time** und **xs:dateTime**. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] legt Einschränkungen für alle erkannten XSD-Enumerationen des einfachen Typs fest.<br /><br /> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] unterstützt nicht den „NaN“-Wert in **\<xsd:simpleType>**-Deklarationen.<br /><br /> Weitere Informationen finden Sie unter [Werte für &#60;xsd:simpleType&#62;-Deklarationen](../../relational-databases/xml/values-for-xsd-simpletype-declarations.md).|  
...
|[Große XML-Schemaauflistungen und Bedingungen des Typs Nicht genügend Arbeitsspeicher](../../relational-databases/xml/large-xml-schema-collections-and-out-of-memory-conditions.md)|Stellt Lösungen für Situationen bereit, in denen nicht genügend Arbeitsspeicher verfügbar ist, was gelegentlich bei großen Schemaauflistungen vorkommt.|  
