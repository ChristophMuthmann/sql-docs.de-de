...
helpviewer_keywords: 
  ...
  - "Schreiben von XML-Code, OPENXML-Anweisung"
  - "OPENXML-Anweisung, Abfragen von XML"
  - "Attributzentrierte Zuordnung"
  - "SELECT-Anweisung [SQL Server], OPENXML-Schlüsselwort"
  - "Spaltenmuster [XML in SQL Server]"
  - "Zeilenmuster [XML in SQL Server]"
  - "rowpattern [XML in SQL Server]"
  - "Abfragen [XML in SQL Server], OPENXML-Anweisung"
  - "XML [SQL Server], OPENXML-Anweisung"
...
```  
 ...
 ![Analysierte XML-Struktur](../../relational-databases/xml/media/xmlparsedtree.gif "Analysierte XML-Struktur")  
