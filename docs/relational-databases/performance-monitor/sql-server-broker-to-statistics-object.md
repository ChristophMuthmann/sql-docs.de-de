---
title: "SQL Server, Statistiken f&#252;r das Broker-TO (Objekt) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Broker Transmission Object-Objekt"
...
|----------------------------------------------|-----------------|  
|**Durchschn. Länge der Batchschreibvorgänge**|Die durchschnittliche Anzahl von Übertragungsobjekten, die in einem Batch gespeichert wurden.|  
|**Durchschn. Schreibdauer für Batch (ms)**|Die durchschnittliche Anzahl von Millisekunden, die zur Speicherung eines Batches von Übertragungsobjekten erforderlich waren.|  
|**Durchschn. Basis für Schreibdauer für Batch**|Nur zur internen Verwendung.|
...
|**Durchschn. Basis für Zeit zwischen Batches**|Nur zur internen Verwendung.| 
