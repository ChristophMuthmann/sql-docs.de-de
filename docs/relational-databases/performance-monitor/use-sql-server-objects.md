---
title: "Verwenden von SQL Server-Objekten | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Serverleistung [SQL Server], Objekte für Überwachung"
  - "Datenbanküberwachung [SQL Server], Objekte für Überwachung"
  - "Diagramme [SQL Server]"
  - "Systemmonitor [SQL Server], Indikatoren"
  - "Indikatoren [SQL Server], aufgelistet"
  - "Objekte [SQL Server], Leistungsüberwachung"
  - "Objekte [SQL Server], Windows-Systemmonitor"
  - "Leistungsindikatoren [SQL Server], Informationen zu Leistungsindikatoren"
  - "Systemmonitor [SQL Server], Objekte"
  - "Leistungsindikatoren [SQL Server]"
  - "Indikatoren [SQL Server], Informationen zu Leistungsindikatoren"
  - "Optimieren von Datenbanken [SQL Server], Objekte für Überwachung"
  - "Datenbankleistung [SQL Server], Objekte für Überwachung"
  - "SQL Server, Objekte"
  - "Überwachen der Leistung [SQL Server], Objekte für Überwachung"
  - "Windows-Systemmonitor [SQL Server], Objekte"
  - "Windows-Systemmonitor [SQL Server], Indikatoren"
  - "Indikatoren [SQL Server]"
  - "Leistungsindikatoren [SQL Server], aufgelistet"
