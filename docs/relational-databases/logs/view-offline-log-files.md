---
title: "Anzeigen von Offlineprotokolldateien | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Protokolldatei-Viewer, Anzeigen von Offlineprotokollen"
  - "Offlineprotokolldateien"
...
-   Leseberechtigung für den Ordner mit den Fehlerprotokolldateien. Standardmäßig befinden sich die Fehlerprotokolldateien unter dem folgenden Pfad (wobei \<*Laufwerk*> das Laufwerk darstellt, auf dem Sie [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] installiert haben, und \<*Instanzname*> den Namen der Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] darstellt):  
