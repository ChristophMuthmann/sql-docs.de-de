---
title: "Problembehandlung bei vollen Transaktionsprotokollen (SQL Server-Fehler 9002) | Microsoft Docs"
ms.custom: ""
ms.date: "08/05/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Protokolle [SQL Server], voll"
  - "Problembehandlung [SQL Server], volles Transaktionsprotokoll"
  - "9002 (Datenbankmodulfehler)"
  - "Transaktionsprotokolle [SQL Server], Kürzung"
  - "Sichern von Transaktionsprotokollen [SQL Server], volle Protokolle"
  - "Transaktionsprotokolle [SQL Server], volles Protokoll"
  - "Volle Transaktionsprotokolle [SQL Server]"
...
### Erhöhen der Größe der Protokolldatei  
