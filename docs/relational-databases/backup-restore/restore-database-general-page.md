---
title: "Datenbank wiederherstellen (Seite &#39;Allgemein&#39;) | Microsoft Docs"
ms.custom: ""
ms.date: "07/01/2016"
...
> [!NOTE]  
>  Wenn Sie einen Wiederherstellungstask mithilfe von [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] angeben, können Sie das entsprechende [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md)-Skript von [!INCLUDE[tsql](../../includes/tsql-md.md)] generieren, indem Sie auf **Skript** klicken und anschließend ein Ziel für das Skript auswählen.  
...
## Wiederherstellen von Microsoft Azure Storage  
