---
title: "Deaktivieren der verwalteten SQL Server-Sicherung in Microsoft Azure | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
#### So deaktivieren Sie [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] für eine bestimmte Datenbank  
...
#### So deaktivieren Sie [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] für alle Datenbanken  
...
#### So deaktivieren Sie die [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] -Standardkonfigurationseinstellungen  
...
#### So halten Sie [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]-Dienste mit Transact-SQL an  
...
#### So setzen Sie [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] mit Transact-SQL fort  
