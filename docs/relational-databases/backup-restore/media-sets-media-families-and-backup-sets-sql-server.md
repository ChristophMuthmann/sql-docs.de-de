---
title: "Mediens&#228;tze, Medienfamilien und Sicherungss&#228;tze (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/18/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Mediensätze [SQL Server], Informationen zu Mediensätzen"
  - "Sicherungsmedien [SQL Server], Informationen zu Sicherungsmedien"
  - "Sicherungen [SQL Server], Mediensätze"
  - "Mediensätze [SQL Server]"
  - "Medienheader [SQL Server]"
  - "Sicherungssätze [SQL Server], Informationen zu Sicherungssätzen"
  - "Sicherungsmedien [SQL Server], Mediensätze"
  - "Sicherungen [SQL Server], Medienfamilien"
  - "Sicherungsmedien [SQL Server], Medienfamilien"
  - "Medienfamilien [SQL Server]"
  - "Sicherungen [SQL Server], Sicherungssätze"
  - "Sicherungssätze [SQL Server]"
...
> **HINWEIS!** Mediensätze können zum Schutz gegen beschädigte Medienvolumes (Band oder Datenträgerdatei) gespiegelt werden. Weitere Informationen finden Sie unter [Gespiegelte Sicherungsmediensätze &#40;SQL Server&#41;](../../relational-databases/backup-restore/mirrored-backup-media-sets-sql-server.md).  
...
```  
 ...
 Informationen zu den Verlaufstabellen, in denen Informationen zu Mediensätzen und deren Medienfamilien und Sicherungssätze enthalten sind, finden Sie unter [Sicherungsverlauf und Headerinformationen &#40;SQL Server&#41;](../../relational-databases/backup-restore/backup-history-and-header-information-sql-server.md).  
...
##  <a name="CreatingMediaSet"></a> Erstellen eines neuen Mediensatzes  
...
##  <a name="Appending"></a> Anfügen an vorhandene Sicherungssätze  
...
##  <a name="Overwriting"></a> Überschreiben von Sicherungssätzen  
