---
title: "Wiederherstellen einer Datenbank ohne Wiederherstellung von Daten (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Wiederherstellen [SQL Server], reine Wiederherstellung"
  - "Reines Wiederherstellungszenario [SQL Server]"
  - "Wiederherstellen von Datenbanken [SQL Server], reine Wiederherstellung"
  - "Wiederherstellung [SQL Server], reine Wiederherstellung"
  - "Datenbankwiederherstellung [SQL Server]"
  - "Datenbankwiederherstellungen [SQL Server], reine Wiederherstellung"
  - "Wiederherstellung [SQL Server], ohne Wiederherstellung von Daten"
...
-   Die Datenbank befindet sich im Standbymodus, und Sie möchten, dass die Datenbank aktualisierbar ist, ohne dass eine weitere Protokollsicherung angewendet werden muss.  
 ...
 Die [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md)-Syntax für eine reine Datenbankwiederherstellung lautet wie folgt:  
...
## Reine Dateiwiederherstellung  
 ...
 Die [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md)-Syntax für eine reine Dateiwiederherstellung lautet:  
