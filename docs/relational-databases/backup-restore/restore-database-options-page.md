---
title: "Datenbank wiederherstellen (Seite Optionen) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
 ...
 **Replikationseinstellungen beibehalten (WITH KEEP_REPLICATION)**  
 ...
 Das Auswählen dieser Option entspricht der Verwendung der Option KEEP_REPLICATION in einer [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md)-Anweisung.  
 ...
 **RESTORE WITH RECOVERY**  
 Stellt die Datenbank nach der Wiederherstellung der im Raster **Wiederherzustellende Sicherungssätze** auf der Seite [Allgemein](../../relational-databases/backup-restore/restore-database-general-page.md) ausgewählten letzten Sicherung wieder her. Dies ist die Standardoption und entspricht der Angabe von WITH RECOVERY in einer [RESTORE](../Topic/RESTORE%20Arguments%20\(Transact-SQL\).md)-Anweisung ([!INCLUDE[tsql](../../includes/tsql-md.md)]).  
