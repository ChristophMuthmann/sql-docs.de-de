---
title: "Wiederherstellen von verwandten Datenbanken mithilfe von markierten Transaktionen (vollst&#228;ndiges Wiederherstellungsmodell) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Transaktionsmarkierungen [SQL Server]"
  - "Markierte Transaktionen [SQL Server]"
  - "Datenbankwiederherstellungen [SQL Server], Einfügen von Transaktionsmarkierungen für"
  - "Wiederherstellung [SQL Server], verwandte Datenbanken"
  - "Wiederherstellen von Datenbanken [SQL Server], Wiederherstellung verwandter Datenbanken"
  - "Datenbankwiederherstellung [SQL Server], verwandte Datenbanken"
  - "Markierte Transaktionen [SQL Server], erstellen"
  - "BEGIN TRAN...WITH MARK-Anweisung"
  - "Zweiphasencommit"
