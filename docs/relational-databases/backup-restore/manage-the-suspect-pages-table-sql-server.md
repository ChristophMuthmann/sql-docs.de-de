---
title: "Verwalten der suspect_pages-Tabelle (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/15/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "824 (Datenbankmodulfehler)"
  - "Wiederherstellen von Seiten [SQL Server]"
  - "Seiten [SQL Server], fehlerverdächtig"
...
-   Einen [Fehler vom Typ 823](../Topic/MSSQLSERVER_823.md), der durch eine vom Betriebssystem ausgegebene zyklische Redundanzprüfung (CRC) verursacht wurde, beispielsweise ein Datenträgerfehler (bestimmte Hardwarefehler).  
  
-   Einen [Fehler vom Typ 824](../Topic/MSSQLSERVER_824.md), z.B. eine zerrissene Seite (logische Fehler).  
