---
title: "Schrittweise Wiederherstellungen [SQL Server] | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Teilupdates [SQL Server]"
  - "Stufenweise Wiederherstellungen [SQL Server]"
  - "Schrittweise Wiederherstellungen [SQL Server]"
  - "Wiederherstellen [SQL Server], Schritt-für-Schritt-Wiederherstellungsszenario"
...
## Schrittweise Wiederherstellung mit dem einfachen Wiederherstellungsmodell  
...
### Anforderungen bei der schrittweisen Wiederherstellung mit dem einfachen Wiederherstellungsmodell  
...
### Phasen der schrittweisen Wiederherstellung (einfaches Wiederherstellungsmodell)  
...
## Schrittweise Wiederherstellung mit dem vollständigen Wiederherstellungsmodell  
...
## Ausführen einer schrittweisen Wiederherstellung einer Datenbank, deren Wiederherstellungsmodell von einfach in vollständig geändert wurde  
