...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Dieser Abschnitt enthält Referenzinformationen zu den folgenden SQL Server Express LocalDB-Fehlermeldungen:  
