---
title: "Rollen auf Datenbankebene | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "12/16/2016"
...
helpviewer_keywords: 
  - "db_denydatareader-Rolle"
  - "Benutzer [SQL Server], Datenbankrollen"
  - "Rollen auf Datenbankebene [SQL Server]"
  - "db_denydatawriter-Rolle"
  - "Rollen [SQL Server], Datenbank-"
  - "Prinzipale [SQL Server], Datenbankebene"
  - "db_backupoperator-Rolle"
  - "Anmeldeinformationen [SQL Server], Rollen"
  - "db_accessadmin-Rolle"
  - "Schemas [SQL Server], Rollen"
  - "Berechtigungen [SQL Server], Rollen"
  - "Datenbankrollen [SQL Server], aufgelistete"
  - "db_datareader-Rolle"
  - "db_ddladmin-Rolle"
  - "db_datawriter-Rolle"
  - "db_securityadmin-Rolle"
  - "db_owner-Rolle"
  - "Datenbankrollen [SQL Server]"
  - "Feste Datenbankrollen [SQL Server]"
  - "Authentifizierung [SQL Server], Rollen"
  - "Gruppen [SQL Server], Rollen"
...
## <a name="special-roles-for-includesssdsmdtokensssdsmdmd-and-includesssdwmdtokensssdwmdmd"></a>Besondere Rollen für [!INCLUDE[ssSDS_md](../../../includes/sssds-md.md)] und [!INCLUDE[ssSDW_md](../../../includes/sssdw-md.md)]
