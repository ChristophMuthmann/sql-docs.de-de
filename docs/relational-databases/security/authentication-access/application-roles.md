---
title: "Anwendungsrollen | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Anwendungsrollen [SQL Server], Informationen zu Anwendungsrollen"
  - "Prinzipale [SQL Server], Anwendungsrollen"
  - "Anmeldeinformationen [SQL Server], Rollen"
  - "Anwendungsrollen [SQL Server]"
  - "Rollen [SQL Server], Anwendung"
  - "Berechtigungen [SQL Server], Rollen"
  - "Benutzer [SQL Server], Anwendungsrollen"
