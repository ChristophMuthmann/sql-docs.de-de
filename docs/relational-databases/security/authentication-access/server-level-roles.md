---
title: "Rollen auf Serverebene | Microsoft Docs"
ms.custom: ""
ms.date: "12/29/2016"
...
helpviewer_keywords: 
  - "Rollen [SQL Server], Serverebene"
  - "Prinzipale [SQL Server], Serverebene"
  - "CONTROL SERVER-Berechtigung"
  - "Feste Serverrollen [SQL Server]"
  - "Anmeldeinformationen [SQL Server], Rollen"
  - "Feste Serverrolle sysadmin"
  - "Rollen auf Serverebene [SQL Server]"
...
## Berechtigungen fester Serverrollen  
 Jede feste Serverrolle besitzt bestimmte Berechtigungen. Eine Übersicht der Berechtigungen, die Serverrollen zugewiesen sind, finden Sie unter [Feste Serverrollen und feste Datenbankrollen des Datenbankmoduls](http://social.technet.microsoft.com/wiki/contents/articles/2024.database-engine-fixed-server-and-fixed-database-roles.aspx).  
