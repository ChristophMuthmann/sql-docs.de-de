---
title: "Erste Schritte mit Berechtigungen f&#252;r das Datenbankmodul | Microsoft Docs"
ms.custom: ""
ms.date: "01/03/2017"
...
helpviewer_keywords: 
  - "Berechtigungen [SQL Server], erste Schritte"
...
#### In Active Directory oder Azure Active Directory:  
...
>  Ein häufiger Fehler ist der Versuch, `GRANT` über `DENY` anstatt über `REVOKE` zu entfernen. Dies kann Probleme verursachen, wenn ein Benutzer Berechtigungen aus mehreren Quellen empfängt, was recht häufig vorkommt. Das folgende Beispiel veranschaulicht das Prinzip.  
 ...
 Die Gruppe „Sales“ erhält `SELECT`-Berechtigungen für die Tabelle „OrderStatus“ über die Anweisung `GRANT SELECT ON OBJECT::OrderStatus TO Sales;`. Der Benutzer Ted ist Mitglied der Rolle „Sales“. Über die Anweisung `GRANT SELECT ON OBJECT::OrderStatus TO Ted;` wurde Ted auch die Berechtigung `SELECT` für die Tabelle „OrderStatus“ unter seinem eigenen Benutzernamen erteilt. Angenommen, der Administrator möchte die Berechtigung `GRANT` aus der Rolle „Sales“ entfernen.  
  
-   Wenn der Administrator `REVOKE SELECT ON OBJECT::OrderStatus TO Sales;` ordnungsgemäß ausführt, behält Ted über seine individuelle `GRANT`-Anweisung `SELECT`-Zugriff auf die Tabelle „OrderStatus“.  
...
## Liste der Berechtigungen  
 ...
 Eine Grafik mit den Beziehungen zwischen den [!INCLUDE[ssDE](../../../includes/ssde-md.md)]-Prinzipalen- und Serverdatenbank-Objekten finden Sie unter [Berechtigungshierarchie &#40;Datenbankmodul&#41;](../../../relational-databases/security/permissions-hierarchy-database-engine.md).  
...
-   Weitere sicherheitsbezogene Sichten finden Sie unter [Sicherheitskatalogsichten&#40;Transact-SQL&#41;](../../../relational-databases/system-catalog-views/security-catalog-views-transact-sql.md).  
...
-   [Lernprogramm: Erste Schritte mit dem Datenbankmodul](../../../relational-databases/tutorial-getting-started-with-the-database-engine.md) [Erstellen einer Datenbank &#40;Lernprogramm&#41;](../../../t-sql/creating-a-database-tutorial.md)  
