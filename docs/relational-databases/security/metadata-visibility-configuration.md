---
title: "Konfigurieren der Sichtbarkeit von Metadaten | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Unterkomponentensichtbarkeit [SQL Server]"
  - "Metadaten [SQL Server], Sichtbarkeit"
  - "Berechtigungen [SQL Server], Metadatenzugriff"
  - "Anzeigen von Metadaten"
  - "Objekte [SQL Server], Metadaten"
  - "Anzeigen von Metadaten"
  - "Datenbankmetadaten [SQL Server]"
  - "Metadaten [SQL Server], Berechtigungen"
...
|||  
|-|-|  
|Katalogsichten|[!INCLUDE[ssDE](../../includes/ssde-md.md)] Gespeicherte **sp_help**-Prozeduren|  
...
|Replikationssystemtabellen|Gespeicherte **sp_help**-Prozeduren für Replikations- und [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Agents|  
...
-   Die gespeicherten **sp_help**-Prozeduren des [!INCLUDE[ssDE](../../includes/ssde-md.md)] geben möglicherweise nur eine Teilmenge von Zeilen oder NULL zurück.  
...
## Siehe auch  
 ...
 [Kompatibilitätssichten &#40;Transact-SQL&#41;](../Topic/Compatibility%20Views%20\(Transact-SQL\).md)  
