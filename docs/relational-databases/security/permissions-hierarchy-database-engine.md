---
title: "Berechtigungshierarchie (Datenbankmodul) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2016"
...
helpviewer_keywords: 
  - "Sicherheit [SQL Server], Verweigern des Zugriffs"
  - "Hierarchien [SQL Server], Berechtigungen"
  - "Sicherungsfähige Elemente [SQL Server]"
  - "Sicherheit [SQL Server], Berechtigungen"
  - "Berechtigungen [SQL Server], Hierarchie"
  - "Sicherheit [SQL Server], Erteilen des Zugriffs"
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
 ...
 ![Diagramm mit Datenbankmodul-Berechtigungshierarchien](../../relational-databases/security/media/wj-security-layers.gif "Diagramm mit Datenbankmodul-Berechtigungshierarchien")  
