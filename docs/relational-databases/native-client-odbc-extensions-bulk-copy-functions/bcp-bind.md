 ...
 *eDataType*  
 ...
 Die folgende Tabelle enthält die gültigen enumerierte Datentypen und die entsprechenden ODBC C-Datentypen.
...
|SQLUNIQUEID|SQLGUID|  
|SQLVARIANT|*Beliebiger Datentypen mit Ausnahme:*<br />-Text<br />-Ntext<br />-Bild<br />-varchar(max)<br />-varbinary(max)<br />-nvarchar(max)<br />-   xml<br />-Zeitstempel|  
