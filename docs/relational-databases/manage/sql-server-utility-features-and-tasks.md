---
title: "Funktionen und Tasks im SQL Server-Hilfsprogramm | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server-Hilfsprogramm [SQL Server]"
  - "Steuerungspunkt für das Hilfsprogramm"
  - "Wachstumsrate des Hilfsprogramms"
  - "Multiserververwaltung"
  - "UCP"
  - "Multiserververwaltung [SQL Server]"
...
## Vorteile des SQL Server-Hilfsprogramms  
...
|Beschreibt, wie Fehler des SQL Server-Hilfsprogramms behoben werden.|[Problembehandlung beim SQL Server-Hilfsprogramm](../Topic/Troubleshoot%20the%20SQL%20Server%20Utility.md)|  
...
|Stellt Links zu UtilityExplorer-F1-Hilfethemen bereit.|[Hilfsprogramm-Explorer (F1-Hilfe)](../../relational-databases/manage/hilfsprogramm-explorer-f1-hilfe.md)|  
