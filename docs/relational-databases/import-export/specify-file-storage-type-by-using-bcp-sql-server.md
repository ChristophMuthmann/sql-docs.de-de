---
title: "Angeben des Dateispeichertyps mithilfe von bcp (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "bcp-Hilfsprogramm [SQL Server], Dateispeichertypen"
  - "Importieren von Daten, Dateispeichertypen"
  - "Systemeigene Datenformate [SQL Server]"
  - "Dateispeichertyp [SQL Server]"
  - "Datenformate [SQL Server], Dateispeichertypen"
