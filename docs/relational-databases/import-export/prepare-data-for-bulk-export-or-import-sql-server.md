---
title: "Vorbereiten von Daten f&#252;r den Massenexport oder -import (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Massenimport [SQL Server], planen"
  - "Massenimport [SQL Server], aus einer CSV-Datei"
  - "Datenformate [SQL Server], Planen von Vorgängen"
  - "CSV-Dateien [SQL Server]"
  - "Felder in Anführungszeichen in CSV-Dateien [SQL Server]"
