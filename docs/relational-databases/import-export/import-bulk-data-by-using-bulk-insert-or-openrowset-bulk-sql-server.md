---
title: "Importieren von Massendaten mithilfe von BULK INSERT oder OPENROWSET(BULK...) (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/26/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "BULK INSERT-Anweisung, Importieren von Daten aus einer Remotedatendatei"
  - "Massenimport [SQL Server], Methoden"
  - "Massenexport [SQL Server], Methoden"
  - "OPENROWSET-Funktion, BULK INSERT"
  - "Massenimport [SQL Server], Sicherheit"
  - "Massenrowsetanbieter [SQL Server]"
  - "Massenexport [SQL Server], BULK INSERT-Anweisung"
  - "Remotedatenzugriff [SQL Server], Massenimport"
  - "Massenimport [SQL Server], BULK INSERT-Anweisung"
  - "Massenexport-/-importvorgänge in Transact-SQL"
...
## Massenimport aus einer Remotedatendatei  
