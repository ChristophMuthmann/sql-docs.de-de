...
```  
 ...
 Damit ein Massenimport von Daten aus `myTestSkipCol2.dat` in die `myTestSkipCol` -Tabelle ausgeführt werden kann, muss `Col1` das erste Datenfeld der Formatdatei zugeordnet werden, `Col3` muss das zweite Feld zugeordnet werden. `Col2`wird ausgelassen.  
