...
## <a name="returns"></a>Rückgabewert  
 Die tatsächliche Länge der Parameterdaten in Byte. Es ist keine *n*-ten Parameter oder keine remote gespeicherte Prozedur vorhanden ist, wird-1 zurückgegeben. Wenn die *n*te Parameter NULL ist, wird 0 zurückgegeben.  
