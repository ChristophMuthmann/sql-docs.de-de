...
|map_  progress|**float**|Zeigt an wie der Status der reduzieren Sie einen Auftrag in Prozent, falls vorhanden|0-1 – multipliziert, um den Faktor 100 (abgeschlossen)|  
