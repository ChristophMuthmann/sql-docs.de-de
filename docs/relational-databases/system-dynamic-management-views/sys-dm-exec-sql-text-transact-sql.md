...
*sql_handle*  
Das SQL-Handle für den zu suchenden Batch. *sql_handle* is **varbinary(64)**. *Sql_handle* kann aus den folgenden dynamischen Verwaltungsobjekten abgerufen werden:  
