...
|**Instanzname**|**nvarchar(256)**|Name –*Server*/*Instanz*– einer Serverinstanz, die ein Replikat für die verfügbarkeitsgruppe hostet.|  
|**Knotenname**|**nvarchar(256)**|Der Name des WSFC-Clusterknotens.|  
