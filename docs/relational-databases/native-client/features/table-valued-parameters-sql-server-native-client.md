---
title: Tabellenwertparameter (SQL Server Native Client) | Microsoft Docs
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[SNAC_Deprecated](../../../includes/snac-deprecated.md)]
 ...
 Weitere Informationen zu Tabellenwertparametern und ODBC, finden Sie unter [Table-Valued Parameters &#40; ODBC &#41;](../../../relational-databases/native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).  
  
 Weitere Informationen zu Tabellenwertparametern und OLE DB, finden Sie unter [Table-Valued Parameters &#40; OLE DB &#41;](../../../relational-databases/native-client-ole-db-table-valued-parameters/table-valued-parameters-ole-db.md).  
