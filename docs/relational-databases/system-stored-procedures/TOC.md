...
# [Räumliche Indizes](spatial-index-stored-procedures-arguments-and-properties.md)  
...
# Temporale Tabellen
## [Temporale Tabelle - sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [Temporale Tabelle - sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# Dateimomentaufnahme-Sicherung
## [Momentaufnahmesicherung - sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [Momentaufnahmesicherung - sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
## [Gespeicherte PolyBase-Prozeduren - sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [Gespeicherte PolyBase-Prozeduren - "sp_polybase_leave_group" aus](polybase-stored-procedures-sp-polybase-leave-group.md)  
# FileStream und Filetable
## [FileStream- und FileTable - sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [FileStream- und FileTable - sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
...
## [sp_cdc_add_job](sys-sp-cdc-add-job-transact-sql.md)  
...
## [sp_cdc_get_captured_columns](sys-sp-cdc-get-captured-columns-transact-sql.md)  
## [sp_cdc_get_ddl_history](sys-sp-cdc-get-ddl-history-transact-sql.md)  
## [sp_cdc_help_change_data_capture](sys-sp-cdc-help-change-data-capture-transact-sql.md)  
## [sp_cdc_help_jobs](sys-sp-cdc-help-jobs-transact-sql.md)  
## [sp_cdc_scan](sys-sp-cdc-scan-transact-sql.md)  
## [Sys. sp_cdc_start_job](sys-sp-cdc-start-job-transact-sql.md)  
## [sp_cdc_stop_job](sys-sp-cdc-stop-job-transact-sql.md)  
...
## [Standardwert](sp-unbindefault-transact-sql.md)  
...
## [sysmail_add_profileaccount_sp](sysmail-add-principalprofile-sp-transact-sql.md)  
...
# [Datenbank-Wartungsplan](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
# [Firewall-Regeln (Azure SQL-Datenbank)](firewall-rules-stored-procedures-azure-sql-database.md)  
...
## [sp_fulltext_pendingchanges aus](sp-fulltext-pendingchanges-transact-sql.md)  
...
## [-Katalog](sp-help-fulltext-catalog-components-transact-sql.md)  
...
## [sp_backup_config_advanced](managed-backup-sp-backup-config-advanced-transact-sql.md)  
## [sp_backup_config_schedule](managed-backup-sp-backup-config-schedule-transact-sql.md)  
...
## [sp_create_snapshot](core-sp-create-snapshot-transact-sql.md)  
## [sp_update_data_source](core-sp-update-data-source-transact-sql.md)  
## [sp_add_collector_type](core-sp-add-collector-type-transact-sql.md)  
...
# [Sicherheit](security-stored-procedures-transact-sql.md)  
...
## [parameterverschlüsselung](sp-describe-parameter-encryption-transact-sql.md)  
...
# [SQL Datawarehouse](sql-data-warehouse-stored-procedures.md)  
...
## [sp_pdw_database_encryption aktiviert werden](sp-pdw-database-encryption-sql-data-warehouse.md)  
...
# [Erweiterte Stretch-Datenbank](stretch-database-extended-stored-procedures-transact-sql.md)  
...
## [ausgeführt werden kann](sp-dropdynamicsnapshot-job-transact-sql.md)  
