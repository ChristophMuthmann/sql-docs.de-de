...
Die folgenden Handbücher sind verfügbar: Allgemeine Konzepte erläutert, und gelten für alle Versionen von SQL Server, sofern nicht anders in das entsprechende Handbuch. 

[Handbuch zur Problembehandlung und Überwachung Always On-Verfügbarkeitsgruppen](http://msdn.microsoft.com/library/dn135328)  
[Indexentwurf Handbuch](../relational-databases/sql-server-index-design-guide.md)  
[Speicher – Architekturhandbuch](../relational-databases/memory-management-architecture-guide.md)  
[Handbuch zur Architektur von Seiten und Blöcken](../relational-databases/pages-and-extents-architecture-guide.md)  
[Nach der Migration Überprüfung und Optimization Guide](post-migration-validation-and-optimization-guide.md)  
