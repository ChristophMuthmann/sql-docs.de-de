...
|**Schlüssel**|**varbinary(816)**|Liste der Spalten-IDs der Spalten, aus denen der Indexschlüssel besteht.<br /><br /> Gibt NULL zurück.<br /><br /> Verwenden Sie zum Anzeigen der Indexschlüsselspalten [sys.sysindexkeys](../../relational-databases/system-compatibility-views/sys-sysindexkeys-transact-sql.md).|  
...
|**Zeilen**|**int**|Zeilenanzahl auf Datenebene auf Grundlage **Indid** = 0 und **Indid** = 1, und der Wert wird für wiederholt **Indid** > 1.|  
