---
title: "Kopieren von Datenbanken durch Sichern und Wiederherstellen | Microsoft Docs"
ms.custom: ""
ms.date: "07/15/2016"
...
helpviewer_keywords: 
  ...
  - "Wiederherstellen von Datenbanken [SQL Server], frühere Versionen von SQL Server"
  - "Datenbankwiederherstellung [SQL Server], Kopieren von Datenbanken"
  - "Wiederherstellen von Datenbanken [SQL Server], auf einer anderen Serverinstanz"
  - "Wiederherstellen [SQL Server], auf einer anderen Serverinstanz"
  - "Sichern von Datenbanken [SQL Server], Kopieren von Datenbanken"
  - "Datenbanksicherungen [SQL Server], Kopieren von Datenbanken"
...
-   Verschieben Sie die Katalogdateien während des Wiederherstellungsvorgangs an einen neuen Speicherort, indem Sie die WITH MOVE-Klausel in der RESTORE DATABASE-Anweisung verwenden. Weitere Informationen finden Sie unter [RESTORE &#40;Transact-SQL&#41;](../Topic/RESTORE%20\(Transact-SQL\).md).  
