---
title: "Verwalten von Metadaten beim Bereitstellen einer Datenbank auf einer anderen Serverinstanz (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Datenbankübergreifende Abfragen [SQL Server]"
  - "Anmeldungen [SQL Server], Neuerstellen auf einer anderen Serverinstanz"
  - "Trigger [SQL Server], DLL"
  - "Benutzerdefinierte Fehlermeldungen [SQL Server]"
  - "Berechtigungen [SQL Server], Metadatenzugriff"
  - "Volltextsuchmodul [SQL Server]"
  - "Metadaten [SQL Server], für andere Instanzen verfügbare Datenbanken"
  - "Aufträge [SQL Server-Agent], Neuerstellen auf einer anderen Serverinstanz"
  - "Failover [SQL Server], Verwalten von Metadaten"
  - "Ereignisbenachrichtigungen [SQL Server], Metadaten"
  - "Datenbankspiegelung [SQL Server], Metadaten"
  - "Startoptionen [SQL Server]"
  - "Wiederherstellen [SQL Server], auf einer anderen Serverinstanz"
  - "Verbindungsserver [SQL Server], Metadaten"
  - "WMI-Anbieter für Serverereignisse, Metadaten"
  - "Anfügen von Datenbanken [SQL Server]"
  - "Protokollversand [SQL Server], Metadaten"
  - "Verschlüsselung [SQL Server], Metadaten"
  - "Serverkonfiguration [SQL Server]"
  - "Verteilte Abfragen [SQL Server], Metadaten"
  - "Erweiterte gespeicherte Prozeduren [SQL Server], Metadaten"
  - "Anmeldeinformationen [SQL Server], Metadaten"
...
##  <a name="server_configuration_settings"></a> Serverkonfigurationseinstellungen  
...
##  <a name="database_ownership"></a> Datenbankbesitz  
...
##  <a name="user_defined_error_messages"></a> Benutzerdefinierte Fehlermeldungen  
 Benutzerdefinierte Fehlermeldungen sind in der [sys.messages](../Topic/sys.messages%20\(Transact-SQL\).md)-Katalogsicht enthalten. Diese Katalogsicht wird in der **master**-Datenbank gespeichert. Wenn eine Datenbankanwendung benutzerdefinierte Fehlermeldungen verwenden muss und die Datenbank auf einer anderen Serverinstanz bereitgestellt wird, können Sie mit [sp_addmessage](../../relational-databases/system-stored-procedures/sp-addmessage-transact-sql.md) diese Fehlermeldungen auf der Zielserverinstanz hinzufügen.  

  
##  <a name="event_notif_and_wmi_events"></a> Ereignisbenachrichtigungen und WMI-Ereignisse (Windows Management Instrumentation, Windows-Verwaltungsinstrumentation) auf Serverebene  
...
> **WICHTIG!** [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)] Verwenden Sie stattdessen die [CLR-Integration](../Topic/Common%20Language%20Runtime%20\(CLR\)%20Integration%20Overview.md).  
...
##  <a name="ifts_service_properties"></a> Eigenschaften des Volltextsuchmoduls für SQL Server  
...
##  <a name="startup_procedures"></a> Autostartprozeduren  
...
##  <a name="triggers"></a> Trigger (auf Serverebene)   
