---
title: "Verschieben von Systemdatenbanken | Microsoft Docs"
ms.custom: ""
ms.date: "08/26/2016"
...
helpviewer_keywords: 
  ...
  - "Datenbankdateien [SQL Server], verschieben"
  - "Datendateien [SQL Server], verschieben"
  - "tempdb-Datenbank [SQL Server], verschieben"
  - "Systemdatenbanken [SQL Server], verschieben"
  - "Geplante Datenträgerwartung [SQL Server]"
  - "Verschieben von Datenbanken"
  - "msdb-Datenbank [SQL Server], verschieben"
  - "Verschieben von Datenbankdateien"
  - "Datenbankdateien verschieben"
  - "Geplante Datenbankverschiebungen [SQL Server]"
  - "Masterdatenbank [SQL Server], verschieben"
  - "Modelldatenbank [SQL Server], verschieben"
  - "Ressourcendatenbank [SQL Server]"
...
1.  Überprüfen Sie mit der folgenden Abfrage, ob [!INCLUDE[ssSB](../../includes/sssb-md.md)] für die msdb-Datenbank aktiviert ist.  
    ...
    ```  
     ...
     Weitere Informationen zum Aktivieren von [!INCLUDE[ssSB](../../includes/sssb-md.md)] finden Sie unter [ALTER DATABASE &#40;Transact-SQL&#41;](../../t-sql/statements/alter-database-transact-sql.md).  
...
3.  Verwenden Sie für jede zu verschiebende Datei die **sqlcmd** -Befehle oder [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] , um die folgende Anweisung auszuführen:  
    ...
    ```  
     ...
     Weitere Informationen zum Verwenden des **sqlcmd**-Hilfsprogramms finden Sie unter [Verwenden des Hilfsprogramms „sqlcmd“](../../relational-databases/scripting/use-the-sqlcmd-utility.md).  
...
##  <a name="Resource"></a> Verschieben der Ressourcendatenbank  
 Der Speicherort der Ressourcendatenbank lautet „\<*Laufwerk*>:\Programme\Microsoft SQL Server\MSSQL\<Version>.\<*Instanzname*>\MSSQL\Binn\\“. Die Datenbank kann nicht verschoben werden.  
...
3.  Geben Sie im Dialogfeld **Fehlerprotokolle des SQL Server-Agents konfigurieren** den neuen Speicherort der Datei SQLAGENT.OUT an. Der Standardspeicherort ist „C:\Programme\Microsoft SQL Server\MSSQL\<Version>.<Instanzname>\MSSQL\Log\\.  
