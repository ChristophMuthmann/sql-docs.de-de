---
title: "Anf&#252;gen und Trennen von Datenbanken (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "Datenbanken [SQL Server], trennen"
  - "Datenbank trennen [SQL Server]"
  - "Datenbanken [SQL Server], anfügen"
  - "Entfernen von Datenbanken"
  - "Transaktionsprotokolle [SQL Server], trennen"
  - "Datenbanken [SQL Server], entfernen"
  - "Wiederherstellen [SQL Server], angefügte Datenbanken"
  - "Transaktionsprotokolle [SQL Server], anfügen"
  - "Differenzielle Sicherungen, nach dem Trennen"
  - "Verschieben von Datenbanken"
  - "Anfügen einer Datenbank [SQL Server]"
  - "Trennen von Datenbanken [SQL Server]"
  - "Differenzielle Basis [SQL Server]"
...
-   Eine Datenbankmomentaufnahme ist in der Datenbank vorhanden.  
     ...
     Bevor Sie die Datenbank trennen können, müssen Sie alle Momentaufnahmen löschen. Weitere Informationen finden Sie unter [Löschen einer Datenbank-Momentaufnahme &#40;Transact-SQL&#41;](../../relational-databases/databases/drop-a-database-snapshot-transact-sql.md).  
...
-   [Ändern von Metadaten beim Anfügen einer Datenbank](#Metadata)  
  
-   [Sichern, Wiederherstellen und Anfügen](#BnR)  
  
-   [Anfügen einer Datenbank an eine andere Serverinstanz](#OtherServerInstance)  
