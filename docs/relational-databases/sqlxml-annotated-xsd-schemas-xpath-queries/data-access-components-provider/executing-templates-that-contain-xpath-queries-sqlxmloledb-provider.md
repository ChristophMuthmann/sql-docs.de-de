...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Dieses Beispiel zeigt, wie Sie die folgenden SQLXMLOLEDB-Anbieter spezifischen Eigenschaften verwenden:  
