...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Im folgenden werden Sicherheitsrichtlinien zur Verwendung von SQLXML für den Datenzugriff.  
