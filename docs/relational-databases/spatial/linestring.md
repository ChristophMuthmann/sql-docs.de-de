...
ms.topic: "article"
helpviewer_keywords: 
  - "geometry-Untertyp LineString [SQL Server]"
...
## LineString-Instanzen  
 ...
 ![Beispiele von LineString-geometry-Instanzen](../../relational-databases/spatial/media/linestring.png "Beispiele von LineString-geometry-Instanzen")  
