---
title: "Erstellen von DML-Triggern | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Verschlüsselung [SQL Server], DML-Trigger"
  - "Verzögerte Namensauflösung, DML-Trigger"
  - "WITH ENCRYPTION-Klausel"
  - "IF UPDATE"
  - "SET-Anweisung, DML-Trigger"
  - "DML-Triggern, programmieren"
  - "Testen von Spaltenänderungen"
  - "Ergebnisse [SQL Server], DML-Trigger"
