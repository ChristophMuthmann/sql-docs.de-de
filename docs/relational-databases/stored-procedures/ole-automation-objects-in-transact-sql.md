---
title: "OLE-Automatisierungsobjekte in Transact-SQL | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Trigger [SQL Server], OLE-Automatisierung"
  - "Batches [SQL Server], OLE-Automatisierung"
  - "OLE-Automatisierung [SQL Server]"
  - "OLE-Automatisierung [SQLServer], Informationen zur OLE-Automatisierung"
