...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]In SMO kann statistische Informationen zur Verarbeitung von Abfragen in der Datenbank gesammelt werden mithilfe der <xref:Microsoft.SqlServer.Management.Smo.Statistic> Objekt.  
