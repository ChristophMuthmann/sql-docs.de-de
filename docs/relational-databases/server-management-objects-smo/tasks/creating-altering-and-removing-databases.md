...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]In SMO wird eine Datenbank durch dargestellt die <xref:Microsoft.SqlServer.Management.Smo.Database> Objekt.  
