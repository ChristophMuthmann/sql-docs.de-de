---
title: "Upgrade der Volltextsuche | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Volltextsuche [SQL Server], installieren"
  - "Migrieren von Volltextindizes [SQL Server]"
  - "Upgrade der Volltextsuche"
  - "Installieren der Volltextsuche"
  - "Volltextsuche [SQL Server], aktualisieren"
...
### Beispiel  
 Im folgenden Beispiel wird die MOVE-Klausel in der [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md)-Anweisung verwendet, um eine [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]-Datenbank mit dem Namen `ftdb1` wiederherzustellen. Die [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]-Datenbankdateien, -Protokolldateien und -Katalogdateien werden wie folgt an neue Speicherorte auf der [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]-Serverinstanz verschoben:  
