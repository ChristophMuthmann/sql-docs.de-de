...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Add Login to Server Role**-Ereignisklasse tritt immer dann auf, wenn ein Anmeldename zu einer festen Serverrolle hinzugefügt oder aus ihr entfernt wird. Diese Ereignisklasse wird für gespeicherte Prozeduren **sp_addsrvrolemember** und **sp_dropsrvrolemember** verwendet.  
