...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die „TM: Begin Tran Starting“-Ereignisklasse zeigt an, dass eine BEGIN TRANSACTION-Anforderung beginnt. Die Anforderung wird vom Client über die Schnittstelle für die Transaktionsverwaltung gesendet.  
