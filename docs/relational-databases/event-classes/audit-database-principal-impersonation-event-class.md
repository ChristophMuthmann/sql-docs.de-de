...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Database Principal Impersonation**-Ereignisklasse tritt auf, wenn innerhalb des Datenbankbereichs ein Identitätswechsel stattfindet, z.B. EXECUTE AS \<*Benutzer*> oder SETUSER.  
