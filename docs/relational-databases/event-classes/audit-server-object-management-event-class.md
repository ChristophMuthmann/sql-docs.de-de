...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Server Object Management**-Ereignisklasse tritt im Fall von CREATE, ALTER oder DROP für Serverobjekte ein.  
