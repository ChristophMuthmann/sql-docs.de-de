...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die Object:Created-Ereignisklasse gibt an, dass ein Objekt erstellt wurde, z.B. mit der CREATE INDEX-, CREATE TABLE- oder CREATE DATABASE-Anweisung.  
