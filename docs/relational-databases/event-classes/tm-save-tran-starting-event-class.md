...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Mit der Ereignisklasse „TM: Save Tran Starting“ wird der Beginn einer SAVE TRANSACTION-Anforderung angegeben. Die Anforderung wird vom Client über eine Schnittstelle zur Transaktionsverwaltung gesendet.  
