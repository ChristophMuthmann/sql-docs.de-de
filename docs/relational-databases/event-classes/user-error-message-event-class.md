...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die „User Error Message“-Ereignisklasse zeigt die Fehlermeldung an, die der Benutzer bei einem Fehler oder einer Ausnahme sieht. Der Text der Fehlermeldung wird im TextData-Feld angezeigt.  
