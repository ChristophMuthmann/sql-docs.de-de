...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die Object:Deleted-Ereignisklasse zeigt an, dass ein Objekt gelöscht wurde. Beispielsweise mit den Anweisungen DROP INDEX oder DROP TABLE. Mit dieser Ereignisklasse kann ermittelt werden, ob Objekte gelöscht werden, die häufig temporäre gespeicherte Prozeduren erstellen, z. B. durch ODBC-Anwendungen.  
