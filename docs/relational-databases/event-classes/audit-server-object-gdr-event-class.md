...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Server Object GDR**-Ereignisklasse tritt auf, wenn von einem Benutzer in Microsoft SQL Server die Anweisung GRANT, REVOKE oder DENY für eine Serverobjektberechtigung ausgegeben wird.  
