...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die Unprepare SQL-Ereignisklasse zeigt an, dass SqlClient, ODBC, OLE DB oder DB-Library eine vorbereitete [!INCLUDE[tsql](../../includes/tsql-md.md)]-Anweisung gelöscht hat.  
