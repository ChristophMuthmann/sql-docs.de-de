...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Schema Object Access**-Ereignisklasse tritt auf, wenn eine Objektberechtigung (wie SELECT) verwendet wird.  
