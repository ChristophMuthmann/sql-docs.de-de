...
[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Die SQL:FullTextQuery-Ereignisklasse tritt auf, wenn [!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] eine Volltextabfrage ausführt. Schließen Sie diese Ereignisklasse in Ablaufverfolgungen ein, die Probleme im Zusammenhang mit Volltextkatalogen überwachen.  
...
|Dauer|**bigint**|Der Zeitraum zum Ausführen der Volltextabfrage.|13|Nein|  
