...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Die Ereignisklasse **Audit Backup/Restore** tritt auf, wenn ein Sicherungs- oder Wiederherstellungsbefehl ausgegeben wird.  
