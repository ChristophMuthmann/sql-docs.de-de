...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Statement Permission**-Ereignisklasse tritt immer dann auf, wenn eine Anweisungsberechtigung (wie CREATE TABLE) verwendet wird.  
