...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Database Operation**-Ereignisklasse tritt bei Vorgängen in einer Datenbank wie CHECKPOINT oder SUBSCRIBE QUERY NOTIFICATION auf.  
