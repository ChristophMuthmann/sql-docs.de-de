...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Database Principal Management**-Ereignisklasse tritt auf, wenn Prinzipale, wie z.B. Benutzer, in einer Datenbank erstellt, geändert oder gelöscht werden.  
