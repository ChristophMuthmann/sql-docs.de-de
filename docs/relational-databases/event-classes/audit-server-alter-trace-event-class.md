...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Server Alter Trace**-Ereignisklasse tritt für alle Anweisungen auf, die auf die ALTER TRACE-Berechtigung überprüfen. Zu diesen Anweisungen gehören diejenigen, mit denen eine Ablaufverfolgung erstellt oder konfiguriert oder ein Filter für eine Ablaufverfolgung festgelegt wird.  
