...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die „TM: Rollback Tran Starting“-Ereignisklasse zeigt an, dass eine ROLLBACK TRANSACTION-Anforderung beginnt. Der Client sendet die Anforderung über die Schnittstelle zur Transaktionsverwaltung. Die EventSubClass-Spalte zeigt an, ob eine neue Transaktion nach dem Rollback der aktuellen Transaktion gestartet wird.  
