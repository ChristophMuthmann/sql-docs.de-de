...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die „RPC Output Parameter“-Ereignisklasse führt Ablaufverfolgungen für die Ausgabeparameterwerte von Remoteprozeduraufrufen (RPC, Remote Procedure Calls) nach deren Ausführung aus.  
