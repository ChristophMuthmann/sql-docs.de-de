...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Verwenden Sie die SQLTransaction-Ereignisklasse, um den Beginn und den Abschluss von Transaktionen zu überwachen, insbesondere beim Testen von Anwendungen, Triggern und gespeicherten Prozeduren.  
