...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Server Operation**-Ereignisklasse tritt auf, wenn Sicherheitsüberwachungsvorgänge, wie das Ändern von Einstellungen, von Ressourcen, des externen Zugriffs oder der Autorisierung, verwendet werden.  
