...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die EventLog-Ereignisklasse zeigt an, dass Ereignisse im [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows-Ereignisprotokoll protokolliert wurden.  
