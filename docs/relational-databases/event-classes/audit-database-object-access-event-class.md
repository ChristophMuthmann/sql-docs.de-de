...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit Database Object Access**-Ereignisklasse tritt auf, wenn auf Datenbankobjekte, z.B. Schemas, zugegriffen wird.  
