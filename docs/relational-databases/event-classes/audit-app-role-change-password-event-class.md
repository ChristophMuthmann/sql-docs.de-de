...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Die **Audit App Role Change Password** -Ereignisklasse tritt immer dann auf, wenn für eine Anwendungsrolle ein Kennwort geändert wird.  
