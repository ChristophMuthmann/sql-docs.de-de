---
title: "Filtern einer Ablaufverfolgung | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Filter [SQL Server], Ereignisse"
  - "Ereignisse [SQL Server], Filter"
  - "Filter [SQL Server]"
...
|Nicht wie|NOT LIKE|Die Ereignisablaufverfolgungsdaten dürfen nicht dem eingegebenen Text entsprechen. Mehrere Werte sind zulässig.|  
