---
title: "Zugreifen auf speicheroptimierte Tabellen mit interpretiertem Transact-SQL | Microsoft Docs"
ms.custom: ""
ms.date: "05/31/2016"
...
- Berichtsabfragen, die in der Regel Konstrukte verwenden, die in nativ kompilierten gespeicherten Prozeduren nicht verfügbar sind (z.B. *window*-Funktionen, die auch als [OVER](../Topic/OVER%20Clause%20\(Transact-SQL\).md)-Funktionen bezeichnet werden).  
...
Weitere Informationen zu Tabellenhinweisen finden Sie unter [Tabellenhinweise &#40;Transact-SQL&#41;](../Topic/Table%20Hints%20\(Transact-SQL\).md). Zur Unterstützung von [!INCLUDE[hek_2](../../includes/hek-2-md.md)] wurde SNAPSHOT hinzugefügt.  
...
- Legt Sie die Datenbankoption [MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md) auf ON fest.  
  
Ein Tabellenhinweis auf die Isolationsstufe ist bei speicheroptimierten Tabellen, auf die der Zugriff mit Abfragen im [Autocommitmodus](http://msdn.microsoft.com/de-de/c8de5b60-d147-492d-b601-2eeae8511d00) erfolgt, nicht erforderlich.  
