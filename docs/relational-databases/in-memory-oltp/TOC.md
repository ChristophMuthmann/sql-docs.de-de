...
## [Bewährte Vorgehensweisen für den Aufruf von nativ kompilierten gespeicherten Prozeduren](best-practices-for-calling-natively-compiled-stored-procedures.md)  
## [Überwachen der Leistung von nativ kompilierten gespeicherten Prozeduren](monitoring-performance-of-natively-compiled-stored-procedures.md)  
...
### [Implementieren eines CASE-Ausdrucks in einer nativ kompilierten gespeicherten Prozedur](implementing-a-case-expression-in-a-natively-compiled-stored-procedure.md)  
