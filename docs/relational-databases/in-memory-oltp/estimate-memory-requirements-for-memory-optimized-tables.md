---
title: "Sch&#228;tzen der Arbeitsspeicheranforderungen speicheroptimierter Tabellen | Microsoft Docs"
ms.custom: ""
ms.date: "12/02/2016"
...
###  <a name="a-namebkmkexampletablea-example-memory-optimized-table"></a><a name="bkmk_ExampleTable"></a> Beispiel für eine speicheroptimierte Tabelle  
...
###  <a name="a-namebkmkmemoryfortablea-memory-for-the-table"></a><a name="bkmk_MemoryForTable"></a> Arbeitsspeicher für die Tabelle  
...
###  <a name="a-namebkmkindexmeemorya-memory-for-indexes"></a><a name="bkmk_IndexMeemory"></a> Arbeitsspeicher für Indizes  
...
Informationen zur Funktionsweise von Hashindizes in speicheroptimierten [!INCLUDE[hek_2](../../includes/hek-2-md.md)]-Tabellen finden Sie unter [Hashindizes](../Topic/Hash%20Indexes.md).  
...
###  <a name="a-namebkmkmemoryforrowversionsa-memory-for-row-versioning"></a><a name="bkmk_MemoryForRowVersions"></a> Arbeitsspeicher für die Zeilenversionsverwaltung
...
###  <a name="a-namebkmktablevariablesa-memory-for-table-variables"></a><a name="bkmk_TableVariables"></a> Arbeitsspeicher für Tabellenvariablen
...
###  <a name="a-namebkmkmemoryforgrowtha-memory-for-growth"></a><a name="bkmk_MemoryForGrowth"></a> Arbeitsspeicher für zukünftiges Wachstum
