---
title: "Anleitung zur Abfrageverarbeitung f&#252;r speicheroptimierte Tabellen | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
```  
 ...
 ![Abfrageplan für einen Join datenträgerbasierter Tabellen.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-1.gif "Abfrageplan für einen Join datenträgerbasierter Tabellen.")  
...
```  
 ...
 ![Abfrageplan für einen Hashjoin datenträgerbasierter Tabellen.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-2.gif "Abfrageplan für einen Hashjoin datenträgerbasierter Tabellen.")  
...
## [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Abfrageverarbeitung für datenträgerbasierte Tabellen  
 ...
 ![Abfrageverarbeitungspipeline in SQL Server.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-3.gif "Abfrageverarbeitungspipeline in SQL Server.")  
...
## Interpretierter [!INCLUDE[tsql](../../includes/tsql-md.md)]-Zugriff auf speicheroptimierte Tabellen  
 ...
 ![Abfrageverarbeitungspipeline für interpretierte Transact-SQL.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-4.gif "Abfrageverarbeitungspipeline für interpretierte Transact-SQL.")  
...
```  
 ...
 ![Abfrageplan für den Join speicheroptimierter Tabellen.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-5.gif "Abfrageplan für den Join speicheroptimierter Tabellen.")  
...
||Systemintern kompiliert|Interpretiert|  
|-|-----------------------|-----------------|  
...
### Kompilierung und Abfrageverarbeitung  
 ...
 ![Systeminterne Kompilierung gespeicherter Prozeduren.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-6.gif "Systeminterne Kompilierung gespeicherter Prozeduren.")  
...
5.  Die generierte DLL wird in den Arbeitsspeicher geladen.  
 ...
 ![Ausführung systemintern kompilierter gespeicherten Prozeduren.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-7.gif "Ausführung systemintern kompilierter gespeicherten Prozeduren.")  
...
```  
 ...
 ![Spaltenstatistiken und Joins.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-9.gif "Spaltenstatistiken und Joins.")  
