...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] In diesem Thema wird erläutert, wie Sie die Leistung von nativ kompilierten gespeicherten Prozeduren überwachen können.  
