---
title: "Sortierung und Unicode-Unterst&#252;tzung | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Binäre Sortierungen [SQL Server]"
  - "Sortierungen auf Ausdrucksebene [SQL Server]"
  - "Windows-Sortierungen [SQL Server]"
  - "Globalisierung [SQL Server], Informationen zur Globalisierung"
  - "Ergänzende Zeichenunterstützung"
  - "Codepages [SQL Server], Informationen zu Codepages"
  - "Sortierungen [SQL Server], Informationen zu Sortierungen"
  - "Unicode [SQL Server], Sortierungen"
  - "Sortierungen auf Datenbankebene [SQL Server]"
  - "Leserichtung"
  - "Sortierungen auf Spaltenebene"
  - "Gebietsschemas [SQL Server], Informationen zu Gebietsschemas"
  - "Gebietsschemas [SQL Server]"
  - "Codepages [SQL Server]"
  - "SQL Server-Sortierungen"
  - "Sortierungen auf Serverebene [SQL Server]"
...
##  <a name="a-nametermsa-collation-terms"></a><a name="Terms"></a> Sortierungsbegriffe    
...
###  <a name="a-namecollationdefna-collation"></a><a name="Collation_Defn"></a>-Sortierung    
...
> -   Sie müssen Zeichendaten speichern, die mehrere Sprachen wiedergeben.    
 ...
 Die Datenbanksortierung wird für alle Metadaten in der Datenbank verwendet und ist der Standard für alle Zeichenfolgenspalten, temporären Objekte, Variablennamen und anderen in der Datenbank verwendeten Zeichenfolgen. Wenn Sie die Sortierung einer Benutzerdatenbank ändern, treten möglicherweise Sortierungskonflikte auf, wenn Abfragen in der Datenbank auf temporäre Tabellen zugreifen. Temporäre Tabellen werden immer in der Systemdatenbank **tempdb** gespeichert, die die Sortierung für die Instanz verwendet. Abfragen, die Zeichendaten aus der Benutzerdatenbank und **tempdb** vergleichen, schlagen möglicherweise fehl, wenn die Sortierungen einen Konflikt beim Auswerten der Zeichendaten verursachen. Sie können dieses Problem umgehen, wenn Sie die COLLATE-Klausel in der Abfrage angeben. Weitere Informationen finden Sie unter [COLLATE &#40;Transact-SQL&#41;](../Topic/COLLATE%20\(Transact-SQL\).md).    
...
###  <a name="a-namelocaledefna-locale"></a><a name="Locale_Defn"></a> Gebietsschema    
...
###  <a name="a-namecodepagedefna-code-page"></a><a name="Code_Page_Defn"></a> Codepage    
...
###  <a name="a-namesortorderdefna-sort-order"></a><a name="Sort_Order_Defn"></a> Sortierreihenfolge    
...
##  <a name="a-nameunicodedefna-unicode-support"></a><a name="Unicode_Defn"></a> Unicode-Unterstützung    
...
##  <a name="a-namesupplementarycharactersa-supplementary-characters"></a><a name="Supplementary_Characters"></a> Ergänzende Zeichen    
...
##  <a name="a-namegb18030a-gb18030-support"></a><a name="GB18030"></a> GB18030-Unterstützung    
...
##  <a name="a-namecomplexscripta-complex-script-support"></a><a name="Complex_script"></a> Unterstützung komplexer Skripts    
...
##  <a name="a-namejapanesecollationsa-japanese-collations-added-in--includesssqlv14mdtokensqlv14sssqlv14mdmd"></a><a name="Japanese_Collations"></a> Japanische Sortierungen, die in [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] hinzugekommen sind
...
##  <a name="a-namerelatedtasksa-related-tasks"></a><a name="Related_Tasks"></a> Verwandte Aufgaben    
...
##  <a name="a-namerelatedcontenta-related-content"></a><a name="Related_Content"></a>Verwandte Inhalte    
