---
title: "Kopieren von Spalten von einer Tabelle in eine andere Tabelle (Datenbankmodul) | Microsoft Docs"
ms.custom: ""
ms.date: "09/01/2016"
...
1.  Anhand von Transact-SQL-Anweisungen können Sie keine einzelnen Spalten aus einer Tabelle in eine andere vorhandene Tabelle kopieren. Mit SELECT INTO können Sie jedoch eine neue Tabelle in der Standarddateigruppe erstellen, und die Ergebniszeilen aus der Abfrage werden darin eingefügt. Weitere Informationen finden Sie unter [INTO-Klausel &#40;Transact-SQL&#41;](../Topic/INTO%20Clause%20\(Transact-SQL\).md).  
