---
title: "Prim&#228;rschl&#252;ssel- und Fremdschl&#252;sseleinschr&#228;nkungen | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "06/02/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Fremdschlüssel [SQL Server], kaskadierende referenzielle Integrität"
  - "FOREIGN KEY-Einschränkungen"
  - "Fremdschlüssel [SQL Server]"
  - "Fremdschlüssel [SQL Server], Informationen zu Fremdschlüsseleinschränkungen"
...
[!INCLUDE[tsql-appliesto-ss2016-all_md](../../includes/tsql-appliesto-ss2016-all-md.md)]
 ...
 [FOREIGN KEY-Einschränkungen](../../relational-databases/tables/primary-and-foreign-key-constraints.md#FKeys)  
...
##  <a name="PKeys"></a> PRIMARY KEY-Einschränkungen  
 ...
 ![Zusammengesetzte PRIMARY KEY-Einschränkung](../../relational-databases/tables/media/fund04.gif "Zusammengesetzte PRIMARY KEY-Einschränkung")  
...
|Beschreibt, wie Fremdschlüsselbeziehungen erstellt werden.|[Erstellen von Fremdschlüssel-Beziehungen](../../relational-databases/tables/erstellen-von-fremdschlüssel-beziehungen.md)|  
