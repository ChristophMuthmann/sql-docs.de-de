...
> [!NOTE]  
>  **FOR SYSTEM_TIME** filtert Zeilen mit einer Gültigkeitsdauer von null (0) (**SysStartTime** = **SysEndTime**).  
> Diese Zeilen werden generiert, wenn mehrere Updates für den gleichen Hauptschlüssel innerhalb der gleichen Transaktion ausgeführt werden.  
