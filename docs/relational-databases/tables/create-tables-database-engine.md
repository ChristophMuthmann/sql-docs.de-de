---
title: "Erstellen von Tabellen (Datenbankmodul) | Microsoft Docs"
ms.custom: ""
ms.date: "09/22/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Tabellenerstellung [SQL Server], Visual Database Tools"
...
---
# Erstellen von Tabellen (Datenbankmodul)
...
## Verwenden des Tabellen-Designers  
...
7.  Um Fremdschlüsselbeziehungen, CHECK-Einschränkungen oder Indizes zu erstellen, klicken Sie mit der rechten Maustaste in den Bereich des Tabellen-Designers und wählen ein Objekt aus der Liste aus, wie in der folgenden Abbildung veranschaulicht.  
     ...
     Weitere Informationen zu diesen Objekten finden Sie unter [Create Foreign Key Relationships](../../relational-databases/tables/erstellen-von-fremdschlüssel-beziehungen.md), [Create Check Constraints](../../relational-databases/tables/create-check-constraints.md) und [Indexes](../../relational-databases/indexes/indexes.md).  
