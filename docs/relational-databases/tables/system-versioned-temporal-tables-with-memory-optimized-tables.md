---
title: "Temporale Tabellen mit Systemversionsverwaltung und speicheroptimierten Tabellen | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "07/12/2016"
...
## Übersicht  
 ...
 Diese Architektur wird anhand des folgenden Diagramms veranschaulicht.![Temporal In-Memory Architecture](../../relational-databases/tables/media/temporal-in-memory-architecture.png "Temporal In-Memory Architecture")  
...
-   Sie können eine Datenleerung erzwingen, indem Sie [sp_xtp_flush_temporal_history](../Topic/sp_xtp_flush_temporal_history.md) aufrufen.  
...
## Der Datenleerungstask  
 ...
 Sie können eine Datenleerung erzwingen, indem Sie [sp_xtp_flush_temporal_history](../Topic/sp_xtp_flush_temporal_history.md) aufrufen und das Schema sowie den Tabellennamen angeben:   
