---
title: "Zwischenspeichern, Aktualisieren und Leistung des Replikationsmonitors | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "Cache [SQL Server], Replikation"
  - "Replikationsmonitor, Cache"
  - "Aktualisieren von Daten"
  - "Replikationsmonitor, aktualisieren"
...
## Aktualisieren der Benutzeroberfläche des Replikationsmonitors  
...
-   Alle Windows können manuell aktualisiert werden, durch Drücken von F5 oder durch Rechtsklick auf einen Knoten in der Struktur des Replikationsmonitors und auf **Aktualisieren**. Das manuelle Aktualisieren erzwingt eine Aktualisierung des Cache.  
  
 Weitere Informationen finden Sie unter [Daten aktualisieren im Replikationsmonitor](../../../relational-databases/replication/monitor/refresh-data-in-replication-monitor.md).  
