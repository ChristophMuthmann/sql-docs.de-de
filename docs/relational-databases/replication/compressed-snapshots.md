---
title: "Komprimierte Momentaufnahmen | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "Komprimierte Momentaufnahmen [SQL Server-Replikation]"
...
-   [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]: [Komprimieren Snapshotdateien & #40; SQL Server Management Studio & #41;](../../relational-databases/replication/publish/compress-snapshot-files-sql-server-management-studio.md)  
