---
title: "Identit&#228;t und Zugriffssteuerung (Replikation) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Zugriffssteuerung [SQL Server-Replikation]"
  - "Sicherheit [SQL Server-Replikation], Identität und Zugriffssteuerung"
  - "Authentifizierung [SQL Server-Replikation]"
  - "Identität [Replikation]"
...
# Identit&#228;t und Zugriffssteuerung (Replikation)
  Authentifizierung ist der Prozess, der eine Entität (in der Regel ein Computer in diesem Kontext), eine andere Entität, die so genannte überprüft, eine *principal*, (normalerweise ein anderer Computer oder Benutzer) ist, wer oder was sie vorgibt. Als Autorisierung wird der Vorgang bezeichnet, bei dem einem authentifizierten Prinzipal Zugriff auf Ressourcen gewährt wird, beispielsweise auf eine Datei in einem Dateisystem oder eine Tabelle in einer Datenbank.  
...
-   Agentsicherheit  
     ...
     Das Sicherheitsmodell des Replikations-Agents ermöglicht die präzise Steuerung der Konten, unter denen Replikations-Agents ausgeführt werden und Verbindungen herstellen. Ausführliche Informationen zum agentbezogenen Sicherheitsmodell finden Sie unter [Replication Agent Security Model](../../../relational-databases/replication/security/replication-agent-security-model.md). Informationen zum Festlegen von Anmeldungen und Kennwörtern für Agents finden Sie unter [Verwalten von Anmeldenamen und Kennwörtern bei der Replikation](../../../relational-databases/replication/security/manage-logins-and-passwords-in-replication.md).  
