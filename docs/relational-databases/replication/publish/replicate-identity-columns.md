---
title: "Replizieren von Identit&#228;tsspalten | Microsoft Docs"
ms.custom: ""
ms.date: "10/04/2016"
...
-   Keine. Diese Option sollte nur für die Rückwärtskompatibilität mit früheren [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] -Versionen verwendet werden. Bei Transaktionsveröffentlichungen ist die Option nur über die gespeicherte Prozedur verfügbar.  
 ...
 Eine Option für die identitätsbereichsverwaltung finden Sie unter [Identitätsspalten verwalten](../../../relational-databases/replication/publish/manage-identity-columns.md).  
...
## Zuweisen von Identitätsbereichen  
 ...
 Wenn der Verleger nach einer Einfügung seinen Identitätsbereich ausgeschöpft hat, es kann automatisch einen neuen Bereich zuweisen, wenn der Einfügevorgang, von einem Mitglied der ausgeführt wurde der **Db_owner** festen Datenbankrolle. Wenn der Einfügevorgang ausgeführt wurde, durch den Benutzer nicht in der Rolle, der Protokolllese-Agent, Merge-Agent oder ein Benutzer Mitglied ist von der **Db_owner** Rolle führen [Sp_adjustpublisheridentityrange &#40; Transact-SQL &#41;](../../../relational-databases/system-stored-procedures/sp-adjustpublisheridentityrange-transact-sql.md). Bei Transaktionsveröffentlichungen muss der Protokolllese-Agent ausgeführt werden, damit automatisch ein neuer Bereich zugeordnet wird (der Agent wird standardmäßig ununterbrochen ausgeführt).  
...
### Mergereplikation  
 Identitätsbereiche werden vom Verleger verwaltet und vom Merge-Agent an die Abonnenten weitergegeben (in einer Wiederveröffentlichungshierarchie werden die Bereiche vom Stammverleger und den Neuverlegern verwaltet). Die Identitätswerte werden auf dem Verleger aus einem Pool zugewiesen. Wenn Sie einen Artikel mit einer Identitätsspalte einer Veröffentlichung im Assistenten für neue Veröffentlichung oder mithilfe von hinzufügen [Sp_addmergearticle &#40; Transact-SQL &#41;](../../../relational-databases/system-stored-procedures/sp-addmergearticle-transact-sql.md), geben Sie Werte für:  
  
-   Die **@identity_range** -Parameter, der steuert, die Größe des Identitätsbereichs auf dem Verleger und Abonnenten mit Clientabonnements anfänglich zugeordnet.  
  
    > [!NOTE]  
    >  Bei Abonnenten mit früheren Versionen von [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], diesen Parameter (anstelle der **@pub_identity_range** Parameter) steuert auch die Größe des Identitätsbereichs auf den Wiederveröffentlichungsabonnenten.  
  
-   Die **@pub_identity_range** -Parameter, der Größe des Identitätsbereichs gesteuert, für Abonnenten mit serverabonnements (erforderlich für Wiederveröffentlichen von Daten) Wiederveröffentlichen zugewiesen werden. Alle Abonnenten mit Serverabonnenten erhalten einen Bereich zur Wiederveröffentlichung, auch wenn sie gar keine Daten erneut veröffentlichen.  
  
-   **@threshold** -Parameter: Mit diesem Parameter wird bestimmt, wann ein neuer Identitätsbereich für ein Abonnement von [!INCLUDE[ssEW](../../../includes/ssew-md.md)] oder eine frühere [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]-Version erforderlich ist.  
  
 Beispielsweise können Sie angeben, für 10.000 **@identity_range** und für 500.000 **@pub_identity_range**. Dem Verleger und allen Abonnenten, die [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] oder eine höhere Version ausführen, einschließlich des Abonnenten mit dem Serverabonnement, wird der Primärbereich 10.000 zugewiesen. Der Abonnent mit dem Serverabonnement wird zudem eine der primärbereich 500.000, die von Abonnenten verwendet werden kann, die Synchronisierung mit dem Wiederveröffentlichungsabonnenten zugewiesen (Sie müssen auch angeben, **@identity_range**, **@pub_identity_range**, und **@threshold** für die Artikel in der Veröffentlichung auf dem Wiederveröffentlichungsabonnenten).  
...
## Siehe auch  
 ...
 [IDENTITY &#40;Eigenschaft&#41; &#40;Transact-SQL&#41;](../Topic/IDENTITY%20\(Property\)%20\(Transact-SQL\).md)   
