---
title: "Replikations-Agent-Verwaltung | Microsoft Docs"
ms.custom: ""
ms.date: "08/24/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Snapshot-Agent, verwalten"
  - "Protokolllese-Agent, verwalten"
  - "Warteschlangenlese-Agent, verwalten"
  - "Freigegebene Agents [SQL Server-Replikation]"
  - "Merge-Agent, verwalten"
  - "Verteilungs-Agent, verwalten"
  - "Agents [SQL Server-Replikation], verwalten"
  - "Aufträge für das Replikationscleanup [SQL Server-Replikation]"
  - "Verwalten der Replikations, Agents"
  - "Replikation [SQL Server], verwalten"
  - "Unabhängige Agents [SQL Server-Replikation]"
...
|[Warteschlangenlese-Agent der Microsoft SQL Server-Replikation](../../../relational-databases/replication/agents/replication-queue-reader-agent.md)|qrdrsvc.exe|  
...
-   [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)] und Replikationsmonitor: [Starten und Beenden eines Replikations-Agents & #40; SQL Server Management Studio & #41;](../../../relational-databases/replication/agents/start-and-stop-a-replication-agent-sql-server-management-studio.md)  
  
-   Replikationsprogrammierung: [ausführbare Konzepte für Replikations-Agent](../../../relational-databases/replication/concepts/replication-agent-executables-concepts.md)  
...
## Agentprofile  
 ...
 Informationen zum Angeben von Befehlszeilenparametern direkt finden Sie unter [Replikations-Agent ausführbare Konzepte](../../../relational-databases/replication/concepts/replication-agent-executables-concepts.md).  
...
-   Die folgenden Agents sind Veröffentlichungen im Replikationsmonitor zugeordnet:  
    ...
    -   Warteschlangenlese-Agent  
     ...
     Auf die Informationen und Aufgaben zu diesen Agents können Sie über die Registerkarte **Agents** zugreifen. Weitere Informationen finden Sie unter [Anzeigen von Informationen und Ausführen von Aufgaben für die Agents verknüpft sind mit einer Publikation & #40; Der Replikationsmonitor & #41;](../../../relational-databases/replication/monitor/view information and perform tasks for publication agents.md).  
