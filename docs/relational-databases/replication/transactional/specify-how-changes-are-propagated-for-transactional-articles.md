---
title: "Angeben der Weitergabemethode f&#252;r &#196;nderungen bei Transaktionsartikeln | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
-   **Sp_MSdel_ \<** *Tablename* **>**, behandelt Löschvorgänge.  
 ...
 Die **\<***Tablename***>** verwendet die Prozedur abhängig ist, wie der Artikel der Publikation hinzugefügt wurde und ob die Abonnementdatenbank eine Tabelle mit dem gleichen Namen und einem anderen Besitzer enthält.  
...
-   Wenn Sie Schemaänderungen an einer veröffentlichten Tabelle vornehmen, müssen die benutzerdefinierten Prozeduren neu generiert werden. Weitere Informationen finden Sie unter [neu generieren benutzerdefinierter transaktionale Verfahren zum Schemaänderungen widerspiegeln](../../../relational-databases/replication/transactional/regenerate-custom-transactional-procedures-to-reflect-schema-changes.md).  
  
-   Wenn Sie einen Wert größer als 1 für **- SubscriptionStreams** -Parameter des Verteilungs-Agent verwenden, müssen Sie sicherstellen, dass Aktualisierungen an Primärschlüsselspalten erfolgreich sind. Beispiel:  
...
#### SCALL-Syntax  
 Gespeicherte Prozeduren zu UPDATE  
 Gespeicherte Prozeduren, die UPDATE-Anweisungen verarbeiten werden übergeben, wenn Sie die aktualisierten Werte nur für die Spalten, die geändert wurden, gefolgt von den ursprünglichen Werten der Primärschlüsselspalten, gefolgt von einer Bitmaske (**Binary (n)**), der die geänderten Spalten anzeigt. Im folgenden Beispiel wurde die Spalte 2 (c2) nicht geändert:  
...
#### MCALL-Syntax  
 Gespeicherte Prozeduren zu UPDATE  
 Gespeicherte Prozeduren, die UPDATE-Anweisungen verarbeiten werden übergeben, wenn Sie die aktualisierten Werte für alle Spalten, die in dem Artikel, gefolgt von den ursprünglichen Werten der Primärschlüsselspalten, gefolgt von einer Bitmaske definierten (**Binary (n)**), der die geänderten Spalten anzeigt:  
...
> [!NOTE]  
>  Bei Verwendung von XCALL die anfangsimagewerte für **Text** und **Image** Spalten sollten NULL sein.  
