---
title: "Ermitteln und L&#246;sen von Konflikten in logischen Datens&#228;tzen | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Konflikterkennung  
 Die Möglichkeit, in denen Konflikte bei logischen Datensätzen, wird durch zwei Eigenschaften bestimmt: **Column_tracking** und **Logical_record_level_conflict_detection**. [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] und höhere Versionen unterstützen ebenfalls die Erkennung der logischen Datensatzebene.  
  
 Die **Logical_record_level_conflict_detection** -Artikeleigenschaft kann TRUE oder FALSE festgelegt werden. Der Wert sollte nur für den übergeordneten Artikel auf der obersten Ebene festgelegt werden. Von den untergeordneten Artikeln wird er ignoriert. Wenn dieser Wert FALSE ist, erkennt die Mergereplikation wie in vorherigen Versionen von [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], ausschließlich auf Basis des Werts von der **Column_tracking** Eigenschaft für den Artikel. Die Mergereplikation wird ignoriert, wenn dieser Wert TRUE ist, die **Column_tracking** Eigenschaft für den Artikel und ermittelt einen Konflikt, wenn Änderungen an einer beliebigen Stelle im logischen Datensatz vorgenommen werden. Stellen Sie sich z. B. das folgende Szenario vor:  
...
-   **Column_tracking** true oder FALSE  
  
-   **Logical_record_level_conflict_detection** ist "false"  
  
-   **Logical_record_level_conflict_resolution** ist "false"  
...
-   **Logical_record_level_conflict_resolution** true  
 ...
 Ein Verleger und ein Abonnent beginnen mit demselben Datensatz. Der Verleger ändert die **custcol1** -Spalte in der **customers** -Tabelle. Der Abonnent ändert die **ordercol1** -Spalte in der **orders** -Tabelle. Es sind keine Änderungen an identischen Zeilen oder Spalten, aber da die Änderungen im selben logischen Datensatz für **Custid**= 1, die Änderungen werden auf der logischen Datensatzebene erkannt.  
