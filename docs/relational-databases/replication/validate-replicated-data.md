---
title: "&#220;berpr&#252;fen von replizierten Daten | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Inlinedatenüberprüfung [SQL Server-Replikation]"
  - "Verwalten der Replikation, Überprüfen von Daten"
  - "Replikation [SQL Server], Überprüfen von Daten"
  - "Transaktionsreplikation, Überprüfen von Daten"
  - "Überprüfen von Daten"
  - "Überprüfen von Daten der Mergereplikation [SQL Server-Replikation]"
  - "Überprüfen von Daten der Mergereplikation [SQL Server-Replikation], Informationen zur Datenüberprüfung"
...
-   Zeilenanzahl und binäre Prüfsumme. Bei dieser Form der Überprüfung wird zusätzlich zum Vergleich der Zeilenanzahl auf dem Verleger und dem Abonnenten mithilfe des Prüfsummenalgorithmus eine Prüfsumme aller Daten berechnet. Ist die Zeilenanzahl fehlerhaft, wird die Berechnung der Prüfsumme nicht ausgeführt.  
 ...
 Bei der Mergereplikation kann außer der Übereinstimmung der Daten auf dem Abonnenten und dem Verleger auch überprüft werden, ob die Daten auf den einzelnen Abonnenten richtig partitioniert sind. Weitere Informationen finden Sie unter [Überprüfen von Partitionsinformationen für einen Abonnenten Merge](../../relational-databases/replication/validate-partition-information-for-a-merge-subscriber.md).  
...
-   Konfigurieren Sie die Replikationswarnung **Replikation: Fehler bei der Datenüberprüfung auf dem Abonnenten** , damit Sie bei einem negativen Überprüfungsergebnis benachrichtigt werden. Weitere Informationen finden Sie unter [vordefinierte Replikationswarnungen konfigurieren & #40; SQL Server Management Studio & #41;](../../relational-databases/replication/administration/configure-predefined-replication-alerts-sql-server-management-studio.md).  
...
-   Ist ein negatives Überprüfungsergebnis ein Problem für Ihre Anwendung? Falls ja, aktualisieren Sie die Daten manuell, damit sie synchronisiert sind, oder initialisieren Sie das Abonnement erneut:  
    ...
    -   Daten können mit dem [Hilfsprogramm "tablediff"](../../tools/tablediff-utility.md)aktualisiert werden. Weitere Informationen zum Verwenden dieses Hilfsprogramms finden Sie unter [Vergleichen replizierten Tabellen für Unterschiede & #40; Replikationsprogrammierung & #41;](../../relational-databases/replication/administration/compare-replicated-tables-for-differences-replication-programming.md).  
  
    -   Weitere Informationen zum erneuten Initialisieren finden Sie unter [Abonnements erneut initialisieren](../../relational-databases/replication/reinitialize-subscriptions.md).  
...
-   Überprüfung der Replikation verwendet die **Prüfsumme** und **Binary_checksum** Funktionen. Informationen zum Verhalten finden Sie unter  [PRÜFSUMME & #40; Transact-SQL & #41;](../../t-sql/functions/checksum-transact-sql.md) und [BINARY_CHECKSUM & #40; Transact-SQL & #41;](../../t-sql/functions/binary-checksum-transact-sql.md).  
