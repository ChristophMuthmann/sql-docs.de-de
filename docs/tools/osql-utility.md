...
helpviewer_keywords: 
  ...
  - "EXIT-Befehl"
  - "Betriebssystem [SQL Server], Befehle"
  - "osql (Hilfsprogramm) [SQL Server]"
  - "gespeicherte Prozeduren [SQL Server], Eingabeaufforderung"
  - "Skripts [SQL Server], Eingabeaufforderung"
  - "RESET-Befehl"
  - "GO-Befehl"
  - "Eingabeaufforderungs-Hilfsprogramme [SQL Server], osql"
  - "CTRL+C (Befehl)"
...
## Einfügen von Kommentaren  
 Sie können Kommentare in eine Transact-SQL-Anweisung einschließen, die von **osql** an [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] gesendet wird. Für Kommentare sind die beiden folgenden Formate zulässig: -- und /*...\*/.  
