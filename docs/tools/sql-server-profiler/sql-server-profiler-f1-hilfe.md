---
title: "SQL Server Profiler (F1-Hilfe) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], Hilfe"
  - "SQL Server Profiler,Hilfe"
  - "Ablaufverfolgungseigenschaften (Dialogfeld)"
  - "Eigenschaften der Ablaufverfolgungsvorlage (Dialogfeld)"
  - "Eigenschaften von Ablaufverfolgungsdateien (Dialogfeld)"
  - "Beschränken der Leistungsindikatoren (Dialogfeld)"
  - "Allgemeine Optionen (Dialogfeld)"
  - "Arbeitsauslastungstabelle auswählen (Dialogfeld)"
  - "Zieltabelle (Dialogfeld)"
  - "Wiedergabekonfiguration (Dialogfeld)"
  - "Suchen (Dialogfeld)"
...
# SQL Server Profiler (F1-Hilfe)
 ...
 ## Ablaufverfolgungseigenschaften (Allgemein)
 ...
 **Beendigungszeit für Ablaufverfolgung aktivieren**  
 Legt das Datum und die Uhrzeit für das Ende und das Schließen der Ablaufverfolgung fest. Mithilfe der Registerkarte **Ereignisauswahl** im Dialogfeld **Ablaufverfolgungseigenschaften** können Sie die Ablaufverfolgung von Ereignissen oder Datenspalten anzeigen und angeben.  
  
 ## Ablaufverfolgungseigenschaften (Registerkarte 'Ereignisauswahl')
...
## Eigenschaften der Ablaufverfolgungsvorlage (Registerkarte Allgemein)
...
## Bearbeiten der Eigenschaften der Ablaufverfolgungsvorlage (Registerkarte Allgemein)
 ...
 **Als Standardvorlage für den ausgewählten Servertyp verwenden**  
 ...
 ## Eigenschaften der Ablaufverfolgungsvorlage (Registerkarte Ereignisauswahl)
 ...
 **Spalten organisieren**  
 ...
 ## Eigenschaften der Ablaufverfolgungsdatei (Registerkarte Allgemein) 
 ...
 **Geändert**  
 ...
 ## Eigenschaften der Ablaufverfolgungsdatei (Registerkarte Ereignisauswahl)
 ...
 **Spalten organisieren**  
 ...
 ## Eigenschaften der Ablaufverfolgungstabelle (Registerkarte Ereignisauswahl)
 ...
 **Spalten organisieren**  
 Klicken Sie nach der Auswahl der zu verfolgenden **Ereignisse** und Datenspalten auf **Spalten organisieren**, um eine Reorganisation der Spalten im Raster des Fensters mit den Ablaufverfolgungsergebnissen zu erzwingen.  
  ...
  ## SQL Server Profiler - Beschränken der Leistungsindikatoren
...
### So wählen Sie Leistungsobjekte und -indikatoren aus, die mit einer Ablaufverfolgung korreliert werden sollen  
...
2.  Aktivieren Sie die Indikatoren, die mit der [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] -Ablaufverfolgungsdatei korreliert werden sollen.  
 ...
 ## SQL Server Profiler - Extras/Optionen (Seite Allgemeine Optionen)
...
> **HINWEIS:** Wenn Sie dieses Kontrollkästchen umschalten, wird das Anzeigeformat der Zeitspalten, z. B. **StartTime** und **EndTime**, geändert. Nicht geändert werden jedoch die **DateTime**-Wertparameter in den Sprachereignissen oder den Remoteprozeduraufrufen (Remote Procedure Calls, RPCs).  
 ...
 **Standardabrufintervall für Systemüberwachung (Sek.)**  
 ...
 ## SQL Server Profiler – Quelltabelle/Datenbankmodul-Optimierungsratgeber – Arbeitsauslastungstabelle auswählen
...
#### enthalten  
 **SQL Server**  
 Gibt die Instanz von SQL Server an, mit der aktuell eine Verbindung besteht. Dieses Feld wird automatisch ausgefüllt und kann nicht aktualisiert werden.  
 ...
 **Table**  
 ...
 ## SQL Server Profiler - Zieltabelle
 ...
 **Tabelle**  
 ...
 ## SQL Server Profiler-Wiedergabekonfiguration (Grundlegende Wiedergabeoptionen)
 ...
 **Wiedergabeergebnisse anzeigen**  
 ...
 ## SQL Server Profiler - Wiedergabekonfiguration (Erweiterte Wiedergabeoptionen)
 ...
 **Wartezeit für die Überwachung blockierter Prozesse (Sek.)**  
 ...
 ## SQL Server Profiler - Suchen (Dialogfeld)
 ...
 **Suchen in Spalte**  
 Klicken Sie auf eine zu durchsuchende Datenspalte, oder klicken Sie auf **\<Alle Spalten>**, um alle Datenspalten in der Ablaufverfolgung zu durchsuchen.  
 ...
 **Vorheriges suchen**  
 ...
 ## SQL Server Profiler - Spalten organisieren
 ...
 **Nach unten**  
 ...
 ## SQL Server Profiler - Filter bearbeiten
...
> **HINWEIS:** Für Spalten mit Zeichenfolgendaten werden die Filterkriterien als ein LIKE- oder NOT LIKE-Zeichenfolgenwert angezeigt.  
