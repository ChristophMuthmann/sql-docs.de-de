---
title: "Organisieren von in einer Ablaufverfolgung angezeigten Spalten (SQL Server Profiler) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Organisieren angezeigter Ablaufverfolgungsspalten [SQL Server]"
  - "Anordnen angezeigter Ablaufverfolgungsspalten"
...
|EventClass|StartTime|Dauer|ClientProcessID|  
|----------------|---------------|--------------|---------------------|  
...
### So gruppieren Sie in einer Ablaufverfolgung angezeigte Datenspalten  
...
### So gruppieren und aggregieren Sie Datenspalten in einer Ablaufverfolgung  
