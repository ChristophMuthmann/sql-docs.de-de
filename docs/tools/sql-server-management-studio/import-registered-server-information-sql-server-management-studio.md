...
helpviewer_keywords: 
  ...
  - "Registrierte Server [SQL Server], importieren"
  - "Importieren von Informationen zu registrierten Servern"
...
---
# Importieren von Informationen zum registrierten Server (SQL Server Management Studio)
...
#### So importieren Sie Informationen zum registrierten Server  
