---
title: "Starten von SQL Server Management Studio | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Anzeigen zusätzlicher Fenster  
  
#### So zeigen Sie das Fenster "Registrierte Server" an  
...
[Herstellen einer Verbindung mit registrierten Servern und dem Objekt-Explorer](../../tools/sql-server-management-studio/connect-with-registered-servers-and-object-explorer.md)  
