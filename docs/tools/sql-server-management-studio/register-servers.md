---
title: "Registrieren von Servern | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Verbindungen [SQL Server], registrierte Server"
  - "Registrieren von Servern"
  - "Server [SQL Server], registrieren"
  - "Serververwaltung [SQL Server], Registrieren von Servern"
  - "Serverregistrierung [SQL Server]"
...
## Vorteile von registrierten Servern  
