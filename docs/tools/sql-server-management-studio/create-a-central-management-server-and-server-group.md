...
#### Erstellen eines zentralen Verwaltungsservers  
...
5.  Prüfen oder ändern Sie auf der Registerkarte **Verbindungseigenschaften** die Netzwerk- und Verbindungseigenschaften. Weitere Informationen finden Sie unter [Verbinden mit SQL Server-Datenbankmodul &#40;Eigenschaftenseite Verbindung&#41;](../../ssms/f1-help/connect-to-server-connection-properties-page-database-engine.md).  
...
#### Erstellen einer neuen Servergruppe und Hinzufügen von Servern zur Gruppe  
...
#### So führen Sie Abfragen für mehrere Konfigurationsziele gleichzeitig aus  
