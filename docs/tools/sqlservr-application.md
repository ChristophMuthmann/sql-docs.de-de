...
ms.topic: "article"
helpviewer_keywords: 
  - "Eingabeaufforderungs-Hilfsprogramme [SQL Server], sqlservr"
  - "Eingabeaufforderung [SQL Server], Anhalten/Fortsetzen einer SQL Server-Instanz"
  - "Starten einer Instanz von SQL Server"
  - "Eingabeaufforderung [SQL Server], fortlaufende Instanz von SQL Server"
  - "sqlservr (Hilfsprogramm)"
  - "Anhalten einer Instanz von SQL Server"
  - "Beenden einer Instanz von SQL Server"
  - "Fortsetzen einer Instanz von SQL Server"
  - "Eingabeaufforderung [SQL Server], Beenden einer Instanz von SQL Server"
  - "Eingabeaufforderung [SQL Server], Starten einer Instanz von SQL Server"
  - "Fortlaufende Instanz von SQL Server"
