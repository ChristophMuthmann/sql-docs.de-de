...
[Starten des Befehlzeilenprogramms dta und Optimieren einer Arbeitsauslastung](../../tools/dta/starting-the-dta-command-prompt-utility-and-tuning-a-workload.md)  
