...
ms.topic: "article"
helpviewer_keywords: 
  - "Physische Entwurfsstrukturen [SQL Server]"
  - "Eingabeaufforderungs-Hilfsprogramme [SQL Server], DTA"
  - "dta (Hilfsprogramm)"
  - "Optimierung von Datenbanken [SQL Server], Datenbankoptimierungsratgeber"
  - "Arbeitsauslastungen [SQL Server], Analysieren"
  - "Hilfsprogramm dta, Informationen zum Hilfsprogramm dta"
  - "Leistung [SQL Server], Datenbankoptimierungsratgeber"
  - "Datenbankoptimierungsratgeber [SQL Server], Eingabeaufforderung"
...
|Wert|Beschreibung|  
|-----------|-----------------|  
|NONE|Keine vorhandenen Strukturen|  
