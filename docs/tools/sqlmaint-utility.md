...
ms.topic: "article"
helpviewer_keywords: 
  - "Datenbank-Wartungspläne [SQL Server]"
  - "sqlmaint (Hilfsprogramm)"
  - "Warten von Datenbanken [SQL Server]"
  - "Sicherungen [SQL Server], sqlmaint-Hilfsprogramm"
  - "Eingabeaufforderungs-Hilfsprogramme [SQL Server], sqlmaint"
  - "Wartungspläne [SQL Server], Eingabeaufforderung"
  - "Sichern [SQL Server], sqlmaint-Hilfsprogramm"
 ...
 **-DelBkUps**\< *Zeitraum* >  
 Gibt bei Datenträgersicherungen an, dass jede Sicherungsdatei im Sicherungsverzeichnis gelöscht werden soll, wenn das Zeitintervall nach Erstellen der Sicherungsdatei den Wert für \<*Zeitraum*> überschreitet.  
...
### C. Sichern aller Datenbanken in einem Plan in ihre jeweiligen Unterverzeichnissen im Standardverzeichnis „x:\Programme\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\Backup“. Weiterhin: Löschen aller Sicherungen, die älter als 2 Wochen sind  
  
```  
sqlmaint -S MyServer -PlanName MyUserDBPlan -BkUpDB -BkUpMedia DISK -UseDefDir -CrBkSubDir -DelBkUps 2weeks  
```  
  
### D. Sichern einer Datenbank in das Standardverzeichnis „x:\Programme\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\Backup“.  
