---
title: "Importieren von Werten aus einer Excel-Datei in eine Dom&#228;ne | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
###  <a name="Prerequisites"></a> Erforderliche Komponenten  
 Um Domänen aus einer Excel-Datei importieren, muss Excel auf dem Computer installiert sein, die [!INCLUDE[ssDQSClient](../includes/ssdqsclient-md.md)] Anwendung installiert ist, um Domänenwerte oder eine vollständige Domäne zu importieren, Sie haben eine Excel-Datei müssen mit domänenwerten erstellt (finden Sie unter [Funktionsweise des Imports](#How)), und Sie müssen über erstellt und geöffnet eine Wissensdatenbank, um die Domäne zu importieren.  
...
7.  In der **Wählen Sie eine Datei** in den Ordner, die Excel-Datei, die Sie verwenden möchten enthält, importieren Domänenwerte aus, wählen Sie die Datei (mit der Erweiterung .xlsx, .xls oder .csv) und klicken Sie dann auf, verschieben Sie im Dialogfeld **Öffnen**. Die Datei muss entweder auf dem Client vorhanden sein, von dem Sie DQS ausführen, oder in einer Freigabedatei, auf die der Benutzer Zugriff hat.  
  
8.  Aus der **Arbeitsblatt** Dropdown-Liste, wählen Sie das Arbeitsblatt, das Sie importieren aus.  
...
-   Die Werte in der ersten Spalte werden in die Domäne importiert. Wenn neben der ersten Spalte und eine oder mehrere zusätzliche Spalten aufgefüllt werden, dann werden die Werte in diesen Spalten als Synonyme hinzugefügt (siehe [Importieren von Synonymen](#Synonyms)).  
