...
##  <a name="Marketplace"></a> Verwenden von Verweisdaten von Windows Azure Marketplace  
 DQS unterstützt das Verwenden von Referenzdaten von Windows Azure Marketplace, um es Inhaltsanbietern zu ermöglichen, Verweisdatendienste durch Marketplace bereitzustellen. Marketplace ist ein Dienst von Microsoft, der einen Marketplace und einen Bereitstellungskanal für hochwertige Daten und Anwendungen als Clouddienste bereitstellt. Weitere Informationen zum Marketplace finden Sie unter [Windows Azure Marketplace](http://go.microsoft.com/fwlink/?LinkId=211291) (http://go.microsoft.com/fwlink/?LinkId=211291).  
...
2.  **Zuordnen eine Domäne/verbunddomäne in einer Wissensdatenbank den Reference Data Service**: Zuordnen eine Domäne/verbunddomäne an den entsprechenden Verweis-Datendienst, der in Schritt 1 abonniert/hinzugefügt.  
  
3.  **Verwenden Sie für die bereinigungsaktivität in einem Data Quality-Projekt zugeordneten Domänen**: beim Erstellen einer Data Quality-Projekt für die **Bereinigung** Aktivität, wählen Sie die Wissensdatenbank mit Domänen/verbunddomänen mit Reference Data Services in Schritt 2 zugeordnet, und führen Sie die bereinigungsaktivität.  
...
|Beschreibt, wie Daten mithilfe des Verweisdatendienstes bereinigt werden.|[Bereinigen von Daten mit Verweisdaten & #40; Externe & #41; Knowledge](../data-quality-services/cleanse-data-using-reference-data-external-knowledge.md)|  
