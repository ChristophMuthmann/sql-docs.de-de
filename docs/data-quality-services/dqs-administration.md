---
title: "DQS-Verwaltung | Microsoft Docs"
ms.custom: ""
ms.date: "10/01/2012"
...
---
# DQS-Verwaltung
  [!INCLUDE[ssDQSnoversion](../includes/ssdqsnoversion-md.md)] (DQS) ermöglicht es Ihnen, Administration und Verwaltung von verschiedenen auf ausgeführten DQS-Aktivitäten [!INCLUDE[ssDQSServer](../includes/ssdqsserver-md.md)], DQS-Aktivitäten auf Serverebene Eigenschaften konfigurieren, die Reference Data Service-Einstellungen konfigurieren und Konfigurieren von DQS-protokolleinstellungen. Dies ist durch die Funktion Verwaltung **** in möglich [!INCLUDE[ssDQSClient](../includes/ssdqsclient-md.md)]. In Abhängigkeit von Ihrem Sicherheitszugriff (Rolle) in DQS wird Ihnen der Zugriff auf bestimmte Funktionen in diesem Bereich gewährt bzw. verweigert.  
...
> [!NOTE]  
>  Die **Konfiguration** Bildschirm steht nur für Benutzer mit der Rolle "Dqs_administrator" in der Datenbank DQS_MAIN.  
...
|----------------------|-----------|  
|Beschreibt das Überwachen von Aktivitäten in DQS.|[Monitor DQS Activities](../data-quality-services/monitor-dqs-activities.md)|  
