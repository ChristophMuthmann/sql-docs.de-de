---
title: "Importieren und Exportieren von Wissen | Microsoft Docs"
ms.custom: ""
ms.date: "07/31/2012"
...
---
# Importieren und Exportieren von Wissen
...
> [!IMPORTANT]  
>  Sie exportieren können *alle* Wissensdatenbanken in Ihre [!INCLUDE[ssDQSServer](../includes/ssdqsserver-md.md)] zu einem DQS-Sicherungsdatei (.dqsb) durch das Ausführen der Datei DQSInstaller.exe von der Befehlszeile aus. Auf ähnliche Weise können Sie importieren *alle* Wissensdatenbanken aus einer DQS-Sicherungsdatei (.dqsb) zu Ihrem [!INCLUDE[ssDQSServer](../includes/ssdqsserver-md.md)] gleichzeitig, indem Sie die Datei DQSInstaller.exe von der Befehlszeile aus ausführen. Informationen hierzu finden Sie unter [Export and Import DQS Knowledge Bases Using DQSInstaller.exe](../data-quality-services/install-windows/export-and-import-dqs-knowledge-bases-using-dqsinstaller-exe.md) im DQS-Installationshandbuch.  
