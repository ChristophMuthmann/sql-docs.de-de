---
title: "Verwalten einer Dom&#228;ne | Microsoft Docs"
ms.custom: ""
ms.date: "07/31/2012"
...
|||  
|-|-|  
|Erstellen einer semantischen Darstellung für ein Datenfeld mit einem bestimmten Datentyp, Angeben, wie die Domäne aufgefüllt wird, und Formatieren der Ausgabe der Domäne|[Domäne erstellen](../data-quality-services/create-a-domain.md)|  
...
|Abschließen, Schließen oder Abbrechen der Domänenverwaltungsaktivität|[Beenden der Domänenverwaltungsaktivität](../Topic/End%20the%20Domain%20Management%20Activity.md)|  
