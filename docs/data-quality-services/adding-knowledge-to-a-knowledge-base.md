---
title: "Hinzuf&#252;gen von Wissen zur Wissensdatenbank | Microsoft Docs"
ms.custom: ""
ms.date: "06/04/2013"
...
---
# Hinzuf&#252;gen von Wissen zur Wissensdatenbank
...
-   Weitere Informationen in der Dokumentation finden Sie unter [Importieren einer Domäne aus einer DQS-Datei](../data-quality-services/import-a-domain-from-a-dqs-file.md) oder [Importieren einer Wissensdatenbank aus einer DQS-Datei](../data-quality-services/import-a-knowledge-base-from-a-dqs-file.md).  
...
-   Weitere Informationen in der Dokumentation finden Sie unter [Werte aus einer Excel-Datei in eine Domäne importieren](../data-quality-services/import-values-from-an-excel-file-into-a-domain.md) oder [Importieren von Domänen aus einer Excel-Datei in der Wissensermittlung](../data-quality-services/import-domains-from-an-excel-file-in-knowledge-discovery.md).  
...
-   Weitere Informationen in der Dokumentation finden Sie unter [Bereinigung Projektwerte in eine Domäne](../data-quality-services/import-cleansing-project-values-into-a-domain.md).  
