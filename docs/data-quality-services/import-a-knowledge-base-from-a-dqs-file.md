---
title: "Importieren einer Wissensdatenbank aus einer DQS-Datei | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Importieren einer Wissensdatenbank aus einer DQS-Datei
  In diesem Thema wird beschrieben, wie eine gesamte Wissensdatenbank aus einer DQS-Datendatei in [!INCLUDE[ssDQSnoversion](../includes/ssdqsnoversion-md.md)] (DQS) importiert wird. Erstellen Sie die Datendatei exportieren Sie eine vorhandene Wissensdatenbank innerhalb der [!INCLUDE[ssDQSClient](../includes/ssdqsclient-md.md)] Anwendung (finden Sie unter [Exportieren einer Wissensdatenbank in eine DQS-Datei](../data-quality-services/export-a-knowledge-base-to-a-dqs-file.md)).  
