...
|-|-|  
|**Tool**|**Zweck**|  
|[Objekt-Explorer](../ssms/object/object-explorer.md)|Durchsucht Server, erstellt und sucht Objekte, verwaltet Datenquellen, und zeigt Protokolle an. Auf dieses Tool kann über das Menü **Ansicht** zugegriffen werden.|  
