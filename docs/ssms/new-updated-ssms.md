...
1. [Download SQL Server PowerShell Module (Herunterladen des SQL Server PowerShell-Moduls)](#TitleNum_1)
...
### <a name="1-nbsp-download-sql-server-powershell-moduledownload-sql-server-ps-modulemd"></a>1. &nbsp; [Herunterladen des SQL Server PowerShell-Moduls](download-sql-server-ps-module.md)
...
Verwenden Sie folgenden Befehl, wenn Sie als Administrator angemeldet sind und das Modul für alle Nutzer des Computers installiert werden soll:

> Install-Module -Name SqlServer -AllowClobber

Verwenden Sie folgenden Befehl, wenn Sie sich nicht als Administrator anmelden können bzw. wenn das Modul nur für den aktuellen Nutzer installiert werden soll:
...
- [Neu + Aktualisiert (2+0): Dokumentation zu **Reporting Services für SQL**](../reporting-services/new-updated-reporting-services.md)
- [Neu + Aktualisiert (0+1): Dokumentation zu **SQL Server Management Studio (SSMS)**](../ssms/new-updated-ssms.md)
- [Neu + Aktualisiert (0+1): Dokumentation zu **Transact-SQL**](../t-sql/new-updated-t-sql.md)
...
- [Neu + Aktualisiert (0+0): Dokumentation zum **Herstellen einer Verbindung mit SQL**](../connect/new-updated-connect.md)
