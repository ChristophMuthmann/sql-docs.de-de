...
Auf dieser Registerkarte können Sie Optionen anzeigen und angeben, wenn Sie eine Verbindung mit [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion_md.md)] herstellen oder [!INCLUDE[ssAS](../../includes/ssas_md.md)] in **Registrierte Server** registrieren. Die Felder**Verbinden** und **Optionen** werden nur beim Herstellen einer Verbindung in diesem Dialogfeld angezeigt. Die Felder**Testen** und **Speichern** werden nur beim Registrieren von [!INCLUDE[ssAS](../../includes/ssas_md.md)]in diesem Dialogfeld angezeigt.  
...
**Testenen**  
Klicken Sie hier, um beim Registrieren von [!INCLUDE[ssAS](../../includes/ssas_md.md)] in **Registrierte Server**die Verbindung zu testen.  
