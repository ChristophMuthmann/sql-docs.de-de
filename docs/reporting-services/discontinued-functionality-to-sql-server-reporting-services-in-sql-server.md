...
# Nicht mehr unterstützte Funktionen in SQL Server Reporting Services in SQL Server 2016
...
In diesem Thema wird beschrieben, SQL Server Reporting Services-Funktionen, die in SQL Server 2016 ohne mehr verfügbar sind. Es umfasst nicht die Ankündigungen über bestimmte Versionen des Betriebssystems oder Microsoft Internet Information Services (IIS) nicht mehr unterstützt. Weitere Informationen zu den Systemanforderungen finden Sie unter [Hardware- und Softwareanforderungen für die Installation von SQL Server 2016](../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md).
...
|-|-|
|Hochladen von Berichtsmodellen über das Webportal|Dies kann weiterhin über die SOAP-API erfolgen.|
