...
2.  [Organisieren von Daten und Auswählen des Layouts im Assistenten](#CompleteWizard)  
...
4.  [Ändern des Standarddatentyps und anderer Eigenschaften für einen Berichtsparameter](#ChangeDefaultProperties)  
    ...
    2.  [Angeben der verfügbaren Werte, die in einer Liste angezeigt werden sollen](#AvailableValues)  
  
    3.  [Angeben eines Standardwerts](#DefaultValues)  
  
    4.  [Suchen eines Name-Wert-Paares](#NameValue)  
...
7.  Ändern Sie in der **Eingabeaufforderung** **Geschäfts-ID?** zu **Geschäftsname?**.  
...
Für *@StoreID* zeigt der Report Viewer „Contoso Catalog Store“ an, da dies der Anzeigename für die Geschäfts-ID **200** ist. Im Bericht werden die verkauften Mengen für Zubehör, Camcorder und digitale SLR-Kameras für die Geschäfts-ID **200** angezeigt.  
...
*  [Lookup-Funktion](../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)   
