...
---
# Lernprogramm: Erstellen eines Freiformberichts (Berichts-Generator)
...
3.  Setzen Sie den Cursor in das Textfeld, und geben Sie anschließend Folgendes ein: **Newsletter für **. Setzen Sie ein Leerzeichen nach dem Wort „für“, um den Text von dem Feld zu trennen, das Sie im nächsten Schritt hinzufügen werden.   
    ...
    ![Hinzufügen von Text für Newsletterüberschriften](../reporting-services/media/tutorial-newsletterfor.png "Hinzufügen von Text für Newsletterüberschriften")  
...
2.  Klicken Sie auf der Registerkarte **Einfügen** im Bereich **Berichtselemente** auf **Linie**.  
...
2.  Klicken Sie auf der Registerkarte **Einfügen** im Bereich **Berichtselemente** auf **Rechteck**. Ziehen Sie das Rechteck in das Listenfeld rechts neben der Tabelle, um die Breite auf etwa 5,7 cm und die Höhe auf etwa 20 cm anzupassen.  
...
12. Wählen Sie die Diagrammachse aus, und klicken Sie auf der Registerkarte *Stamm** im Bereich **Zahl** auf **Währung**.
...
Weitere Informationen zu Abfrage-Designern finden Sie unter [Abfrage-Designer &#40;Berichts-Generator&#41;](../Topic/Query%20Designers%20(Report%20Builder).md) und [Benutzeroberfläche des textbasierten Abfrage-Designers &#40;Berichts-Generator&#41;](../reporting-services/report-data/text-based-query-designer-user-interface-report-builder.md).  
