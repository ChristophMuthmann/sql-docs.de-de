---
title: "Problembehandlung bei Berichten: Kartenberichte (Berichts-Generator und SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
---
# Problembehandlung bei Berichten: Kartenberichte (Berichts-Generator und SSRS)
...
## Wie reduziere ich die Berichtsdefinitionsgröße?  
...
## Auf der Entwurfsoberfläche werden räumliche Beispieldaten angezeigt  
...
## Beim Festlegen eines Offsets für ein einzelnes Kartenelement wird eine Gruppe von Kartenelementen verschoben  
...
## In eine Ebene, die räumliche Daten aus einer ESRI-Shape-Datei verwendet, sind immer Daten eingebettet  
...
## Nach dem Umbenennen einer Datenquelle oder eines Dataset auf einen Anzeigenamen werden keine Daten auf der Karte angezeigt.  
...
## Räumliche Daten enthalten NULL-Werte und leere Zeichenfolgen.  
...
## Die Karte enthält mehr als die maximale Anzahl räumlicher Elemente  
...
## Zentrierung und Ansicht können nicht auf ein eingebettetes Kartenelement festgelegt werden  
...
## Im Bericht sind Zentrierung und Ansicht für die Karte festgelegt. Beim erneuten Öffnen des Berichts ist die Kartenansicht anders.  
...
## Zentrierung und Ansicht für eine Kartenebenenoption zeigen kein erwartungsgemäßes Verhalten  
...
## Mindestens eine Ebene wird nicht in der Karte angezeigt  
...
## Ein auf der Kartenebene festgelegter Filter hat keine Auswirkungen.  
...
## Wie können die Werte in der Kartenlegende gesteuert werden?  
...
## Die festgelegten Regeln ergeben nicht die erwarteten Ergebnisse.  
...
## Was bedeutet der Wert "NaN" auf der Farbskala?  
...
## Die Farbskala wird beim Ausführen des Berichts nicht angezeigt.  
...
## Der Hintergrund aus Bing Map-Kacheln wird nicht angezeigt.  
...
## Wie kann der Text in einer Kachelebene gesteuert werden?  
...
## Wenn eine Bezeichnung oder eine QuickInfo auf einen Ausdruck festgelegt wird, wird ein Ausdrucksfehler bezüglich eines Datasetbereichs angezeigt.  
...
## Siehe auch  
 ...
 [Problembehandlung in Berichts-Generator](http://msdn.microsoft.com/de-de/3806fc48-56f8-44d1-a3c1-df8c33cce0a3)  
