...
Informationen zum Festlegen des Achsenintervalls mit Beispieldaten finden Sie unter [Lernprogramm: Hinzufügen eines Säulendiagramms zu einem Bericht](Tutorial:%20Add%20a%20Column%20Chart%20to%20Your%20Report%20\(Report%20Builder\).md).
...
## So zeigen Sie alle Kategoriebezeichnungen auf der X-Achse an  
...
## Ändern des Bezeichnungsintervalls im Eigenschaftenbereich
...
## So aktivieren Sie eine variable Intervallberechnung auf einer Achse  
