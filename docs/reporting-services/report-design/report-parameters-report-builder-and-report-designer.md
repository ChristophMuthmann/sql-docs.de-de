...
##  <a name="UserInterface"></a> Anzeigen eines Berichts mit Parametern  
 Wenn Sie einen Bericht mit Parametern anzeigen, werden auf der Berichts-Viewer-Symbolleiste alle Parameter angezeigt, sodass Sie interaktiv Werte angeben können. Die folgende Abbildung zeigt den Parameterbereich für einen Bericht Withparameters @ReportMonth, @ReportYear, @EmployeeID, @ShowAll, @ExpandTableRows, @CategoryQuota, und @SalesDate.  
...
3.  **@ShowAllParameter** Parameters @ShowAll Datentyp **booleschen**. Geben Sie mithilfe der Optionsfelder entweder **True** oder **False**an.  
...
5.  **@CategoryQuotaParameter** Parameters @CategoryQuota Datentyp **Float**, sodass es einen numerischen Wert akzeptiert.  @CategoryQuotamehrere Werte zulassen festgelegt ist.  
 ...
 **Datasetabfrage oder gespeicherte Prozedur mit Parametern**  
 ...
 ![Berichts-Generator-Dataset-Parametereigenschaften](../../reporting-services/report-design/media/ssrb-paramdatasetprops.png "Builder Berichtsparametereigenschaften Dataset")  
