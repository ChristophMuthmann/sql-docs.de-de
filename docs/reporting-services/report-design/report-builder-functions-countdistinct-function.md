---
title: CountDistinct-Funktion (Berichts-Generator und SSRS) | Microsoft Docs
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---countdistinct-function"></a>Berichtsfunktionen Sie Builder - CountDistinct-Funktion
