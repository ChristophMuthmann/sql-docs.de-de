---
title: StDevP-Funktion (Berichts-Generator und SSRS) | Microsoft Docs
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---stdevp-function"></a>Berichtsfunktionen Sie Builder - StDevP-Funktion
