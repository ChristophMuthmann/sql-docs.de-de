...
---
# Formatieren von Datenpunkten in einem Diagramm (Berichts-Generator und SSRS)
...
## Hinzufügen von QuickInfos und Drillthroughaktionen zu Datenpunkten  
...
## Hervorheben von einzelnen Datenpunkten in einer Reihe  
...
## Positionieren von Datenpunktbezeichnungen in einem Diagramm  
...
## Hinzufügen von Schlüsselwörtern für Datenpunktbezeichnungen, QuickInfos und Legendentext  
...
|#SERIESNAME|Reihenname|Alle|InclusionThresholdSetting|  
|#LABEL|Datenpunktbezeichnung|Alle|InclusionThresholdSetting|  
|#AXISLABEL|Achsenbezeichnung für Datenpunkt|Form|`=Fields!MyDataField.Value`|  
|#INDEX|Datenpunktindex|Alle|InclusionThresholdSetting|  
...
|#LEGENDTEXT|Der Text, der dem Text des Legendenelements entspricht.|Alle|InclusionThresholdSetting|  
...
## Verbessern der Lesbarkeit in einem Diagramm mit mehreren Datenpunkten  
...
## Einfügen von Datenpunktmarkern  
