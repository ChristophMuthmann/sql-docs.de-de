---
title: Max-Funktion (Berichts-Generator und SSRS) | Microsoft Docs
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---max-function"></a>Berichts-Generator Funktionen - Max-Funktion
