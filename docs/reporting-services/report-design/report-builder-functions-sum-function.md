---
title: SUM-Funktion (Berichts-Generator und SSRS) | Microsoft Docs
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---sum-function"></a>Berichts-Generator - Funktionen, "Sum"-Funktion
