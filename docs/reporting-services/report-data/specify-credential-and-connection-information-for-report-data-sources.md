---
title: "Angeben der Anmeldeinformationen und Verbindungsinformationen f&#252;r Berichtsdatenquellen | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Keine Anmeldeinformationen, Option [Reporting Services]"
  - "Identitätswechsel [Reporting Services]"
  - "Benutzeridentitätswechsel [Reporting Services]"
  - "Windows-Authentifizierung [Reporting Services]"
  - "Datenquellen [Reporting Services], Sicherheit"
  - "Verbindungszeichenfolgen [Reporting Services]"
  - "Unbeaufsichtigte Berichtsverarbeitung [Reporting Services]"
  - "Berichte [Reporting Services], Sicherheit"
  - "Remotedatenquellen [Reporting Services]"
  - "Anmeldeinformationen [Reporting Services]"
  - "Authentifizierung [Reporting Services]"
  - "Externe Datenquellen [Reporting Services]"
  - "Aufforderung zur Eingabe der Anmeldeinformationen [Reporting Services]"
  - "Mehrere Verbindungen"
  - "Gespeicherte Anmeldeinformationen [Reporting Services]"
  - "Sicherheit [Reporting Services], Datenquellen"
  - "Integrierte Sicherheit von Windows [Reporting Services]"
...
## Verwenden von Anmeldeinformationen im Berichts-Generator  
...
-   Berichtsserver-Anmeldeinformationen, die Sie im Dialogfeld [Reporting Services-Anmeldung &#40;Berichts-Generator&#41;](../../reporting-services/report-builder/reporting-services-login-dialog-box-report-builder.md) eingeben.  
...
-   Datenquellen-Anmeldeinformationen, die Sie im Dialogfeld [Datenquelleneigenschaften auf der Seite „Anmeldeinformationen“ &#40;Berichts-Generator&#41;](../Topic/Data%20Source%20Properties%20Dialog%20Box,%20Credentials%20\(Report%20Builder\).md) für eine eingebettete Datenquelle eingeben.  
...
-   Anmeldeinformationen für die Datenquelle, die Sie im Dialogfeld [Datenquellen-Anmeldeinformationen eingeben &#40;Berichts-Generator&#41;](../../reporting-services/report-data/enter-data-source-credentials-dialog-box-report-builder.md) eingeben, wenn Sie eine Datasetabfrage ausführen, Datasetfelder aktualisieren oder eine Vorschau des Berichts anzeigen.  
 ...
 Weitere Informationen finden Sie unter [Datenquelleneigenschaften &#40;Dialogfeld, Allgemein, Berichts-Generator&#41;](../Topic/Data%20Source%20Properties%20Dialog%20Box,%20General%20\(Report%20Builder\).md) und [Anzeigen einer Berichtsvorschau in Berichts-Generator](../../reporting-services/report-builder/previewing-reports-in-report-builder.md).  
  
## Verwenden von Remotedatenquellen  
...
## Möglichkeiten zum Festlegen von Anmeldeinformationen zur Verbindungsherstellung mit Remotedatenquellen  
...
-   Der Bericht ist ein Unterbericht, der die Anmeldeinformationen des übergeordneten Berichts verwendet.  
 ...
 Unter diesen Bedingungen stellt der Berichtsserver eine Verbindung zu einer Remotedatenquelle mithilfe des Kontos für die unbeaufsichtigte Ausführung her, das Sie vorher definieren müssen. Da der Berichtsserver die Verbindung zu einem Remoteserver nicht mit seinen Dienstanmeldeinformationen herstellt, müssen Sie ein Konto angeben, mit dem der Berichtsserver die Verbindung herstellen kann. Weitere Informationen zum Erstellen dieses Kontos finden Sie unter [Konfigurieren des Kontos für die unbeaufsichtigte Ausführung &#40;SSRS-Konfigurations-Manager&#41;](../../reporting-services/install-windows/configure-the-unattended-execution-account-ssrs-configuration-manager.md).  
