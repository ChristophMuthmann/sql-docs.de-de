...
ms.topic: "article"
helpviewer_keywords: 
  - "Berichtsserver [Reporting Services], Verschlüsselung"
  - "Verknüpfen von Berichtsserverinstanzen [SQL Server]"
  - "Bereitstellungen für horizontales Skalieren von Berichtsservern [Reporting Services]"
  - "Kryptografie [Reporting Services]"
  - "Mehrere Berichtsserverinstanzen"
  - "Eingabeaufforderungs-Hilfsprogramme [Reporting Services]"
  - "Berichtsserver [Reporting Services], Bereitstellungen für horizontales Skalieren"
...
#### Entfernen von Verschlüsselungsschlüsseln für einzelne Berichtsserver in einer Bereitstellung für horizontales Skalieren  
...
## Hinweise  
 ...
 Weitere Informationen zu den Verschlüsselungsschlüsseln finden Sie unter [Konfigurieren und Verwalten von Verschlüsselungsschlüsseln &#40;SSRS-Konfigurations-Manager&#41;](../../reporting-services/install-windows/configure-and-manage-encryption-keys-ssrs-configuration-manager.md) und [Initialisieren eines Berichtsservers &#40;SSRS-Konfigurations-Manager&#41;](../../reporting-services/install-windows/initialize-a-report-server-ssrs-configuration-manager.md).  
