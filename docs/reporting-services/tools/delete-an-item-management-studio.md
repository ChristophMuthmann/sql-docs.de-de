...
ms.topic: "article"
helpviewer_keywords: 
  - "Elemente [Reporting Services], löschen"
  - "Löschen von Berichtselementen"
  - "Berichtselemente [Reporting Services], löschen"
...
---
# L&#246;schen eines Elements (Management Studio)
...
### So löschen Sie ein Element aus dem Ordnernamespace eines Berichtsservers  
