...
ms.topic: "article"
helpviewer_keywords: 
  - "Berichte [Reporting Services], Bereitstellen"
  - "Veröffentlichen von Berichten [Reporting Services]"
  - "Eigenschaften [Reporting Services], Bereitstellen"
...
### So legen Sie Bereitstellungseigenschaften fest  
...
### So legen Sie Konfigurations-Manager-Eigenschaften fest  
