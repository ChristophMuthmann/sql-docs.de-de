---
title: "Hilfsprogramm &#39;RS.exe&#39; (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Automatische Berichtsserveraufgaben"
  - "Hilfsprogramm rs"
  - "Eingabeaufforderungs-Hilfsprogramme [Reporting Services]"
  - "Berichtsserver [Reporting Services], Automatisieren von Aufgaben"
  - "Eingabeaufforderungs-Hilfsprogramme [SQL Server], rs"
  - "Skripts [Reporting Services], Eingabeaufforderung"
  - "Bereitstellen von Berichten [Reporting Services]"
