---
title: "Problembehandlung f&#252;r eine Reporting Services-Installation | Microsoft Docs"
ms.custom: ""
ms.date: "03/15/2017"
 ...
 **Problemumgehung:** Verwenden Sie zum Konfigurieren eines Berichtsservers im SharePoint-Modus die SharePoint-Zentraladministration. Weitere Informationen finden Sie unter [Verwalten einer Reporting Services-SharePoint-Dienstanwendung](../../reporting-services/report-server-sharepoint/manage-a-reporting-services-sharepoint-service-application.md).  
 ...
 ![Pfeilsymbol, dass mit dem Link "Zurück zum Anfang" verwendet wird](../../analysis-services/instances/media/uparrow16x16.png "Pfeilsymbol, dass mit dem Link "Zurück zum Anfang" verwendet wird") [Problembehandlung von Installationen im SharePoint-Modus](#bkmk_tshoot_sharepoint)  
  
###  <a name="bkmk_no_ssrs_service"></a> Nach der Installation von [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]-SSRS im SharePoint-Modus wird der SQL Server Reporting Services-Dienst nicht in der SharePoint-Zentraladministration angezeigt.  
 **Beschreibung:** Wenn Sie nach einer erfolgreichen Installation von [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] im SharePoint-Modus und dem [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]-Add-in für SharePoint 2013/2016 keinen Eintrag „SQL Server Reporting Services“ in den folgenden zwei Menüs sehen, dann wurde der [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]-Dienst nicht registriert:  
 ...
 **Problemumgehung:** Überprüfen Sie, ob eine [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] -Dienstanwendung vorhanden und ordnungsgemäß konfiguriert ist. Weitere Informationen finden Sie unter [Installieren des ersten Berichtsservers im SharePoint-Modus](http://msdn.microsoft.com/de-de/b29d0f45-0068-4c84-bd7e-5b8a9cd1b538).
...
2.  Öffnen Sie ein Eingabeaufforderungsfenster, und geben Sie den folgenden Befehl ein:  
    ...
    -   **run \<***.NET 4.0 Framework-Verzeichnis***>\InstallUtil.exe \<***Berichtsserver-Bin-Verzeichnis***>\ReportingServicesLibrary.dll**  
        ...
        > [!NOTE]  
        >  Ersetzen Sie \<*.NET 4.0 Framework-Verzeichnis*> durch den physischen Pfad der .NET Framework 4.0-Dateien und \<*Berichtsserver-Bin-Verzeichnis*> durch den physischen Pfad der Berichtsserver-Binärdateien.  
...
###  <a name="WindowsAuthBreaksAfterUpgrade"></a> Fehler 401 – „Nicht autorisiert“ bei Verwendung von Windows-Authentifizierung nach einem Upgrade von SQL Server 2005 auf [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
###  <a name="Uninstall32BitBreaks64Bit"></a> Durch das Deinstallieren einer 32-Bit-Instanz von [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]-Reporting Services in einer parallelen Bereitstellung mit einer 64-Bit-Instanz wird die 64-Bit-Instanz beschädigt.  
...
-   [Forum: SQL Server Reporting Services](http://social.msdn.microsoft.com/Forums/sqlreportingservices/threads)  
 ...
 ![SharePoint-Einstellungen](../../analysis-services/media/as-sharepoint2013-settings-gear.png "SharePoint-Einstellungen") [Übermitteln von Feedback und Kontaktinformationen über Microsoft SQL Server Connect](https://connect.microsoft.com/SQLServer/Feedback) (https://connect.microsoft.com/SQLServer/Feedback).  
