---
title: "Installieren des Berichts-Generators | Microsoft Docs"
ms.custom: ""
ms.date: "09/22/2016"
...
## Installieren des [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] s von einem Webportal oder über die SharePoint-Bibliothek 
...
## Installieren von [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] mit System Center Configuration Manager 
...
## So installieren Sie [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] über eine Freigabe  
...
## So installieren Sie [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] über die Befehlszeile 
...
## Festlegen von Standardwerten für den [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)]  
