---
title: "Initialisieren eines Berichtsservers (SSRS-Konfigurations-Manager) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Berichtsserver [Reporting Services], initialisieren"
  - "Initialisierungsprozess [Reporting Services]"
  - "Überprüfen von Berichtsserverinitialisierungen"
  - "Bereitstellungen für horizontales Skalieren [Reporting Services]"
  - "Initialisierung von Berichtsservern [Reporting Services]"
  - "Überprüfen, Initialisierung eines Berichtsservers"
...
-   Um einen Berichtsserver für die Bereitstellung für horizontales Skalieren zu initialisieren, verwenden Sie die Initialisierungsseite im Reporting Services-Konfigurationstool oder das Hilfsprogramm **RSKeymgmt**. Schrittweise Anleitungen finden Sie unter [Konfigurieren eines Berichtsservers im einheitlichen Modus für Bereitstellungen für horizontales Skalieren &#40;SSRS-Konfigurations-Manager&#41;](../../reporting-services/install-windows/configure a native mode report server scale-out deployment.md).  
...
## Bestätigen der Initialisierung eines Berichtsservers  
 Um die Initialisierung des Berichtsservers zu bestätigen, führen Sie den Ping-Befehl für den Report Server-Webdienst aus, indem Sie **http://\<servername>/reportserver** im Befehlsfenster eingeben. Wenn der **RSReportServerNotActivated** -Fehler auftritt, ist die Initialisierung fehlgeschlagen.  
