...
# <a name="host-a-report-server-database-in-a-sql-server-failover-cluster"></a>Hosten einer Berichtsserver-Datenbank in einem SQL Server-Failovercluster
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]unterstützt Failoverclustering, damit Sie mehrere Datenträger verwenden können, für eine oder mehrere [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Instanzen. Failovercluster werden nur für die Berichtsserver-Datenbank unterstützt; Sie können den Berichtsserver-Dienst nicht als Teil eines Failoverclusters ausführen.  
