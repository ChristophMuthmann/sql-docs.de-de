---
title: "Migration vom einheitlichen vom SharePoint-Modus (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
---
# Migration vom einheitlichen vom SharePoint-Modus (SSRS)
...
## Migrieren von Inhalten mithilfe von Skripts  
...
|Abonnements|ja|Informationen finden Sie im Thema zur ListSubscriptions-Methode unter [Abonnement- und Übermittlungsmethoden](../../reporting-services/report-server-web-service/methods/subscription-and-delivery-methods.md) und im Thema zur <xref:ReportService2010.ReportingService2010.ChangeSubscriptionOwner%2A>-Methode.|  
|Momentaufnahmen|||  
