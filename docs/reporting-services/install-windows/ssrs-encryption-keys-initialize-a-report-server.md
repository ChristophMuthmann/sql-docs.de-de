...
## <a name="how-to-confirm-a-report-server-initialization"></a>Bestätigen der Initialisierung eines Berichtsservers  
 Pingen Sie den Report Server-Webdienst zum Bestätigen der berichtsserverinitialisierung durch Eingabe **http://\<Servername > / Reportserver** im Befehlsfenster. Wenn der **RSReportServerNotActivated** -Fehler auftritt, ist die Initialisierung fehlgeschlagen.  
