...
ms.topic: "article"
helpviewer_keywords: 
  - "Berichte [Reporting Services], aktualisieren"
  - "Veröffentlichte Berichte [Reporting Services], Upgrades"
  - "Benutzerdefinierte Berichtselemente, aktualisieren"
  - "Reporting Services-Upgrades"
  - "Aktualisieren von Reporting Services"
  - "Momentaufnahme [Reporting Services], aktualisieren"
  - "Berichtsdefinitionsdateien [Reporting Services]"
  - "RDL-Dateien"
...
-   Wenn Sie eine [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]-Installation auf eine [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)]-Installation aktualisieren, werden vorhandene Berichte und Momentaufnahmen, die auf einem Berichtsserver veröffentlicht wurden, kompiliert und automatisch auf das neue Schema aktualisiert, wenn sie zum ersten Mal verarbeitet werden. Wenn ein Bericht nicht automatisch aktualisiert werden kann, wird er im Abwärtskompatibilitätsmodus verarbeitet. Die Berichtsdefinition bleibt im ursprünglichen Schema erhalten.  
 ...
 Weitere Informationen zu neuen Funktionen für [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] finden Sie unter [Neues bei Reporting Services &#40;SSRS&#41;](../Topic/What's%20New%20in%20Reporting%20Services%20\(SSRS\).md).  
...
## Siehe auch  
 ...
 [Aktuelle Änderungen in SQL Server Reporting Services in SQL Server 2016](../../reporting-services/breaking-changes-in-sql-server-reporting-services-in-sql-server-2016.md)   
 ...
 [Nicht mehr unterstützte Funktionen in SQL Server Reporting Services in SQL Server 2016](../Topic/Discontinued%20Functionality%20to%20SQL%20Server%20Reporting%20Services%20in%20SQL%20Server%202016.md)   
