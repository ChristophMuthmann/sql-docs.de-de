...
helpviewer_keywords: 
  ...
  - "Autorisierung [Reporting Services]"
  - "Serversicherheit [Reporting Services]"
  - "Rollenbasierte Sicherheit [Reporting Services]"
  - "Elemente [Reporting Services], Sicherheit"
  - "Berechtigungen [Reporting Services], systemeigener Modus"
  - "Veröffentlichte Berichte [Reporting Services], Sicherheit"
  - "Berichte [Reporting Services], Sicherheit"
  - "Berichtselemente [Reporting Services], Sicherheit"
  - "Rollenbasierte Sicherheit [Reporting Services], Informationen zur rollenbasierten Sicherheit"
...
1.  Überprüfen Sie die vordefinierten Rollen, um zu ermitteln, ob Sie sie unverändert verwenden können. Wenn Sie die Aufgaben anpassen oder zusätzliche Rollen definieren müssen, sollte dies erfolgen, bevor Sie den einzelnen Rollen Benutzer zuweisen. Weitere Informationen zu den einzelnen Rollen finden Sie unter [Vordefinierte Rollen](../../reporting-services/security/predefined-roles.md).  
...
|Tool|Aufgaben|  
|----------|-----------|  
|Management Studio - zum Anzeigen, Ändern, Erstellen und Löschen von Rollendefinitionen|[Erstellen, Löschen oder Ändern einer Rolle &#40;Management Studio&#41;](../../reporting-services/security/create-delete-or-modify-a-role-management-studio.md)|  
|Berichts-Manager - zum Zuweisen von Benutzern und Gruppen zu Rollen|[Gewähren von Benutzerzugriff auf einen Berichtsserver &#40;Berichts-Manager&#41;](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md)<br /><br /> [Ändern oder Löschen einer Rollenzuweisung &#40;Berichts-Manager&#41;](../../reporting-services/security/modify-or-delete-a-role-assignment-report-manager.md)|  
