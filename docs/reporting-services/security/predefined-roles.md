...
ms.topic: "article"
helpviewer_keywords: 
  - "Sicherheit [Reporting Services], Standardwerte"
  - "Standardsicherheit"
  - "Rollenbasierte Sicherheit [Reporting Services], Standardwerte"
...
3.  Verwenden Sie den Berichts-Manager, wenn Sie bereit sind, Benutzer- und Gruppenkonten bestimmten Rollen zuzuweisen. Weitere Informationen finden Sie unter [Gewähren von Benutzerzugriff auf einen Berichtsserver &#40;Berichts-Manager&#41;](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md).  
