...
-   Beim Aktualisieren eines [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]-Servers auf [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] werden der Datei **rsreportserver.config** Konfigurationseinstellungen mit Standardwerten hinzugefügt. Wenn die Einstellungen bereits vorhanden waren, behält die [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]-Installation sie in der Datei **rsreportserver.config** bei.  
