...
ms.topic: "article"
helpviewer_keywords: 
  - "Benutzer [Reporting Services]"
  - "Rollen [Reporting Services]"
  - "Rollenbasierte Sicherheit [Reporting Services], Rollenzuweisungen"
  - "Gruppen [Reporting Services]"
...
## Vordefinierte Rollenzuweisungen  
 ...
 Weitere Informationen zu den vordefinierten Rollenzuweisungen, die Standardsicherheit bereitstellen, finden Sie unter [Vordefinierte Rollen](../../reporting-services/security/predefined-roles.md).  
