...
helpviewer_keywords: 
  - "Sicherheit [Reporting Services], Erweiterungen"
  - "Berichtsserver [Reporting Services], Informationen zu Berichtsserver"
  - "Renderingerweiterungen [Reporting Services, Informationen zu Erweiterungen"
  - "Erweiterungen [Reporting Services], Informationen zu Erweiterungen"
  - "Speichern von Daten [Reporting Services]"
  - "Berichtsserver [Reporting Services]"
  - "Datenverarbeitungserweiterungen [Reporting Services], Informationen zu Erweiterungen"
  - "Übermittlungserweiterungen [Reporting Services], Informationen zu Erweiterungen"
  - "Datenspeicherung [Reporting Services]"
  - "Komponenten [Reporting Services], Berichtsserver"
  - "Berichtsverarbeitung [Reporting Services], Erweiterungen"
  - "Webdienst [Reporting Services], Berichtsserver"
  - "Speicherung [Reporting Services]"
...
|Task|Link|  
|----------|----------|  
|Prüfen Sie die Hardware- und Softwareanforderungen.|[Hardware and Software Requirements for Reporting Services in SharePoint Mode](../Topic/Hardware%20and%20Software%20Requirements%20for%20Reporting%20Services%20in%20SharePoint%20Mode.md).|  
|Installieren Sie [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] im SharePoint-Modus.|[Installieren des SharePoint-Modus von Reporting Services für SharePoint 2010](http://msdn.microsoft.com/de-de/47efa72e-1735-4387-8485-f8994fb08c8c)|  
|Wenn Sie ein Webentwickler sind oder Erfahrung im Erstellen von Cascading Stylesheets haben, können Sie auf eigenes Risiko die Standardstile ändern, um Farben, Schriftarten und Layout der Symbolleiste oder des Berichts-Managers zu ändern. In dieser Version sind weder die Standardstylesheets noch Anweisungen zum Ändern der Stylesheets dokumentiert.|[Anpassen von Stylesheets für den HTML-Viewer und Berichts-Manager](../Topic/Customize%20Style%20Sheets%20for%20HTML%20Viewer%20and%20Report%20Manager.md)|  
