---
title: "RSReportServer.config-Konfigurationsdatei | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
-   [Dateispeicherort](#bkmk_file_location)  
  
-   [Allgemeine Konfigurationseinstellungen ("rsreportserver.config")](#bkmk_generalconfiguration)  
  
-   [URLReservations (Datei RSReportServer.config)](#bkmk_URLReservations)  
  
-   [Authentication (Datei RSReportServer.config)](#bkmk_Authentication)  
  
-   [Service (Datei RSReportServer.config)](#bkmk_service)  
  
-   [Allgemeine Konfiguration der Erweiterung(en) für die Übermittlungsbenutzeroberfläche](#bkmk_ui)  
  
-   [Erweiterungen (Datei "RSReportServer.config") für den einheitlichen Modus](#bkmk_extensions)  
  
    -   [Allgemeine Konfiguration der Übermittlungserweiterung(en)](#bkmk_extensionsgeneral)  
  
        -   [Konfigurationseinstellungen für die Dateifreigabe-Übermittlungerweiterung](#bkmk_fileshare_extension)  
  
        -   [Konfigurationseinstellungen für Berichtsserver-E-Mail-Erweiterung](#bkmk_email_extension)  
  
        -   [Konfiguration der Erweiterung für die Berichtsserver-SharePoint-Dokumentbibliothek](#bkmk_documentlibrary_extension)  
  
        -   [Konfiguration der Erweiterung der NULL-Übermittlung](#bkmk_null_extension)  
  
    -   [Allgemeine Konfiguration der Erweiterung(en) für die Übermittlungsbenutzeroberfläche](#bkmk_ui)  
  
    -   [Allgemeine Konfiguration der Renderingerweiterungen](#bkmk_rendering)  
  
    -   [Allgemeine Konfiguration der Datenerweiterung(en)](#bkmk_data)  
  
    -   [Allgemeine Konfiguration der Erweiterungen für semantische Abfragen](#bkmk_semantic)  
  
    -   [Modellgenerierungskonfiguration](#bkmk_model)  
  
    -   [Konfiguration der Sicherheitserweiterung](#bkmk_security)  
  
    -   [Konfigurieren der Authentifizierungseinstellung](#bkmk_authentication)  
  
    -   [Ereignisverarbeitung](#bkmk_eventprocessing)  
  
    -   [Berichtsdefinitionenanpassung](#bkmk_reportdefinition)  
  
    -   [RDLSandboxing](#bkmk_rdlsandboxing)  
  
-   [MapTileServerConfiguration (Datei 'RSReportServer.config')](#bkmk_MapTileServer)  
  
-   [Standardkonfigurationsdatei für einen Berichtsserver im einheitlichen Modus](#bkmk_nativedefaultfile)  
  
-   [Standardkonfigurationsdatei für einen Berichtsserver im SharePoint-Modus](#bkmk_sharepointdefaultfile)  
...
|Einstellung|Description|Mode|  
|-------------|-----------------|----------|  
|**ReportServerUrl**|Gibt die URL des Berichtsservers an, zu der der Berichts-Manager eine Verbindung herstellt. Ändern Sie diesen Wert nur, wenn Sie den Berichts-Manager konfigurieren, um eine Verbindung zu einem Berichtsserver in einer anderen Instanz oder auf einem Remotecomputer herzustellen. Weitere Informationen finden Sie unter [Konfigurieren des Berichts-Managers &#40;einheitlicher Modus&#41;](../../reporting-services/report-server/configure-report-manager-native-mode.md).|N,S|  
|**ReportBuilderTrustLevel**|Ändern Sie diesen Wert nicht; er ist nicht konfigurierbar. In [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] und neueren Versionen wird der Berichts-Generator nur in **FullTrust**ausgeführt. Weitere Informationen finden Sie unter [Konfigurieren des Berichts-Generator-Zugriffs](../../reporting-services/report-server/configure-report-builder-access.md). Weitere Informationen zum Beenden der Modus mit teilweiser Vertrauenswürdigkeit finden Sie unter [Nicht mehr unterstützte Funktionen in SQL Server Reporting Services in SQL Server 2016](../Topic/Discontinued%20Functionality%20to%20SQL%20Server%20Reporting%20Services%20in%20SQL%20Server%202016.md).|N,S|  
...
|**Konfiguration**|Enthält die Konfigurationseinstellungen, die für jede Übermittlungserweiterung spezifisch sind.|  
...
-   [Geräteinformationseinstellungen für Renderingerweiterungen &#40;Reporting Services&#41;](../../reporting-services/device-information-settings-for-rendering-extensions-reporting-services.md)  
 ...
 Weitere Informationen zu den Attributen für das untergeordnete **\<Erweiterung>**-Element unter **\<Render>** finden Sie unten:  
