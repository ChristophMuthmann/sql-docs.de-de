...
apitype: "MOFDef"
helpviewer_keywords: 
  - "GenerateDatabaseCreationScript-Methode"
...
> [!IMPORTANT]  
>  *IsSharePointMode*=**True** wird ab [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] nicht mehr unterstützt, da [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] im SharePoint-Modus ein gemeinsamer SharePoint-Dienst ist und nicht vom WMI-Anbieter kontrolliert wird. Es wird empfohlen, diesen Parameter immer auf **False**festzulegen.  
