---
title: "Erstellen, &#196;ndern oder L&#246;schen von Zeitpl&#228;nen | Microsoft Docs"
ms.custom: ""
ms.date: "07/01/2016"
...
helpviewer_keywords: 
  ...
  - "Freigegebene Zeitpläne [Reporting Services]"
  - "Ändern von Zeitplänen"
  - "Entfernen von Zeitplänen"
  - "Freigegebene Zeitpläne [Reporting Services], Erstellen"
  - "Freigegebene Zeitpläne [Reporting Services], Ändern"
  - "Zeitpläne [Reporting Services], Löschen"
  - "Löschen von Zeitplänen"
  - "Zeitpläne [Reporting Services], Erstellen"
  - "Zeitpläne [Reporting Services], Ändern"
  - "Freigegebene Zeitpläne [Reporting Services], Löschen"
...
---
# Erstellen, &#196;ndern oder L&#246;schen von Zeitpl&#228;nen
...
**Hinweis:** Wenn Sie nicht sicher sind, ob ein freigegebener Zeitplan verwendet wird, sollten Sie diesen ggf. in [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] statt im Webportal löschen. [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] bietet die gleichen Verwaltungsfunktionen für freigegebene Zeitpläne wie der Berichts-Manager, verfügt aber zusätzlich über eine Berichtsseite mit dem Namen jedes Bericht, der den Zeitplan verwendet.  
 ...
 ## Löschen eines berichtsspezifischen Zeitplans  
...
### So löschen Sie einen freigegebenen Zeitplan (Webportal)  
...
### Erstellen, Löschen oder Ändern eines freigegebenen Zeitplans (Management Studio)  
...
### So erstellen oder ändern Sie einen freigegebenen Zeitplan (Management Studio)  
...
##### So löschen Sie einen freigegebenen Zeitplan (Management Studio)  
...
### Erstellen von freigegebenen Zeitplänen (SharePoint-Modus)  
...
### Löschen von freigegebenen Zeitplänen (SharePoint-Modus)  
