---
title: "&#220;berwachen von Reporting Services-Abonnements | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Abonnements [Reporting Services], inaktive"
  - "Abonnements [Reporting Services], Status"
  - "Überwachen [Reporting Services], Abonnements"
  - "Statusinformationen [Reporting Services]"
  - "Inaktive Abonnements [Reporting Services]"
