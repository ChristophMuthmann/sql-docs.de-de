...
|108|Fehler|Erweiterung|Berichtsserver<br /><br /> Berichts-Manager|*\<Quelle >* kann eine Übermittlung, datenverarbeitungs- oder Renderingerweiterung nicht laden.<br /><br /> Dies ist wahrscheinlich auf eine unvollständige Bereitstellung oder das Entfernen einer Erweiterung zurückzuführen. Weitere Informationen finden Sie unter [Deploying a Data Processing Extension](../../reporting-services/extensions/data-processing/deploying-a-data-processing-extension.md) und [Deploying a Delivery Extension](../../reporting-services/extensions/delivery-extension/deploying-a-delivery-extension.md).|  
...
|111|Fehler|Protokollierung|Berichtsserver<br /><br /> Berichts-Manager|*\<Quelle >* kann nicht das Ablaufverfolgungsprotokoll nicht erstellen. Weitere Informationen finden Sie unter [Report Server Service Trace Log](../../reporting-services/report-server/report-server-service-trace-log.md).|  
...
|127|Informationen|Aktivierung|Berichtsserver|Der verschlüsselte Inhalt wurde erfolgreich aus der Berichtsserver-Datenbank entfernt. Weitere Informationen zum Löschen nicht wiederherstellbarer verschlüsselter Daten finden Sie unter [konfigurieren und Verwalten von Verschlüsselungsschlüsseln &#40; SSRS-Konfigurations-Manager &#41; ](../../reporting-services/install-windows/ssrs-encryption-keys-manage-encryption-keys.md).|  
...
|130|Fehler|Verwaltung|Berichtsserver<br /><br /> Prozessor für Zeitplanung und Übermittlung|*\<Quelle >* die Konfigurationsdatei wurde nicht gefunden. Konfigurationsdateien sind für den Berichtsserver erforderlich.|  
