---
title: ODBC-Referenz | Microsoft Docs
ms.custom: 
ms.date: 01/19/2017
...
-   [Funktionszusammenfassung](../../../odbc/reference/syntax/function-summary.md)  
  
-   [ODBC-API-Referenz](../../../odbc/reference/syntax/odbc-api-reference.md)  
  
-   [Setup-DLL-API-Referenz](../../../odbc/reference/syntax/setup-dll-api-reference.md)  
  
-   [Installer DLL-API-Referenz](../../../odbc/reference/syntax/installer-dll-api-reference-function.md)  
