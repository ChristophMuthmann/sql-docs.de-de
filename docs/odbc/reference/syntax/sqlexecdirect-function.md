...
|HY109|Ungültige Cursorposition|\**StatementText* enthaltenen ein positioniertes update oder delete-Anweisung und der Cursor positioniert wurde (durch **SQLSetPos** oder **SQLFetchScroll**) in einer Zeile, die gelöscht wurde oder konnte nicht abgerufen werden.|  
