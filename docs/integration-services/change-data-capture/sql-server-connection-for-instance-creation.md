---
title: "SQL Server-Verbindung f&#252;r die Instanzerstellung | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# SQL Server-Verbindung f&#252;r die Instanzerstellung
...
-   **SQL Server-Authentifizierung:** Wenn Sie diese Option aktivieren, müssen Sie den **Anmeldenamen** und das **Kennwort** für den Benutzer in der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Instanz eingeben, mit der Sie eine Verbindung herstellen.  
