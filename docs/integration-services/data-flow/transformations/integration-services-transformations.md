---
title: "SQL Server Integration Services-Transformationen | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Transformationen [Integration Services], Auflistung"
  - "Transformationen [Integration Services], Typen"
  - "Transformationen [Integration Services]"
  - "Datenfluss [Integration Services], Transformationen"
  - "Business Intelligence-Transformationen [Integration Services]"
  - "Jointsransformationen"
  - "Teilentransformationen [Integration Services]"
  - "Benutzerdefinierte Transformationen [Integration Services]"
  - "Zeilentransformationen [Integration Services]"
  - "Rowset-Transformationen [Integration Services]"
