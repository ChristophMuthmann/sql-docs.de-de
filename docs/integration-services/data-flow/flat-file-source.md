...
helpviewer_keywords: 
  - "Quellen [Integration Services], Flatfile"
  - "Lesen von Textdateien [Integration Services]"
  - "Flatfiles"
  - "Flatfilequelle"
...
## Konfiguration der Flatfilequelle  
