...
1.  Erstellen oder öffnen Sie ein [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]-Paket in [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)].  
