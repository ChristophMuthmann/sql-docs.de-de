---
title: "Upgrade von Integration Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services, Upgraden"
  - "SSIS, Upgraden"
  - "SQL Server Integration Services, Upgraden"
...
>   
>  Informationen zu anderen nicht mehr unterstützten Funktionen finden Sie unter [Nicht mehr unterstützte Integration Services-Funktionalität in SQL Server 2016](../Topic/Discontinued%20Integration%20Services%20Functionality%20in%20SQL%20Server%202016.md).  
...
## Aktualisieren von Integration Services und Datenbankmodul auf [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
## Upgrade ausschließlich des Datenbankmoduls auf [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 In diesem Abschnitt werden die Auswirkungen eines Upgrades mit folgenden Kriterien beschrieben:  
