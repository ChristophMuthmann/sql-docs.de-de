...
ms.topic: "article"
helpviewer_keywords: 
  - "Verbindungen [Integration Services], SMTP"
  - "SMTP-Verbindungs-Manager [Integration Services]"
  - "Verbindungs-Manager [Integration Services], SMTP"
...
## Konfiguration des SMTP-Verbindungs-Managers  
