...
### <a name="32-bit-and-64-bit-providers-for-connection-managers"></a>32-Bit- und 64-Bit-Anbieter für Verbindungs-Manager  
 ...
 Beide Versionen des Anbieters verfügen über die gleiche ID. Um anzugeben, ob die [! UMFASSEN[SsISnoversion](/sql-docs/docs/integration-services/integration-services-ssis-development-and-management-tools).  
