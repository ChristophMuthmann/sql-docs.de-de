...
### So erstellen Sie einen Excel-Verbindungs-Manager im Bereich "Verbindungs-Manager"  
...
### So erstellen Sie eine Excel-Verbindung mit dem SQL Server-Import/Export-Assistenten  
