...
helpviewer_keywords: 
  ...
  - "Verbindungen [Integration Services], SQL Server Compact"
  - "Verbindungs-Manager [Integration Services], SQL Server Compact"
...
## Konfiguration des SQL Server Compact Edition-Verbindungs-Managers  
