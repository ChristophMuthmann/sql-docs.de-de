...
## <a name="see-also"></a>Siehe auch  
 [Understanding the Differences between Local and Remote Execution (Grundlegendes zu den Unterschieden zwischen der lokalen und der Remoteausführung)](../../integration-services/run-manage-packages-programmatically/understanding-the-differences-between-local-and-remote-execution.md)   
 [Loading and Running a Local Package Programmatically (Programmgesteuertes Laden und Ausführen eines lokalen Pakets)](../../integration-services/run-manage-packages-programmatically/loading-and-running-a-local-package-programmatically.md)   
