...
In diesem Beispiel enthält das Feld **SQL-Anweisung** die vom Assistenten generierte Standardanweisung **CREATE TABLE** . Diese Anweisung erstellt eine neue Zieltabelle, die mit dem Namen **Person.AddressNew** , ist eine Kopie der **Person.Address** Quelltabelle. 
  
 ![Tabelle-Seite des Import / Export-Assistenten erstellen](../../integration-services/import-export-data/media/create-table.png "Tabelle-Seite des Import / Export-Assistenten erstellen")  
...
Wenn Sie den Standard-CREATE TABLE-Befehl ändern, müssen Sie auch nehmen Sie Änderungen an die zugehörigen spaltenzuordnungen, wenn Sie zum zurückkehren der **Spaltenzuordnungen** (Dialogfeld).  
 ...
 **Automatisch generieren**  
 Stellen Sie die Standard-SQL-Anweisung wieder her, wenn Sie es, indem Sie auf Änderungen vorgenommen haben **automatisch generieren**.  
