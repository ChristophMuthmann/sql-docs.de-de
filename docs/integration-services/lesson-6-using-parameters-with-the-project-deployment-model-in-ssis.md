...
1.  [Schritt 1: Kopieren des Pakets aus Lektion 5](../integration-services/step-1-copying-the-lesson-5-package.md)  
  
2.  [Schritt 2: Converting the Project to the Project Deployment Model (Konvertieren des Projekts in das Projektbereitstellungsmodell)](../integration-services/step-2-converting-the-project-to-the-project-deployment-model.md)  
  
3.  [Schritt 3: Testen des Pakets aus Lektion 6](../integration-services/step-3-testing-the-lesson-6-package.md)  
  
4.  [Schritt 4: Bereitstellen des Pakets aus Lektion 6](../integration-services/step-4-deploying-the-lesson-6-package.md)  
  
## Lektion beginnen  
[Schritt 1: Kopieren des Pakets aus Lektion 5](../integration-services/step-1-copying-the-lesson-5-package.md)  
