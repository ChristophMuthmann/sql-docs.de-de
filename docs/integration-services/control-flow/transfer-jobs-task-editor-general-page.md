---
title: Transfer Jobs Task-Editor (Seite Allgemein) | Microsoft Docs
ms.custom: 
ms.date: 03/14/2017
...
ms.openlocfilehash: 1fd4efd2c1beb06f78a925641ba31e75ef52a085
ms.contentlocale: de-de
ms.lasthandoff: 08/03/2017

---
# <a name="transfer-jobs-task-editor-general-page"></a>Editor für den Task Aufträge übertragen (Seite Allgemein)
  Mithilfe der Seite **Allgemein** des Dialogfelds **Editor für den Task Aufträge übertragen** können Sie den Task Aufträge übertragen benennen und beschreiben. Weitere Informationen zum Task Aufträge übertragen finden Sie unter [Transfer Jobs Task](../../integration-services/control-flow/transfer-jobs-task.md).  
