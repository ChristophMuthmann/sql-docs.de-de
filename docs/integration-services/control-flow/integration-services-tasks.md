...
ms.topic: "article"
helpviewer_keywords: 
  - "Skripts [Integration Services], Aufgaben"
  - "Dateien [Integration Services], Aufgabenoptionen"
  - "Workflowtasks [Integration Services]"
  - "Integration Services, Aufgaben"
  - "Hinzufügen von Pakettasks"
  - "Aufgaben [Integration Services], gelistete"
  - "SSIS-Tasks"
  - "SSIS, Aufgaben"
  - "Ablaufsteuerung [Integration Services], Aufgaben"
  - "Tasks [Integration Services]"
  - "Gruppieren von Tasks"
  - "Aufgaben [Integration Services], Informationen zu Aufgaben"
  - "SQL Server Integration Services-Tasks"
  - "Datenvorbereitungstasks [Integration Services]"
  - "Verzeichnisvorgänge [Integration Services]"
...
## Konfiguration von Tasks  
 ...
 Jeder Task kann einzeln mithilfe der benutzerdefinierten Dialogfelder für die verschiedenen Tasks des [!INCLUDE[ssIS](../../includes/ssis-md.md)] -Designers konfiguriert werden oder mithilfe des Eigenschaftenfensters von [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]. In einem Paket können mehrere Tasks desselben Typs vorhanden sein (z. B. sechs Tasks vom Typ SQL ausführen), wobei jeder Task unterschiedlich konfiguriert sein kann. Weitere Informationen finden Sie unter [Festlegen der Eigenschaften eines Tasks oder Containers](../Topic/Set%20the%20Properties%20of%20a%20Task%20or%20Container.md).  
  
## Tasks "Verbindungen" und "Gruppen"  
