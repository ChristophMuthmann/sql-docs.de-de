...
helpviewer_keywords: 
  - "Datenprofilerstellungs-Task [Integration Services], Informationen zum Datenprofilerstellungs-Task"
...
> [!IMPORTANT]  
>  Die Ausgabedatei enthält möglicherweise sensible Daten über die Datenbank und die Daten in der Datenbank. Vorschläge zur Verbesserung der Sicherheit dieser Datei finden Sie unter [Zugriff auf Dateien, die von Paketen verwendet werden](../../integration-services/security/access-to-files-used-by-packages.md).  
>   
...
## Verfügbare benutzerdefinierte Meldungen für den Datenprofilerstellungs-Task  
 In der folgenden Tabelle werden die benutzerdefinierten Protokolleinträge für den Datenprofilerstellungs-Task aufgelistet. Weitere Informationen finden Sie unter [Integration Services-Protokollierung &#40;SSIS&#41;](../../integration-services/performance/integration-services-ssis-logging.md) und [Benutzerdefinierte Meldungen für die Protokollierung](../../integration-services/performance/custom-messages-for-logging.md).  
