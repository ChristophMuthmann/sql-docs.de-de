---
title: Servergruppen in SQL Operations Studio (preview) | Microsoft Docs
description: Informationen Sie zur Server-Gruppen in der SQL Operations Studio (preview).
ms.custom: tools|sos
ms.date: 11/15/2017
